...
type iDescribeApplicationResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetApplication(v string) *DescribeApplicationResponseBody
	GetApplication() *string
	SetRequestId(v string) *DescribeApplicationResponseBody
	GetRequestId() *string
}
...
func (s *DescribeApplicationResponseBody) GetApplication() *string {
	return s.Application
}

func (s *DescribeApplicationResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *DescribeApplicationResponseBody) Validate() error {
