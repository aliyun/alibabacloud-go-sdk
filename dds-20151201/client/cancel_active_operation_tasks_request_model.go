...
type iCancelActiveOperationTasksRequest interface {
	...
	GetOwnerId() *int64
	SetResourceGroupId(v string) *CancelActiveOperationTasksRequest
...
func (s *CancelActiveOperationTasksRequest) GetResourceGroupId() *string {
...
func (s *CancelActiveOperationTasksRequest) SetResourceGroupId(v string) *CancelActiveOperationTasksRequest {
	s.ResourceGroupId = &v
	return s
}
