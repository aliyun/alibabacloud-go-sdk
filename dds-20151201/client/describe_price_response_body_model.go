...
func (s *DescribePriceResponseBodyOrderCouponsCoupon) GetActivityExtInfo() map[string]interface{} {
...
func (s *DescribePriceResponseBodyOrderCouponsCoupon) GetEffective() *bool {
	return s.Effective
}
...
func (s *DescribePriceResponseBodyOrderCouponsCoupon) SetActivityExtInfo(v map[string]interface{}) *DescribePriceResponseBodyOrderCouponsCoupon {
	s.ActivityExtInfo = v
	return s
}
...
func (s *DescribePriceResponseBodyOrderCouponsCoupon) SetEffective(v bool) *DescribePriceResponseBodyOrderCouponsCoupon {
	s.Effective = &v
	return s
}
...
func (s *DescribePriceResponseBodyOrderCouponsCoupon) Validate() error {
	if s.PromotionRuleIdList != nil {
		if err := s.PromotionRuleIdList.Validate(); err != nil {
			return err
		}
	}
	return nil
...
func (s *DescribePriceResponseBodySubOrdersSubOrderOptionalPromotionsOptionalPromotion) Validate() error {
	...
	if s.TargetArticleItemCodes != nil {
		if err := s.TargetArticleItemCodes.Validate(); err != nil {
			return err
		}
	}
	return nil
