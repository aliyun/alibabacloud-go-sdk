...
type iDescribeMeterImsMediaConvertUsageRequest interface {
	dara.Model
	String() string
	GoString() string
	SetEndTs(v int64) *DescribeMeterImsMediaConvertUsageRequest
	GetEndTs() *int64
	SetInterval(v int64) *DescribeMeterImsMediaConvertUsageRequest
	GetInterval() *int64
	SetRegion(v string) *DescribeMeterImsMediaConvertUsageRequest
	GetRegion() *string
	SetStartTs(v int64) *DescribeMeterImsMediaConvertUsageRequest
	GetStartTs() *int64
}
...
func (s *DescribeMeterImsMediaConvertUsageRequest) GetEndTs() *int64 {
	return s.EndTs
}

func (s *DescribeMeterImsMediaConvertUsageRequest) GetInterval() *int64 {
	return s.Interval
}

func (s *DescribeMeterImsMediaConvertUsageRequest) GetRegion() *string {
	return s.Region
}

func (s *DescribeMeterImsMediaConvertUsageRequest) GetStartTs() *int64 {
	return s.StartTs
}
...
func (s *DescribeMeterImsMediaConvertUsageRequest) Validate() error {
