...
func (client *Client) GetAIAgentConcurrencyWithContext(ctx context.Context, request *GetAIAgentConcurrencyRequest, runtime *dara.RuntimeOptions) (_result *GetAIAgentConcurrencyResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) SubmitCosyVoiceCustomizedVoiceJobWithContext(ctx context.Context, request *SubmitCosyVoiceCustomizedVoiceJobRequest, runtime *dara.RuntimeOptions) (_result *SubmitCosyVoiceCustomizedVoiceJobResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
