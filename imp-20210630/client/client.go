...
func (client *Client) DeleteLiveRoomWithOptions(request *DeleteLiveRoomRequest, runtime *util.RuntimeOptions) (_result *DeleteLiveRoomResponse, _err error) {
	...
	_body, _err := client.DoRPCRequest(tea.String("DeleteLiveRoom"), tea.String("2021-06-30"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) PublishLiveRoomWithOptions(request *PublishLiveRoomRequest, runtime *util.RuntimeOptions) (_result *PublishLiveRoomResponse, _err error) {
	...
	_body, _err := client.DoRPCRequest(tea.String("PublishLiveRoom"), tea.String("2021-06-30"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateLiveRoomWithOptions(tmpReq *UpdateLiveRoomRequest, runtime *util.RuntimeOptions) (_result *UpdateLiveRoomResponse, _err error) {
	...
	_body, _err := client.DoRPCRequest(tea.String("UpdateLiveRoom"), tea.String("2021-06-30"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
