...
type iExecuteTaskResponseBody interface {
  ...
  String() string
  GoString() string
  SetCode(v int32) *ExecuteTaskResponseBody
  GetCode() *int32 
...
func (s *ExecuteTaskResponseBody) GetCode() *int32  {
  return s.Code
}
...
func (s *ExecuteTaskResponseBody) SetCode(v int32) *ExecuteTaskResponseBody {
  s.Code = &v
  return s
}
