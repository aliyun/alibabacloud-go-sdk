...
type iModifyDiskSizeRequest interface {
	...
	String() string
	GoString() string
	SetAutoPay(v bool) *ModifyDiskSizeRequest
	GetAutoPay() *bool
...
func (s *ModifyDiskSizeRequest) GetAutoPay() *bool {
	return s.AutoPay
}
...
func (s *ModifyDiskSizeRequest) SetAutoPay(v bool) *ModifyDiskSizeRequest {
	s.AutoPay = &v
	return s
}
