...
type iFaceThumbnail interface {
	dara.Model
	String() string
	GoString() string
	SetFaceGroupId(v string) *FaceThumbnail
	GetFaceGroupId() *string
	SetFaceId(v string) *FaceThumbnail
	GetFaceId() *string
	SetFaceThumbnail(v string) *FaceThumbnail
	GetFaceThumbnail() *string
}
...
func (s *FaceThumbnail) GetFaceGroupId() *string {
	return s.FaceGroupId
}

func (s *FaceThumbnail) GetFaceId() *string {
	return s.FaceId
}

func (s *FaceThumbnail) GetFaceThumbnail() *string {
	return s.FaceThumbnail
}
...
func (s *FaceThumbnail) Validate() error {
