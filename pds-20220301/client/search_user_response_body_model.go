...
type iSearchUserResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetItems(v []*User) *SearchUserResponseBody
	GetItems() []*User
	SetNextMarker(v string) *SearchUserResponseBody
...
func (s *SearchUserResponseBody) GetItems() []*User {
	return s.Items
}

func (s *SearchUserResponseBody) GetNextMarker() *string {
	return s.NextMarker
}
...
func (s *SearchUserResponseBody) Validate() error {
	if s.Items != nil {
