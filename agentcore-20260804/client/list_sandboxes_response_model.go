...
type iListSandboxesResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *ListSandboxesResponseBody) *ListSandboxesResponse
	GetBody() *ListSandboxesResponseBody
}

type ListSandboxesResponse struct {
	Headers    map[string]*string         `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                     `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *ListSandboxesResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *ListSandboxesResponse) GetBody() *ListSandboxesResponseBody {
	return s.Body
}
...
func (s *ListSandboxesResponse) SetBody(v *ListSandboxesResponseBody) *ListSandboxesResponse {
	s.Body = v
	return s
}
