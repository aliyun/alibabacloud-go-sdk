...
type iUpdateCloudGtmMonitorTemplateShrinkRequest interface {
	dara.Model
	String() string
	GoString() string
	SetAcceptLanguage(v string) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetAcceptLanguage() *string
	SetClientToken(v string) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetClientToken() *string
	SetEvaluationCount(v int32) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetEvaluationCount() *int32
	SetExtendInfo(v string) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetExtendInfo() *string
	SetFailureRate(v int32) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetFailureRate() *int32
	SetInterval(v int32) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetInterval() *int32
	SetIspCityNodesShrink(v string) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetIspCityNodesShrink() *string
	SetName(v string) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetName() *string
	SetTemplateId(v string) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetTemplateId() *string
	SetTimeout(v int32) *UpdateCloudGtmMonitorTemplateShrinkRequest
	GetTimeout() *int32
}
...
func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetAcceptLanguage() *string {
	return s.AcceptLanguage
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetClientToken() *string {
	return s.ClientToken
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetEvaluationCount() *int32 {
	return s.EvaluationCount
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetExtendInfo() *string {
	return s.ExtendInfo
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetFailureRate() *int32 {
	return s.FailureRate
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetInterval() *int32 {
	return s.Interval
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetIspCityNodesShrink() *string {
	return s.IspCityNodesShrink
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetName() *string {
	return s.Name
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetTemplateId() *string {
	return s.TemplateId
}

func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) GetTimeout() *int32 {
	return s.Timeout
}
...
func (s *UpdateCloudGtmMonitorTemplateShrinkRequest) Validate() error {
