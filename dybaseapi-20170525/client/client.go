...
func (client *Client) Init(config *openapiutil.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(dara.String("dybaseapi"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
...
func (client *Client) QueryTokenForMnsQueueWithOptions(request *QueryTokenForMnsQueueRequest, runtime *dara.RuntimeOptions) (_result *QueryTokenForMnsQueueResponse, _err error) {
	...
	params := &openapiutil.Params{
		Action:      dara.String("QueryTokenForMnsQueue"),
