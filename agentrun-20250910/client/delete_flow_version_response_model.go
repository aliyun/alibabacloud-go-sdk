...
type iDeleteFlowVersionResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *CommonResult) *DeleteFlowVersionResponse
...
func (s *DeleteFlowVersionResponse) GetBody() *CommonResult {
	return s.Body
}
...
func (s *DeleteFlowVersionResponse) SetBody(v *CommonResult) *DeleteFlowVersionResponse {
	s.Body = v
	return s
}
