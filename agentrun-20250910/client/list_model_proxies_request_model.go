...
type iListModelProxiesRequest interface {
	...
	SetWorkspaceIds(v string) *ListModelProxiesRequest
...
func (s *ListModelProxiesRequest) GetWorkspaceIds() *string {
...
func (s *ListModelProxiesRequest) SetWorkspaceIds(v string) *ListModelProxiesRequest {
	s.WorkspaceIds = &v
	return s
}
