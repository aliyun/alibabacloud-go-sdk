...
type iGetWorkspaceResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *WorkspaceResult) *GetWorkspaceResponse
...
func (s *GetWorkspaceResponse) GetBody() *WorkspaceResult {
	return s.Body
}
...
func (s *GetWorkspaceResponse) SetBody(v *WorkspaceResult) *GetWorkspaceResponse {
	s.Body = v
	return s
}
