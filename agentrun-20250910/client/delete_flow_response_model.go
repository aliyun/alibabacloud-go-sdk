...
type iDeleteFlowResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *CommonResult) *DeleteFlowResponse
...
func (s *DeleteFlowResponse) GetBody() *CommonResult {
	return s.Body
}
...
func (s *DeleteFlowResponse) SetBody(v *CommonResult) *DeleteFlowResponse {
	s.Body = v
	return s
}
