...
type iListWorkspacesResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *ListWorkspacesResult) *ListWorkspacesResponse
	GetBody() *ListWorkspacesResult
}

type ListWorkspacesResponse struct {
	Headers    map[string]*string    `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *ListWorkspacesResult `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *ListWorkspacesResponse) GetBody() *ListWorkspacesResult {
	return s.Body
}
...
func (s *ListWorkspacesResponse) SetBody(v *ListWorkspacesResult) *ListWorkspacesResponse {
	s.Body = v
	return s
}
