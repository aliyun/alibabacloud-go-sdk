...
type iDeleteWorkspaceResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *WorkspaceResult) *DeleteWorkspaceResponse
...
func (s *DeleteWorkspaceResponse) GetBody() *WorkspaceResult {
	return s.Body
}
...
func (s *DeleteWorkspaceResponse) SetBody(v *WorkspaceResult) *DeleteWorkspaceResponse {
	s.Body = v
	return s
}
