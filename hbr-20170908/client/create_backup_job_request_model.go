...
type iCreateBackupJobRequest interface {
	dara.Model
	String() string
	GoString() string
	SetBackupType(v string) *CreateBackupJobRequest
	GetBackupType() *string
	SetClusterId(v string) *CreateBackupJobRequest
	GetClusterId() *string
	SetContainerClusterId(v string) *CreateBackupJobRequest
	GetContainerClusterId() *string
	SetContainerResources(v string) *CreateBackupJobRequest
	GetContainerResources() *string
	SetCrossAccountRoleName(v string) *CreateBackupJobRequest
	GetCrossAccountRoleName() *string
	SetCrossAccountType(v string) *CreateBackupJobRequest
	GetCrossAccountType() *string
	SetCrossAccountUserId(v int64) *CreateBackupJobRequest
	GetCrossAccountUserId() *int64
	SetDetail(v map[string]interface{}) *CreateBackupJobRequest
	GetDetail() map[string]interface{}
	SetExclude(v string) *CreateBackupJobRequest
	GetExclude() *string
	SetInclude(v string) *CreateBackupJobRequest
	GetInclude() *string
	SetInitiatedByAck(v bool) *CreateBackupJobRequest
	GetInitiatedByAck() *bool
	SetInstanceId(v string) *CreateBackupJobRequest
	GetInstanceId() *string
	SetJobName(v string) *CreateBackupJobRequest
	GetJobName() *string
	SetOptions(v string) *CreateBackupJobRequest
	GetOptions() *string
	SetRetention(v int64) *CreateBackupJobRequest
	GetRetention() *int64
	SetSourceType(v string) *CreateBackupJobRequest
	GetSourceType() *string
	SetSpeedLimit(v string) *CreateBackupJobRequest
	GetSpeedLimit() *string
	SetVaultId(v string) *CreateBackupJobRequest
	GetVaultId() *string
}
...
func (s *CreateBackupJobRequest) GetBackupType() *string {
	return s.BackupType
}

func (s *CreateBackupJobRequest) GetClusterId() *string {
	return s.ClusterId
}

func (s *CreateBackupJobRequest) GetContainerClusterId() *string {
	return s.ContainerClusterId
}

func (s *CreateBackupJobRequest) GetContainerResources() *string {
	return s.ContainerResources
}

func (s *CreateBackupJobRequest) GetCrossAccountRoleName() *string {
	return s.CrossAccountRoleName
}

func (s *CreateBackupJobRequest) GetCrossAccountType() *string {
	return s.CrossAccountType
}

func (s *CreateBackupJobRequest) GetCrossAccountUserId() *int64 {
	return s.CrossAccountUserId
}

func (s *CreateBackupJobRequest) GetDetail() map[string]interface{} {
	return s.Detail
}

func (s *CreateBackupJobRequest) GetExclude() *string {
	return s.Exclude
}

func (s *CreateBackupJobRequest) GetInclude() *string {
	return s.Include
}

func (s *CreateBackupJobRequest) GetInitiatedByAck() *bool {
	return s.InitiatedByAck
}

func (s *CreateBackupJobRequest) GetInstanceId() *string {
	return s.InstanceId
}

func (s *CreateBackupJobRequest) GetJobName() *string {
	return s.JobName
}

func (s *CreateBackupJobRequest) GetOptions() *string {
	return s.Options
}

func (s *CreateBackupJobRequest) GetRetention() *int64 {
	return s.Retention
}

func (s *CreateBackupJobRequest) GetSourceType() *string {
	return s.SourceType
}

func (s *CreateBackupJobRequest) GetSpeedLimit() *string {
	return s.SpeedLimit
}

func (s *CreateBackupJobRequest) GetVaultId() *string {
	return s.VaultId
}
