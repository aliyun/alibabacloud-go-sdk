...
func (s *DescribeAbnormalPatternDetectionResponseBodyDetectionItems) GetMessage() *string {
	return s.Message
}
...
func (s *DescribeAbnormalPatternDetectionResponseBodyDetectionItems) GetStatus() *string {
	return s.Status
}
