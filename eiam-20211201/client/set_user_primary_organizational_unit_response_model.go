...
type iSetUserPrimaryOrganizationalUnitResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *SetUserPrimaryOrganizationalUnitResponseBody) *SetUserPrimaryOrganizationalUnitResponse
	GetBody() *SetUserPrimaryOrganizationalUnitResponseBody
}
...
func (s *SetUserPrimaryOrganizationalUnitResponse) GetBody() *SetUserPrimaryOrganizationalUnitResponseBody {
	return s.Body
}
