...
type iDeleteCredentialResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *DeleteCredentialResponseBody) *DeleteCredentialResponse
	GetBody() *DeleteCredentialResponseBody
}

type DeleteCredentialResponse struct {
	Headers    map[string]*string            `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                        `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *DeleteCredentialResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *DeleteCredentialResponse) GetBody() *DeleteCredentialResponseBody {
	return s.Body
}
...
func (s *DeleteCredentialResponse) SetBody(v *DeleteCredentialResponseBody) *DeleteCredentialResponse {
	s.Body = v
	return s
}
