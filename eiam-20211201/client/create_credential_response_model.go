...
type iCreateCredentialResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *CreateCredentialResponseBody) *CreateCredentialResponse
	GetBody() *CreateCredentialResponseBody
}

type CreateCredentialResponse struct {
	Headers    map[string]*string            `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                        `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *CreateCredentialResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *CreateCredentialResponse) GetBody() *CreateCredentialResponseBody {
	return s.Body
}
