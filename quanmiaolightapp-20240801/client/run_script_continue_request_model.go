...
type iRunScriptContinueRequest interface {
	dara.Model
	String() string
	GoString() string
	SetScriptSummary(v string) *RunScriptContinueRequest
	GetScriptSummary() *string
	SetScriptTypeKeyword(v string) *RunScriptContinueRequest
	GetScriptTypeKeyword() *string
	SetUserProvidedContent(v string) *RunScriptContinueRequest
	GetUserProvidedContent() *string
}
...
func (s *RunScriptContinueRequest) GetScriptSummary() *string {
	return s.ScriptSummary
}

func (s *RunScriptContinueRequest) GetScriptTypeKeyword() *string {
	return s.ScriptTypeKeyword
}

func (s *RunScriptContinueRequest) GetUserProvidedContent() *string {
	return s.UserProvidedContent
}
...
func (s *RunScriptContinueRequest) Validate() error {
