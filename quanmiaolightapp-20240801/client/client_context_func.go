...
func (client *Client) BatchCancelTasksWithContext(ctx context.Context, workspaceId *string, tmpReq *BatchCancelTasksRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *BatchCancelTasksResponse, _err error) {
...
func (client *Client) BatchQueryTaskStatusWithContext(ctx context.Context, workspaceId *string, tmpReq *BatchQueryTaskStatusRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *BatchQueryTaskStatusResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GetTaskExecutionStatisticsWithContext(ctx context.Context, workspaceId *string, request *GetTaskExecutionStatisticsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetTaskExecutionStatisticsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) RunEnterpriseVocAnalysisWithContext(ctx context.Context, workspaceId *string, tmpReq *RunEnterpriseVocAnalysisRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *RunEnterpriseVocAnalysisResponse, _err error) {
	...
	if !dara.IsNil(request.PositiveFilter) {
...
func (client *Client) RunEssayCorrectionWithSSECtx(ctx context.Context, workspaceId *string, tmpReq *RunEssayCorrectionRequest, headers map[string]*string, runtime *dara.RuntimeOptions, _yield chan *RunEssayCorrectionResponse, _yieldErr chan error) {
	defer close(_yield)
	client.runEssayCorrectionWithSSECtx_opYieldFunc(_yield, _yieldErr, ctx, workspaceId, tmpReq, headers, runtime)
	return
}
...
//
// @return RunEssayCorrectionResponse
func (client *Client) RunEssayCorrectionWithContext(ctx context.Context, workspaceId *string, tmpReq *RunEssayCorrectionRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *RunEssayCorrectionResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) RunMarketingInformationWritingWithSSECtx(ctx context.Context, workspaceId *string, tmpReq *RunMarketingInformationWritingRequest, headers map[string]*string, runtime *dara.RuntimeOptions, _yield chan *RunMarketingInformationWritingResponse, _yieldErr chan error) {
	defer close(_yield)
	client.runMarketingInformationWritingWithSSECtx_opYieldFunc(_yield, _yieldErr, ctx, workspaceId, tmpReq, headers, runtime)
	return
}
...
//
// @return RunMarketingInformationWritingResponse
func (client *Client) RunMarketingInformationWritingWithContext(ctx context.Context, workspaceId *string, tmpReq *RunMarketingInformationWritingRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *RunMarketingInformationWritingResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) SubmitEnterpriseVocAnalysisTaskWithContext(ctx context.Context, workspaceId *string, tmpReq *SubmitEnterpriseVocAnalysisTaskRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *SubmitEnterpriseVocAnalysisTaskResponse, _err error) {
	...
	if !dara.IsNil(request.BatchTask) {
...
func (client *Client) runEssayCorrectionWithSSECtx_opYieldFunc(_yield chan *RunEssayCorrectionResponse, _yieldErr chan error, ctx context.Context, workspaceId *string, tmpReq *RunEssayCorrectionRequest, headers map[string]*string, runtime *dara.RuntimeOptions) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err := tmpReq.Validate()
		if _err != nil {
			_yieldErr <- _err
...
func (client *Client) runMarketingInformationWritingWithSSECtx_opYieldFunc(_yield chan *RunMarketingInformationWritingResponse, _yieldErr chan error, ctx context.Context, workspaceId *string, tmpReq *RunMarketingInformationWritingRequest, headers map[string]*string, runtime *dara.RuntimeOptions) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err := tmpReq.Validate()
		if _err != nil {
			_yieldErr <- _err
