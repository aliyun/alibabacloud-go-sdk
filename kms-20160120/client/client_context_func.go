...
func (client *Client) GenerateMacWithContext(ctx context.Context, request *GenerateMacRequest, runtime *dara.RuntimeOptions) (_result *GenerateMacResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GetKmsInstanceQuotaInfosWithContext(ctx context.Context, request *GetKmsInstanceQuotaInfosRequest, runtime *dara.RuntimeOptions) (_result *GetKmsInstanceQuotaInfosResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) VerifyMacWithContext(ctx context.Context, request *VerifyMacRequest, runtime *dara.RuntimeOptions) (_result *VerifyMacResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
