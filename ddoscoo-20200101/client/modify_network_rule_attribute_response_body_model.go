...
type iModifyNetworkRuleAttributeResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ModifyNetworkRuleAttributeResponseBody
	GetRequestId() *string
}
...
func (s *ModifyNetworkRuleAttributeResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ModifyNetworkRuleAttributeResponseBody) Validate() error {
