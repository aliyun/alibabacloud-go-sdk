...
type iModifyBlockStatusResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ModifyBlockStatusResponseBody
	GetRequestId() *string
}
...
func (s *ModifyBlockStatusResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ModifyBlockStatusResponseBody) Validate() error {
