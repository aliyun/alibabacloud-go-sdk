...
type iCreateTagResourcesResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *CreateTagResourcesResponseBody
	GetRequestId() *string
}
...
func (s *CreateTagResourcesResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *CreateTagResourcesResponseBody) Validate() error {
