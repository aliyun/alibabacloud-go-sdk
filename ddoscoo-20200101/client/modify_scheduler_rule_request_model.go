...
type iModifySchedulerRuleRequest interface {
	dara.Model
	String() string
	GoString() string
	SetParam(v string) *ModifySchedulerRuleRequest
	GetParam() *string
	SetResourceGroupId(v string) *ModifySchedulerRuleRequest
	GetResourceGroupId() *string
	SetRuleName(v string) *ModifySchedulerRuleRequest
	GetRuleName() *string
	SetRuleType(v int32) *ModifySchedulerRuleRequest
	GetRuleType() *int32
	SetRules(v string) *ModifySchedulerRuleRequest
	GetRules() *string
}
...
func (s *ModifySchedulerRuleRequest) GetParam() *string {
	return s.Param
}

func (s *ModifySchedulerRuleRequest) GetResourceGroupId() *string {
	return s.ResourceGroupId
}

func (s *ModifySchedulerRuleRequest) GetRuleName() *string {
	return s.RuleName
}

func (s *ModifySchedulerRuleRequest) GetRuleType() *int32 {
	return s.RuleType
}

func (s *ModifySchedulerRuleRequest) GetRules() *string {
	return s.Rules
}
...
func (s *ModifySchedulerRuleRequest) Validate() error {
