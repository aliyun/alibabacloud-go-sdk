...
type iListKnowledgeBasesResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *ListKnowledgeBasesResponseBody) *ListKnowledgeBasesResponse
	GetBody() *ListKnowledgeBasesResponseBody
}

type ListKnowledgeBasesResponse struct {
	Headers    map[string]*string              `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                          `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *ListKnowledgeBasesResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *ListKnowledgeBasesResponse) GetBody() *ListKnowledgeBasesResponseBody {
	return s.Body
}
...
func (s *ListKnowledgeBasesResponse) SetBody(v *ListKnowledgeBasesResponseBody) *ListKnowledgeBasesResponse {
	s.Body = v
	return s
}
