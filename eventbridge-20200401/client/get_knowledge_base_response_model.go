...
type iGetKnowledgeBaseResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *GetKnowledgeBaseResponseBody) *GetKnowledgeBaseResponse
	GetBody() *GetKnowledgeBaseResponseBody
}

type GetKnowledgeBaseResponse struct {
	Headers    map[string]*string            `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                        `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *GetKnowledgeBaseResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *GetKnowledgeBaseResponse) GetBody() *GetKnowledgeBaseResponseBody {
	return s.Body
}
...
func (s *GetKnowledgeBaseResponse) SetBody(v *GetKnowledgeBaseResponseBody) *GetKnowledgeBaseResponse {
	s.Body = v
	return s
}
