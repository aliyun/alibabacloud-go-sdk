...
type iCreateKnowledgeBaseResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *CreateKnowledgeBaseResponseBody) *CreateKnowledgeBaseResponse
	GetBody() *CreateKnowledgeBaseResponseBody
}

type CreateKnowledgeBaseResponse struct {
	Headers    map[string]*string               `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                           `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *CreateKnowledgeBaseResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *CreateKnowledgeBaseResponse) GetBody() *CreateKnowledgeBaseResponseBody {
	return s.Body
}
...
func (s *CreateKnowledgeBaseResponse) SetBody(v *CreateKnowledgeBaseResponseBody) *CreateKnowledgeBaseResponse {
	s.Body = v
	return s
}
