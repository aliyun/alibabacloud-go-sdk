...
func (client *Client) AddAgendaSumRecordFlowPopWithOptions(request *AddAgendaSumRecordFlowPopRequest, runtime *dara.RuntimeOptions) (_result *AddAgendaSumRecordFlowPopResponse, _err error) {
...
//
// @return AddAgendaSumRecordFlowPopResponse
func (client *Client) AddAgendaSumRecordFlowPop(request *AddAgendaSumRecordFlowPopRequest) (_result *AddAgendaSumRecordFlowPopResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &AddAgendaSumRecordFlowPopResponse{}
	_body, _err := client.AddAgendaSumRecordFlowPopWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
