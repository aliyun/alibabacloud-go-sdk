...
func (client *Client) ApplyWsTokenWithOptions(request *ApplyWsTokenRequest, runtime *util.RuntimeOptions) (_result *ApplyWsTokenResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapi.Params{
		Action:      tea.String("ApplyWsToken"),
		Version:     tea.String("2019-01-15"),
		Protocol:    tea.String("HTTPS"),
		Pathname:    tea.String("/"),
		Method:      tea.String("POST"),
...
func (client *Client) UploadDataSyncForLLMWithOptions(request *UploadDataSyncForLLMRequest, runtime *util.RuntimeOptions) (_result *UploadDataSyncForLLMResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapi.Params{
		Action:      tea.String("UploadDataSyncForLLM"),
		Version:     tea.String("2019-01-15"),
		Protocol:    tea.String("HTTPS"),
		Pathname:    tea.String("/"),
		Method:      tea.String("POST"),
