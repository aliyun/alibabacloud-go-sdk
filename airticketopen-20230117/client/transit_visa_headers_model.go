...
type iTransitVisaHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *TransitVisaHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *TransitVisaHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *TransitVisaHeaders
...
func (s *TransitVisaHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *TransitVisaHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *TransitVisaHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *TransitVisaHeaders) Validate() error {
