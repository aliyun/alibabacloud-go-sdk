...
type iRefundApplyHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *RefundApplyHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *RefundApplyHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *RefundApplyHeaders
...
func (s *RefundApplyHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *RefundApplyHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *RefundApplyHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *RefundApplyHeaders) Validate() error {
