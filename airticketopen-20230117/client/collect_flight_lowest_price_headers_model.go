...
type iCollectFlightLowestPriceHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *CollectFlightLowestPriceHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *CollectFlightLowestPriceHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *CollectFlightLowestPriceHeaders
...
func (s *CollectFlightLowestPriceHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *CollectFlightLowestPriceHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *CollectFlightLowestPriceHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *CollectFlightLowestPriceHeaders) Validate() error {
