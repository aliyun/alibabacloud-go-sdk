...
type iLuggageDirectHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *LuggageDirectHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *LuggageDirectHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *LuggageDirectHeaders
...
func (s *LuggageDirectHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *LuggageDirectHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *LuggageDirectHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *LuggageDirectHeaders) Validate() error {
