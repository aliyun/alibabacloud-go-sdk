...
type iAncillarySuggestHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *AncillarySuggestHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *AncillarySuggestHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *AncillarySuggestHeaders
...
func (s *AncillarySuggestHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *AncillarySuggestHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *AncillarySuggestHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *AncillarySuggestHeaders) Validate() error {
