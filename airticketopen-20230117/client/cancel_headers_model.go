...
type iCancelHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *CancelHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *CancelHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *CancelHeaders
...
func (s *CancelHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *CancelHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *CancelHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *CancelHeaders) Validate() error {
