...
type iSearchHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *SearchHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *SearchHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *SearchHeaders
...
func (s *SearchHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *SearchHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *SearchHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *SearchHeaders) Validate() error {
