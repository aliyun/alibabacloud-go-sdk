...
type iTicketingHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *TicketingHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *TicketingHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *TicketingHeaders
...
func (s *TicketingHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *TicketingHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *TicketingHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *TicketingHeaders) Validate() error {
