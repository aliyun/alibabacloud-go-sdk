...
type iChangeCancelHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *ChangeCancelHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *ChangeCancelHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *ChangeCancelHeaders
...
func (s *ChangeCancelHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *ChangeCancelHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *ChangeCancelHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *ChangeCancelHeaders) Validate() error {
