...
type iAccountFlowListHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *AccountFlowListHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *AccountFlowListHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *AccountFlowListHeaders
...
func (s *AccountFlowListHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *AccountFlowListHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *AccountFlowListHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *AccountFlowListHeaders) Validate() error {
