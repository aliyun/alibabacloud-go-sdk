...
type iOrderDetailHeaders interface {
	dara.Model
	String() string
	GoString() string
	SetCommonHeaders(v map[string]*string) *OrderDetailHeaders
	GetCommonHeaders() map[string]*string
	SetXAcsAirticketAccessToken(v string) *OrderDetailHeaders
	GetXAcsAirticketAccessToken() *string
	SetXAcsAirticketLanguage(v string) *OrderDetailHeaders
...
func (s *OrderDetailHeaders) GetCommonHeaders() map[string]*string {
	return s.CommonHeaders
}

func (s *OrderDetailHeaders) GetXAcsAirticketAccessToken() *string {
	return s.XAcsAirticketAccessToken
}

func (s *OrderDetailHeaders) GetXAcsAirticketLanguage() *string {
...
func (s *OrderDetailHeaders) Validate() error {
