...
func (s *ListServiceInstancesResponseBodyServiceInstances) GetUserId() *int64 {
	return s.UserId
}
...
func (s *ListServiceInstancesResponseBodyServiceInstancesService) GetDeployMetadata() *string {
...
func (s *ListServiceInstancesResponseBodyServiceInstancesService) GetEnablePrivateVpcConnection() *bool {
...
func (s *ListServiceInstancesResponseBodyServiceInstancesService) GetSourceSupplierName() *string {
