...
type iCreateArtifactResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *CreateArtifactResponseBody) *CreateArtifactResponse
	GetBody() *CreateArtifactResponseBody
}
...
func (s *CreateArtifactResponse) GetBody() *CreateArtifactResponseBody {
	return s.Body
}
