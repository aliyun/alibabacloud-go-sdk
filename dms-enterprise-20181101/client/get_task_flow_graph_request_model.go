...
type iGetTaskFlowGraphRequest interface {
	dara.Model
	String() string
	GoString() string
	SetDagId(v int64) *GetTaskFlowGraphRequest
	GetDagId() *int64
	SetTid(v int64) *GetTaskFlowGraphRequest
	GetTid() *int64
}
...
func (s *GetTaskFlowGraphRequest) GetDagId() *int64 {
	return s.DagId
}

func (s *GetTaskFlowGraphRequest) GetTid() *int64 {
	return s.Tid
}
...
func (s *GetTaskFlowGraphRequest) Validate() error {
