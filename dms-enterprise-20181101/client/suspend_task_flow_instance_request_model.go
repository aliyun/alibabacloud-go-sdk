...
type iSuspendTaskFlowInstanceRequest interface {
	dara.Model
	String() string
	GoString() string
	SetDagId(v int64) *SuspendTaskFlowInstanceRequest
	GetDagId() *int64
	SetDagInstanceId(v int64) *SuspendTaskFlowInstanceRequest
	GetDagInstanceId() *int64
	SetTid(v int64) *SuspendTaskFlowInstanceRequest
	GetTid() *int64
}
...
func (s *SuspendTaskFlowInstanceRequest) GetDagId() *int64 {
	return s.DagId
}

func (s *SuspendTaskFlowInstanceRequest) GetDagInstanceId() *int64 {
	return s.DagInstanceId
}

func (s *SuspendTaskFlowInstanceRequest) GetTid() *int64 {
	return s.Tid
}
...
func (s *SuspendTaskFlowInstanceRequest) Validate() error {
