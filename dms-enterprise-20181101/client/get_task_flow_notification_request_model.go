...
type iGetTaskFlowNotificationRequest interface {
	dara.Model
	String() string
	GoString() string
	SetDagId(v int64) *GetTaskFlowNotificationRequest
	GetDagId() *int64
	SetTid(v int64) *GetTaskFlowNotificationRequest
	GetTid() *int64
}
...
func (s *GetTaskFlowNotificationRequest) GetDagId() *int64 {
	return s.DagId
}

func (s *GetTaskFlowNotificationRequest) GetTid() *int64 {
	return s.Tid
}
...
func (s *GetTaskFlowNotificationRequest) Validate() error {
