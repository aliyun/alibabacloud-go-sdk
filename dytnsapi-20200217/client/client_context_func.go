...
func (client *Client) HistoryThreeElementsVerificationWithContext(ctx context.Context, request *HistoryThreeElementsVerificationRequest, runtime *dara.RuntimeOptions) (_result *HistoryThreeElementsVerificationResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) SaveContactsWithContext(ctx context.Context, request *SaveContactsRequest, runtime *dara.RuntimeOptions) (_result *SaveContactsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) VirtualThreeElementsVerificationWithContext(ctx context.Context, request *VirtualThreeElementsVerificationRequest, runtime *dara.RuntimeOptions) (_result *VirtualThreeElementsVerificationResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
