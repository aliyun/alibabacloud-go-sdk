...
func (client *Client) BindPasswordFreeLoginUserWithOptions(request *BindPasswordFreeLoginUserRequest, runtime *util.RuntimeOptions) (_result *BindPasswordFreeLoginUserResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapi.Params{
		Action:      tea.String("BindPasswordFreeLoginUser"),
		Version:     tea.String("2021-04-20"),
		Protocol:    tea.String("HTTPS"),
		Pathname:    tea.String("/"),
		Method:      tea.String("POST"),
...
func (client *Client) UpdateTerminalPolicyWithOptions(request *UpdateTerminalPolicyRequest, runtime *util.RuntimeOptions) (_result *UpdateTerminalPolicyResponse, _err error) {
	...
	if !tea.BoolValue(util.IsUnset(request.EnableBackgroundMode)) {
