...
func (client *Client) Init(config *openapiutil.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(dara.String("goodstech"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
...
func (client *Client) ClassifyCommodityWithOptions(request *ClassifyCommodityRequest, runtime *dara.RuntimeOptions) (_result *ClassifyCommodityResponse, _err error) {
	...
	params := &openapiutil.Params{
		Action:      dara.String("ClassifyCommodity"),
...
func (client *Client) ClassifyCommodityAdvance(request *ClassifyCommodityAdvanceRequest, runtime *dara.RuntimeOptions) (_result *ClassifyCommodityResponse, _err error) {
	// Step 0: init client
	...
	if !dara.IsNil(request.ImageURLObject) {
		...
		classifyCommodityReq.ImageURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
