...
func (client *Client) DisableArmsWithContext(ctx context.Context, request *DisableArmsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *DisableArmsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) QueryArmsEnableWithContext(ctx context.Context, request *QueryArmsEnableRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *QueryArmsEnableResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ResumeTrafficWithContext(ctx context.Context, request *ResumeTrafficRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ResumeTrafficResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) SuspendTrafficWithContext(ctx context.Context, request *SuspendTrafficRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *SuspendTrafficResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
