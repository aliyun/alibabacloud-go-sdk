...
func (client *Client) Init(config *openapiutil.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(dara.String("objectdet"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
...
func (client *Client) DetectIPCObjectWithOptions(request *DetectIPCObjectRequest, runtime *dara.RuntimeOptions) (_result *DetectIPCObjectResponse, _err error) {
...
func (client *Client) DetectIPCObjectAdvance(request *DetectIPCObjectAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectIPCObjectResponse, _err error) {
	// Step 0: init client
	...
	if !dara.IsNil(request.ImageURLObject) {
		...
		detectIPCObjectReq.ImageURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectKitchenAnimalsWithOptions(request *DetectKitchenAnimalsRequest, runtime *dara.RuntimeOptions) (_result *DetectKitchenAnimalsResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DetectKitchenAnimalsAdvance(request *DetectKitchenAnimalsAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectKitchenAnimalsResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.ImageURLAObject) {
		...
		detectKitchenAnimalsReq.ImageURLA = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
	...
	if !dara.IsNil(request.ImageURLBObject) {
		...
		detectKitchenAnimalsReq.ImageURLB = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectMainBodyWithOptions(request *DetectMainBodyRequest, runtime *dara.RuntimeOptions) (_result *DetectMainBodyResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DetectMainBodyAdvance(request *DetectMainBodyAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectMainBodyResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.ImageURLObject) {
		...
		detectMainBodyReq.ImageURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectObjectWithOptions(request *DetectObjectRequest, runtime *dara.RuntimeOptions) (_result *DetectObjectResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DetectObjectAdvance(request *DetectObjectAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectObjectResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.ImageURLObject) {
		...
		detectObjectReq.ImageURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectVehicleICongestionWithOptions(tmpReq *DetectVehicleICongestionRequest, runtime *dara.RuntimeOptions) (_result *DetectVehicleICongestionResponse, _err error) {
...
func (client *Client) DetectVehicleICongestionAdvance(request *DetectVehicleICongestionAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectVehicleICongestionResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.ImageURLObject) {
		...
		detectVehicleICongestionReq.ImageURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectVehicleIllegalParkingWithOptions(tmpReq *DetectVehicleIllegalParkingRequest, runtime *dara.RuntimeOptions) (_result *DetectVehicleIllegalParkingResponse, _err error) {
	_err = tmpReq.Validate()
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DetectVehicleIllegalParkingAdvance(request *DetectVehicleIllegalParkingAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectVehicleIllegalParkingResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.ImageURLObject) {
		...
		detectVehicleIllegalParkingReq.ImageURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectVideoIPCObjectWithOptions(request *DetectVideoIPCObjectRequest, runtime *dara.RuntimeOptions) (_result *DetectVideoIPCObjectResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DetectVideoIPCObjectAdvance(request *DetectVideoIPCObjectAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectVideoIPCObjectResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.VideoURLObject) {
		...
		detectVideoIPCObjectReq.VideoURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectWhiteBaseImageWithOptions(request *DetectWhiteBaseImageRequest, runtime *dara.RuntimeOptions) (_result *DetectWhiteBaseImageResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DetectWhiteBaseImageAdvance(request *DetectWhiteBaseImageAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectWhiteBaseImageResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.ImageURLObject) {
		...
		detectWhiteBaseImageReq.ImageURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) DetectWorkwearWithOptions(tmpReq *DetectWorkwearRequest, runtime *dara.RuntimeOptions) (_result *DetectWorkwearResponse, _err error) {
	_err = tmpReq.Validate()
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DetectWorkwearAdvance(request *DetectWorkwearAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectWorkwearResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.ImageUrlObject) {
		...
		detectWorkwearReq.ImageUrl = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
