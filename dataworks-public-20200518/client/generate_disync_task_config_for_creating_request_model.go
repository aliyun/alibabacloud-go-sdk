...
type iGenerateDISyncTaskConfigForCreatingRequest interface {
	dara.Model
	String() string
	GoString() string
	SetClientToken(v string) *GenerateDISyncTaskConfigForCreatingRequest
	GetClientToken() *string
	SetProjectId(v int64) *GenerateDISyncTaskConfigForCreatingRequest
	GetProjectId() *int64
	SetTaskParam(v string) *GenerateDISyncTaskConfigForCreatingRequest
	GetTaskParam() *string
	SetTaskType(v string) *GenerateDISyncTaskConfigForCreatingRequest
	GetTaskType() *string
}
...
func (s *GenerateDISyncTaskConfigForCreatingRequest) GetClientToken() *string {
	return s.ClientToken
}

func (s *GenerateDISyncTaskConfigForCreatingRequest) GetProjectId() *int64 {
	return s.ProjectId
}

func (s *GenerateDISyncTaskConfigForCreatingRequest) GetTaskParam() *string {
	return s.TaskParam
}

func (s *GenerateDISyncTaskConfigForCreatingRequest) GetTaskType() *string {
	return s.TaskType
}
...
func (s *GenerateDISyncTaskConfigForCreatingRequest) Validate() error {
