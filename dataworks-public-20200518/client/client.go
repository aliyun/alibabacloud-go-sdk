...
func (s *ListQualityResultsByEntityRequest) SetEntityId(v int) *ListQualityResultsByEntityRequest {
	s.EntityId = &v
	return s
}
...
func (s *ListQualityResultsByEntityRequest) SetPageSize(v int) *ListQualityResultsByEntityRequest {
	s.PageSize = &v
	return s
}

func (s *ListQualityResultsByEntityRequest) SetPageNumber(v int) *ListQualityResultsByEntityRequest {
	s.PageNumber = &v
	return s
}
...
type ListQualityResultsByEntityResponse struct {
	RequestId      *string                                           `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	QualityResults *ListQualityResultsByEntityResponseQualityResults `json:"QualityResults,omitempty" xml:"QualityResults,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListQualityResultsByEntityResponse) SetRequestId(v string) *ListQualityResultsByEntityResponse {
	s.RequestId = &v
	return s
}

func (s *ListQualityResultsByEntityResponse) SetQualityResults(v *ListQualityResultsByEntityResponseQualityResults) *ListQualityResultsByEntityResponse {
	s.QualityResults = v
	return s
}

type ListQualityResultsByEntityResponseQualityResults struct {
	TotalCount *int64                                                        `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	PageNumber *int                                                          `json:"PageNumber,omitempty" xml:"PageNumber,omitempty" require:"true"`
	PageSize   *int                                                          `json:"PageSize,omitempty" xml:"PageSize,omitempty" require:"true"`
	RuleChecks []*ListQualityResultsByEntityResponseQualityResultsRuleChecks `json:"RuleChecks,omitempty" xml:"RuleChecks,omitempty" require:"true" type:"Repeated"`
}

func (s ListQualityResultsByEntityResponseQualityResults) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByEntityResponseQualityResults) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByEntityResponseQualityResults) SetTotalCount(v int64) *ListQualityResultsByEntityResponseQualityResults {
	s.TotalCount = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResults) SetPageNumber(v int) *ListQualityResultsByEntityResponseQualityResults {
	s.PageNumber = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResults) SetPageSize(v int) *ListQualityResultsByEntityResponseQualityResults {
	s.PageSize = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResults) SetRuleChecks(v []*ListQualityResultsByEntityResponseQualityResultsRuleChecks) *ListQualityResultsByEntityResponseQualityResults {
	s.RuleChecks = v
	return s
}

type ListQualityResultsByEntityResponseQualityResultsRuleChecks struct {
	...
	BizDate           *int64                                                                      `json:"BizDate,omitempty" xml:"BizDate,omitempty" require:"true"`
	DateType          *string                                                                     `json:"DateType,omitempty" xml:"DateType,omitempty" require:"true"`
	ActualExpression  *string                                                                     `json:"ActualExpression,omitempty" xml:"ActualExpression,omitempty" require:"true"`
	...
	CheckResult       *int                                                                        `json:"CheckResult,omitempty" xml:"CheckResult,omitempty" require:"true"`
	CheckResultStatus *int                                                                        `json:"CheckResultStatus,omitempty" xml:"CheckResultStatus,omitempty" require:"true"`
	...
	TimeCost          *string                                                                     `json:"TimeCost,omitempty" xml:"TimeCost,omitempty" require:"true"`
	ExternalType      *string                                                                     `json:"ExternalType,omitempty" xml:"ExternalType,omitempty" require:"true"`
	ExternalId        *string                                                                     `json:"ExternalId,omitempty" xml:"ExternalId,omitempty" require:"true"`
	DiscreteCheck     *bool                                                                       `json:"DiscreteCheck,omitempty" xml:"DiscreteCheck,omitempty" require:"true"`
	FixedCheck        *bool                                                                       `json:"FixedCheck,omitempty" xml:"FixedCheck,omitempty" require:"true"`
	Trend             *string                                                                     `json:"Trend,omitempty" xml:"Trend,omitempty" require:"true"`
	WarningThreshold  *float32                                                                    `json:"WarningThreshold,omitempty" xml:"WarningThreshold,omitempty" require:"true"`
	CriticalThreshold *float32                                                                    `json:"CriticalThreshold,omitempty" xml:"CriticalThreshold,omitempty" require:"true"`
	ExpectValue       *float32                                                                    `json:"ExpectValue,omitempty" xml:"ExpectValue,omitempty" require:"true"`
	...
	ResultString      *string                                                                     `json:"ResultString,omitempty" xml:"ResultString,omitempty" require:"true"`
	CheckerId         *int                                                                        `json:"CheckerId,omitempty" xml:"CheckerId,omitempty" require:"true"`
	CheckerType       *int                                                                        `json:"CheckerType,omitempty" xml:"CheckerType,omitempty" require:"true"`
	RuleName          *string                                                                     `json:"RuleName,omitempty" xml:"RuleName,omitempty" require:"true"`
	IsPrediction      *bool                                                                       `json:"IsPrediction,omitempty" xml:"IsPrediction,omitempty" require:"true"`
	UpperValue        *float32                                                                    `json:"UpperValue,omitempty" xml:"UpperValue,omitempty" require:"true"`
	LowerValue        *float32                                                                    `json:"LowerValue,omitempty" xml:"LowerValue,omitempty" require:"true"`
	CheckerName       *string                                                                     `json:"CheckerName,omitempty" xml:"CheckerName,omitempty" require:"true"`
	ReferenceValue    []*ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue `json:"ReferenceValue,omitempty" xml:"ReferenceValue,omitempty" require:"true" type:"Repeated"`
	SampleValue       []*ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue    `json:"SampleValue,omitempty" xml:"SampleValue,omitempty" require:"true" type:"Repeated"`
}

func (s ListQualityResultsByEntityResponseQualityResultsRuleChecks) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByEntityResponseQualityResultsRuleChecks) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetId(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.Id = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetTaskId(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.TaskId = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetEntityId(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.EntityId = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetRuleId(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.RuleId = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetProperty(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.Property = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetBizDate(v int64) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.BizDate = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetDateType(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.DateType = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetActualExpression(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.ActualExpression = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetMatchExpression(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.MatchExpression = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetBlockType(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.BlockType = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetCheckResult(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.CheckResult = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetCheckResultStatus(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.CheckResultStatus = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetMethodName(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.MethodName = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetComment(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.Comment = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetWhereCondition(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.WhereCondition = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetBeginTime(v int64) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.BeginTime = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetEndTime(v int64) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.EndTime = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetTimeCost(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.TimeCost = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetExternalType(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.ExternalType = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetExternalId(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.ExternalId = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetDiscreteCheck(v bool) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.DiscreteCheck = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetFixedCheck(v bool) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.FixedCheck = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetTrend(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.Trend = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetWarningThreshold(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.WarningThreshold = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetCriticalThreshold(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.CriticalThreshold = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetExpectValue(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.ExpectValue = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetOp(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.Op = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetProjectName(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.ProjectName = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetTableName(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.TableName = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetTemplateId(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.TemplateId = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetTemplateName(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.TemplateName = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetResultString(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.ResultString = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetCheckerId(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.CheckerId = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetCheckerType(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.CheckerType = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetRuleName(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.RuleName = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetIsPrediction(v bool) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.IsPrediction = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetUpperValue(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.UpperValue = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetLowerValue(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.LowerValue = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetCheckerName(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.CheckerName = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetReferenceValue(v []*ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.ReferenceValue = v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecks) SetSampleValue(v []*ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue) *ListQualityResultsByEntityResponseQualityResultsRuleChecks {
	s.SampleValue = v
	return s
}

type ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue struct {
	BizDate           *int64   `json:"BizDate,omitempty" xml:"BizDate,omitempty" require:"true"`
	DiscreteProperty  *string  `json:"DiscreteProperty,omitempty" xml:"DiscreteProperty,omitempty" require:"true"`
	...
	SingleCheckResult *int     `json:"SingleCheckResult,omitempty" xml:"SingleCheckResult,omitempty" require:"true"`
}

func (s ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) SetBizDate(v int64) *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue {
	s.BizDate = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) SetDiscreteProperty(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue {
	s.DiscreteProperty = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) SetValue(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue {
	s.Value = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) SetThreshold(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue {
	s.Threshold = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue) SetSingleCheckResult(v int) *ListQualityResultsByEntityResponseQualityResultsRuleChecksReferenceValue {
	s.SingleCheckResult = &v
	return s
}

type ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue struct {
	BizDate          *int64   `json:"BizDate,omitempty" xml:"BizDate,omitempty" require:"true"`
	DiscreteProperty *string  `json:"DiscreteProperty,omitempty" xml:"DiscreteProperty,omitempty" require:"true"`
	Value            *float32 `json:"Value,omitempty" xml:"Value,omitempty" require:"true"`
}

func (s ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue) SetBizDate(v int64) *ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue {
	s.BizDate = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue) SetDiscreteProperty(v string) *ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue {
	s.DiscreteProperty = &v
	return s
}

func (s *ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue) SetValue(v float32) *ListQualityResultsByEntityResponseQualityResultsRuleChecksSampleValue {
	s.Value = &v
	return s
}
...
func (s *GetNodeTypeListInfoRequest) SetPageNumber(v int) *GetNodeTypeListInfoRequest {
	s.PageNumber = &v
	return s
}

func (s *GetNodeTypeListInfoRequest) SetPageSize(v int) *GetNodeTypeListInfoRequest {
	s.PageSize = &v
	return s
}
...
type GetNodeTypeListInfoResponse struct {
	RequestId        *string                                      `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	NodeTypeInfoList *GetNodeTypeListInfoResponseNodeTypeInfoList `json:"NodeTypeInfoList,omitempty" xml:"NodeTypeInfoList,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetNodeTypeListInfoResponse) SetRequestId(v string) *GetNodeTypeListInfoResponse {
	s.RequestId = &v
	return s
}

func (s *GetNodeTypeListInfoResponse) SetNodeTypeInfoList(v *GetNodeTypeListInfoResponseNodeTypeInfoList) *GetNodeTypeListInfoResponse {
	s.NodeTypeInfoList = v
	return s
}

type GetNodeTypeListInfoResponseNodeTypeInfoList struct {
	PageNumber   *int                                                       `json:"PageNumber,omitempty" xml:"PageNumber,omitempty" require:"true"`
	PageSize     *int                                                       `json:"PageSize,omitempty" xml:"PageSize,omitempty" require:"true"`
	TotalCount   *int                                                       `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	NodeTypeInfo []*GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo `json:"NodeTypeInfo,omitempty" xml:"NodeTypeInfo,omitempty" require:"true" type:"Repeated"`
}

func (s GetNodeTypeListInfoResponseNodeTypeInfoList) String() string {
	return tea.Prettify(s)
}

func (s GetNodeTypeListInfoResponseNodeTypeInfoList) GoString() string {
	return s.String()
}

func (s *GetNodeTypeListInfoResponseNodeTypeInfoList) SetPageNumber(v int) *GetNodeTypeListInfoResponseNodeTypeInfoList {
	s.PageNumber = &v
	return s
}

func (s *GetNodeTypeListInfoResponseNodeTypeInfoList) SetPageSize(v int) *GetNodeTypeListInfoResponseNodeTypeInfoList {
	s.PageSize = &v
	return s
}

func (s *GetNodeTypeListInfoResponseNodeTypeInfoList) SetTotalCount(v int) *GetNodeTypeListInfoResponseNodeTypeInfoList {
	s.TotalCount = &v
	return s
}

func (s *GetNodeTypeListInfoResponseNodeTypeInfoList) SetNodeTypeInfo(v []*GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo) *GetNodeTypeListInfoResponseNodeTypeInfoList {
	s.NodeTypeInfo = v
	return s
}

type GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo struct {
	NodeType     *int    `json:"NodeType,omitempty" xml:"NodeType,omitempty" require:"true"`
	NodeTypeName *string `json:"NodeTypeName,omitempty" xml:"NodeTypeName,omitempty" require:"true"`
}

func (s GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo) String() string {
	return tea.Prettify(s)
}

func (s GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo) GoString() string {
	return s.String()
}

func (s *GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo) SetNodeType(v int) *GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo {
	s.NodeType = &v
	return s
}

func (s *GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo) SetNodeTypeName(v string) *GetNodeTypeListInfoResponseNodeTypeInfoListNodeTypeInfo {
	s.NodeTypeName = &v
	return s
}
...
type GetInstanceStatusCountResponse struct {
	RequestId   *string                                    `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	StatusCount *GetInstanceStatusCountResponseStatusCount `json:"StatusCount,omitempty" xml:"StatusCount,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetInstanceStatusCountResponse) SetRequestId(v string) *GetInstanceStatusCountResponse {
	s.RequestId = &v
	return s
}

func (s *GetInstanceStatusCountResponse) SetStatusCount(v *GetInstanceStatusCountResponseStatusCount) *GetInstanceStatusCountResponse {
	s.StatusCount = v
	return s
}

type GetInstanceStatusCountResponseStatusCount struct {
	TotalCount    *int `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	NotRunCount   *int `json:"NotRunCount,omitempty" xml:"NotRunCount,omitempty" require:"true"`
	WaitTimeCount *int `json:"WaitTimeCount,omitempty" xml:"WaitTimeCount,omitempty" require:"true"`
	WaitResCount  *int `json:"WaitResCount,omitempty" xml:"WaitResCount,omitempty" require:"true"`
	RunningCount  *int `json:"RunningCount,omitempty" xml:"RunningCount,omitempty" require:"true"`
	FailureCount  *int `json:"FailureCount,omitempty" xml:"FailureCount,omitempty" require:"true"`
	SuccessCount  *int `json:"SuccessCount,omitempty" xml:"SuccessCount,omitempty" require:"true"`
}

func (s GetInstanceStatusCountResponseStatusCount) String() string {
	return tea.Prettify(s)
}

func (s GetInstanceStatusCountResponseStatusCount) GoString() string {
	return s.String()
}

func (s *GetInstanceStatusCountResponseStatusCount) SetTotalCount(v int) *GetInstanceStatusCountResponseStatusCount {
	s.TotalCount = &v
	return s
}

func (s *GetInstanceStatusCountResponseStatusCount) SetNotRunCount(v int) *GetInstanceStatusCountResponseStatusCount {
	s.NotRunCount = &v
	return s
}

func (s *GetInstanceStatusCountResponseStatusCount) SetWaitTimeCount(v int) *GetInstanceStatusCountResponseStatusCount {
	s.WaitTimeCount = &v
	return s
}

func (s *GetInstanceStatusCountResponseStatusCount) SetWaitResCount(v int) *GetInstanceStatusCountResponseStatusCount {
	s.WaitResCount = &v
	return s
}

func (s *GetInstanceStatusCountResponseStatusCount) SetRunningCount(v int) *GetInstanceStatusCountResponseStatusCount {
	s.RunningCount = &v
	return s
}

func (s *GetInstanceStatusCountResponseStatusCount) SetFailureCount(v int) *GetInstanceStatusCountResponseStatusCount {
	s.FailureCount = &v
	return s
}

func (s *GetInstanceStatusCountResponseStatusCount) SetSuccessCount(v int) *GetInstanceStatusCountResponseStatusCount {
	s.SuccessCount = &v
	return s
}
...
func (s *ListDataServiceFoldersRequest) SetPageNumber(v int) *ListDataServiceFoldersRequest {
	s.PageNumber = &v
	return s
}

func (s *ListDataServiceFoldersRequest) SetPageSize(v int) *ListDataServiceFoldersRequest {
	s.PageSize = &v
	return s
}
...
type ListDataServiceFoldersResponse struct {
	RequestId          *string                                           `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	FolderPagingResult *ListDataServiceFoldersResponseFolderPagingResult `json:"FolderPagingResult,omitempty" xml:"FolderPagingResult,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListDataServiceFoldersResponse) SetRequestId(v string) *ListDataServiceFoldersResponse {
	s.RequestId = &v
	return s
}

func (s *ListDataServiceFoldersResponse) SetFolderPagingResult(v *ListDataServiceFoldersResponseFolderPagingResult) *ListDataServiceFoldersResponse {
	s.FolderPagingResult = v
	return s
}

type ListDataServiceFoldersResponseFolderPagingResult struct {
	PageNumber *int                                                       `json:"PageNumber,omitempty" xml:"PageNumber,omitempty" require:"true"`
	PageSize   *int                                                       `json:"PageSize,omitempty" xml:"PageSize,omitempty" require:"true"`
	TotalCount *int                                                       `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	Folders    []*ListDataServiceFoldersResponseFolderPagingResultFolders `json:"Folders,omitempty" xml:"Folders,omitempty" require:"true" type:"Repeated"`
}

func (s ListDataServiceFoldersResponseFolderPagingResult) String() string {
	return tea.Prettify(s)
}

func (s ListDataServiceFoldersResponseFolderPagingResult) GoString() string {
	return s.String()
}

func (s *ListDataServiceFoldersResponseFolderPagingResult) SetPageNumber(v int) *ListDataServiceFoldersResponseFolderPagingResult {
	s.PageNumber = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResult) SetPageSize(v int) *ListDataServiceFoldersResponseFolderPagingResult {
	s.PageSize = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResult) SetTotalCount(v int) *ListDataServiceFoldersResponseFolderPagingResult {
	s.TotalCount = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResult) SetFolders(v []*ListDataServiceFoldersResponseFolderPagingResultFolders) *ListDataServiceFoldersResponseFolderPagingResult {
	s.Folders = v
	return s
}

type ListDataServiceFoldersResponseFolderPagingResultFolders struct {
	FolderId     *int64  `json:"FolderId,omitempty" xml:"FolderId,omitempty" require:"true"`
...
func (s ListDataServiceFoldersResponseFolderPagingResultFolders) String() string {
	return tea.Prettify(s)
}

func (s ListDataServiceFoldersResponseFolderPagingResultFolders) GoString() string {
	return s.String()
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetFolderId(v int64) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.FolderId = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetFolderName(v string) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.FolderName = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetProjectId(v int64) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.ProjectId = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetTenantId(v int64) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.TenantId = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetCreatedTime(v string) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.CreatedTime = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetModifiedTime(v string) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.ModifiedTime = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetGroupId(v string) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.GroupId = &v
	return s
}

func (s *ListDataServiceFoldersResponseFolderPagingResultFolders) SetParentId(v int64) *ListDataServiceFoldersResponseFolderPagingResultFolders {
	s.ParentId = &v
	return s
}
...
func (s *ListQualityResultsByRuleRequest) SetRuleId(v int) *ListQualityResultsByRuleRequest {
	s.RuleId = &v
	return s
}
...
func (s *ListQualityResultsByRuleRequest) SetPageSize(v int) *ListQualityResultsByRuleRequest {
	s.PageSize = &v
	return s
}

func (s *ListQualityResultsByRuleRequest) SetPageNumber(v int) *ListQualityResultsByRuleRequest {
	s.PageNumber = &v
	return s
}
...
type ListQualityResultsByRuleResponse struct {
	RequestId      *string                                         `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	QualityResults *ListQualityResultsByRuleResponseQualityResults `json:"QualityResults,omitempty" xml:"QualityResults,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListQualityResultsByRuleResponse) SetRequestId(v string) *ListQualityResultsByRuleResponse {
	s.RequestId = &v
	return s
}

func (s *ListQualityResultsByRuleResponse) SetQualityResults(v *ListQualityResultsByRuleResponseQualityResults) *ListQualityResultsByRuleResponse {
	s.QualityResults = v
	return s
}

type ListQualityResultsByRuleResponseQualityResults struct {
	TotalCount *int64                                                      `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	PageNumber *int                                                        `json:"PageNumber,omitempty" xml:"PageNumber,omitempty" require:"true"`
	PageSize   *int                                                        `json:"PageSize,omitempty" xml:"PageSize,omitempty" require:"true"`
	RuleChecks []*ListQualityResultsByRuleResponseQualityResultsRuleChecks `json:"RuleChecks,omitempty" xml:"RuleChecks,omitempty" require:"true" type:"Repeated"`
}

func (s ListQualityResultsByRuleResponseQualityResults) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByRuleResponseQualityResults) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByRuleResponseQualityResults) SetTotalCount(v int64) *ListQualityResultsByRuleResponseQualityResults {
	s.TotalCount = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResults) SetPageNumber(v int) *ListQualityResultsByRuleResponseQualityResults {
	s.PageNumber = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResults) SetPageSize(v int) *ListQualityResultsByRuleResponseQualityResults {
	s.PageSize = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResults) SetRuleChecks(v []*ListQualityResultsByRuleResponseQualityResultsRuleChecks) *ListQualityResultsByRuleResponseQualityResults {
	s.RuleChecks = v
	return s
}

type ListQualityResultsByRuleResponseQualityResultsRuleChecks struct {
	Id                *int                                                                      `json:"Id,omitempty" xml:"Id,omitempty" require:"true"`
	TaskId            *string                                                                   `json:"TaskId,omitempty" xml:"TaskId,omitempty" require:"true"`
	EntityId          *int                                                                      `json:"EntityId,omitempty" xml:"EntityId,omitempty" require:"true"`
	RuleId            *int                                                                      `json:"RuleId,omitempty" xml:"RuleId,omitempty" require:"true"`
	...
	LowerValue        *float32                                                                  `json:"LowerValue,omitempty" xml:"LowerValue,omitempty" require:"true"`
	CheckerName       *string                                                                   `json:"CheckerName,omitempty" xml:"CheckerName,omitempty" require:"true"`
	ReferenceValue    []*ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue `json:"ReferenceValue,omitempty" xml:"ReferenceValue,omitempty" require:"true" type:"Repeated"`
	SampleValue       []*ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue    `json:"SampleValue,omitempty" xml:"SampleValue,omitempty" require:"true" type:"Repeated"`
}

func (s ListQualityResultsByRuleResponseQualityResultsRuleChecks) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByRuleResponseQualityResultsRuleChecks) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetId(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.Id = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetTaskId(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.TaskId = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetEntityId(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.EntityId = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetRuleId(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.RuleId = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetProperty(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.Property = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetBizDate(v int64) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.BizDate = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetDateType(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.DateType = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetActualExpression(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.ActualExpression = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetMatchExpression(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.MatchExpression = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetBlockType(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.BlockType = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetCheckResult(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.CheckResult = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetCheckResultStatus(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.CheckResultStatus = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetMethodName(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.MethodName = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetComment(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.Comment = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetWhereCondition(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.WhereCondition = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetBeginTime(v int64) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.BeginTime = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetEndTime(v int64) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.EndTime = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetTimeCost(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.TimeCost = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetExternalType(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.ExternalType = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetExternalId(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.ExternalId = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetDiscreteCheck(v bool) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.DiscreteCheck = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetFixedCheck(v bool) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.FixedCheck = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetTrend(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.Trend = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetWarningThreshold(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.WarningThreshold = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetCriticalThreshold(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.CriticalThreshold = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetExpectValue(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.ExpectValue = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetOp(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.Op = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetProjectName(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.ProjectName = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetTableName(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.TableName = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetTemplateId(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.TemplateId = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetTemplateName(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.TemplateName = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetResultString(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.ResultString = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetCheckerId(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.CheckerId = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetCheckerType(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.CheckerType = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetRuleName(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.RuleName = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetIsPrediction(v bool) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.IsPrediction = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetUpperValue(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.UpperValue = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetLowerValue(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.LowerValue = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetCheckerName(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.CheckerName = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetReferenceValue(v []*ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.ReferenceValue = v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecks) SetSampleValue(v []*ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue) *ListQualityResultsByRuleResponseQualityResultsRuleChecks {
	s.SampleValue = v
	return s
}

type ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue struct {
	BizDate           *int64   `json:"BizDate,omitempty" xml:"BizDate,omitempty" require:"true"`
	DiscreteProperty  *string  `json:"DiscreteProperty,omitempty" xml:"DiscreteProperty,omitempty" require:"true"`
	Value             *float32 `json:"Value,omitempty" xml:"Value,omitempty" require:"true"`
	Threshold         *float32 `json:"Threshold,omitempty" xml:"Threshold,omitempty" require:"true"`
...
func (s ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) SetBizDate(v int64) *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue {
	s.BizDate = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) SetDiscreteProperty(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue {
	s.DiscreteProperty = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) SetValue(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue {
	s.Value = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) SetThreshold(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue {
	s.Threshold = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue) SetSingleCheckResult(v int) *ListQualityResultsByRuleResponseQualityResultsRuleChecksReferenceValue {
	s.SingleCheckResult = &v
	return s
}

type ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue struct {
	BizDate          *int64   `json:"BizDate,omitempty" xml:"BizDate,omitempty" require:"true"`
	DiscreteProperty *string  `json:"DiscreteProperty,omitempty" xml:"DiscreteProperty,omitempty" require:"true"`
	Value            *float32 `json:"Value,omitempty" xml:"Value,omitempty" require:"true"`
}

func (s ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue) String() string {
	return tea.Prettify(s)
}

func (s ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue) GoString() string {
	return s.String()
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue) SetBizDate(v int64) *ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue {
	s.BizDate = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue) SetDiscreteProperty(v string) *ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue {
	s.DiscreteProperty = &v
	return s
}

func (s *ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue) SetValue(v float32) *ListQualityResultsByRuleResponseQualityResultsRuleChecksSampleValue {
	s.Value = &v
	return s
}
...
type ListMetaDBResponse struct {
	RequestId    *string                         `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	DatabaseInfo *ListMetaDBResponseDatabaseInfo `json:"DatabaseInfo,omitempty" xml:"DatabaseInfo,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListMetaDBResponse) SetRequestId(v string) *ListMetaDBResponse {
	s.RequestId = &v
	return s
}

func (s *ListMetaDBResponse) SetDatabaseInfo(v *ListMetaDBResponseDatabaseInfo) *ListMetaDBResponse {
	s.DatabaseInfo = v
	return s
}

type ListMetaDBResponseDatabaseInfo struct {
	TotalCount *int64                                  `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	DbList     []*ListMetaDBResponseDatabaseInfoDbList `json:"DbList,omitempty" xml:"DbList,omitempty" require:"true" type:"Repeated"`
}

func (s ListMetaDBResponseDatabaseInfo) String() string {
	return tea.Prettify(s)
}

func (s ListMetaDBResponseDatabaseInfo) GoString() string {
	return s.String()
}

func (s *ListMetaDBResponseDatabaseInfo) SetTotalCount(v int64) *ListMetaDBResponseDatabaseInfo {
	s.TotalCount = &v
	return s
}

func (s *ListMetaDBResponseDatabaseInfo) SetDbList(v []*ListMetaDBResponseDatabaseInfoDbList) *ListMetaDBResponseDatabaseInfo {
	s.DbList = v
	return s
}

type ListMetaDBResponseDatabaseInfoDbList struct {
	Name              *string `json:"Name,omitempty" xml:"Name,omitempty" require:"true"`
	Type              *string `json:"Type,omitempty" xml:"Type,omitempty" require:"true"`
...
func (s ListMetaDBResponseDatabaseInfoDbList) String() string {
	return tea.Prettify(s)
}

func (s ListMetaDBResponseDatabaseInfoDbList) GoString() string {
	return s.String()
}

func (s *ListMetaDBResponseDatabaseInfoDbList) SetName(v string) *ListMetaDBResponseDatabaseInfoDbList {
	s.Name = &v
	return s
}

func (s *ListMetaDBResponseDatabaseInfoDbList) SetType(v string) *ListMetaDBResponseDatabaseInfoDbList {
	s.Type = &v
	return s
}

func (s *ListMetaDBResponseDatabaseInfoDbList) SetOwnerId(v string) *ListMetaDBResponseDatabaseInfoDbList {
	s.OwnerId = &v
	return s
}

func (s *ListMetaDBResponseDatabaseInfoDbList) SetLocation(v string) *ListMetaDBResponseDatabaseInfoDbList {
	s.Location = &v
	return s
}

func (s *ListMetaDBResponseDatabaseInfoDbList) SetCreateTimeStamp(v int64) *ListMetaDBResponseDatabaseInfoDbList {
	s.CreateTimeStamp = &v
	return s
}

func (s *ListMetaDBResponseDatabaseInfoDbList) SetModifiedTimeStamp(v int64) *ListMetaDBResponseDatabaseInfoDbList {
	s.ModifiedTimeStamp = &v
	return s
}

func (s *ListMetaDBResponseDatabaseInfoDbList) SetUUID(v string) *ListMetaDBResponseDatabaseInfoDbList {
	s.UUID = &v
	return s
}

type CreateTableRequest struct {
	HasPart           *int                         `json:"HasPart,omitempty" xml:"HasPart,omitempty"`
	Columns           []*CreateTableRequestColumns `json:"Columns,omitempty" xml:"Columns,omitempty" require:"true" type:"Repeated"`
	IsView            *int                         `json:"IsView,omitempty" xml:"IsView,omitempty"`
	Visibility        *int                         `json:"Visibility,omitempty" xml:"Visibility,omitempty"`
	LifeCycle         *int                         `json:"LifeCycle,omitempty" xml:"LifeCycle,omitempty"`
...
func (s *CreateTableRequest) SetHasPart(v int) *CreateTableRequest {
	s.HasPart = &v
	return s
}
...
func (s *CreateTableRequest) SetIsView(v int) *CreateTableRequest {
	s.IsView = &v
	return s
}

func (s *CreateTableRequest) SetVisibility(v int) *CreateTableRequest {
	s.Visibility = &v
	return s
}

func (s *CreateTableRequest) SetLifeCycle(v int) *CreateTableRequest {
	s.LifeCycle = &v
	return s
}
...
func (s *CreateTableRequest) SetEnvType(v int) *CreateTableRequest {
	s.EnvType = &v
	return s
}
...
type CreateTableRequestColumns struct {
	...
	SeqNumber      *int    `json:"SeqNumber,omitempty" xml:"SeqNumber,omitempty"`
	Length         *int    `json:"Length,omitempty" xml:"Length,omitempty"`
	IsPartitionCol *int    `json:"IsPartitionCol,omitempty" xml:"IsPartitionCol,omitempty"`
	IsPrimaryKey   *int    `json:"IsPrimaryKey,omitempty" xml:"IsPrimaryKey,omitempty"`
	IsNullable     *int    `json:"IsNullable,omitempty" xml:"IsNullable,omitempty"`
	Comment        *string `json:"Comment,omitempty" xml:"Comment,omitempty"`
}
...
func (s *CreateTableRequestColumns) SetSeqNumber(v int) *CreateTableRequestColumns {
	s.SeqNumber = &v
	return s
}

func (s *CreateTableRequestColumns) SetLength(v int) *CreateTableRequestColumns {
	s.Length = &v
	return s
}

func (s *CreateTableRequestColumns) SetIsPartitionCol(v int) *CreateTableRequestColumns {
	s.IsPartitionCol = &v
	return s
}

func (s *CreateTableRequestColumns) SetIsPrimaryKey(v int) *CreateTableRequestColumns {
	s.IsPrimaryKey = &v
	return s
}

func (s *CreateTableRequestColumns) SetIsNullable(v int) *CreateTableRequestColumns {
	s.IsNullable = &v
	return s
}
...
type CreateTableRequestThemes struct {
	...
	ThemeLevel *int   `json:"ThemeLevel,omitempty" xml:"ThemeLevel,omitempty"`
}
...
func (s *CreateTableRequestThemes) SetThemeLevel(v int) *CreateTableRequestThemes {
	s.ThemeLevel = &v
	return s
}
...
type CreateTableResponse struct {
	RequestId *string                      `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	TaskInfo  *CreateTableResponseTaskInfo `json:"TaskInfo,omitempty" xml:"TaskInfo,omitempty" require:"true" type:"Struct"`
}
...
func (s *CreateTableResponse) SetRequestId(v string) *CreateTableResponse {
	s.RequestId = &v
	return s
}

func (s *CreateTableResponse) SetTaskInfo(v *CreateTableResponseTaskInfo) *CreateTableResponse {
	s.TaskInfo = v
	return s
}

type CreateTableResponseTaskInfo struct {
	TaskId     *string `json:"TaskId,omitempty" xml:"TaskId,omitempty" require:"true"`
	Content    *string `json:"Content,omitempty" xml:"Content,omitempty" require:"true"`
	Status     *string `json:"Status,omitempty" xml:"Status,omitempty" require:"true"`
	NextTaskId *string `json:"NextTaskId,omitempty" xml:"NextTaskId,omitempty" require:"true"`
}

func (s CreateTableResponseTaskInfo) String() string {
	return tea.Prettify(s)
}

func (s CreateTableResponseTaskInfo) GoString() string {
	return s.String()
}

func (s *CreateTableResponseTaskInfo) SetTaskId(v string) *CreateTableResponseTaskInfo {
	s.TaskId = &v
	return s
}

func (s *CreateTableResponseTaskInfo) SetContent(v string) *CreateTableResponseTaskInfo {
	s.Content = &v
	return s
}

func (s *CreateTableResponseTaskInfo) SetStatus(v string) *CreateTableResponseTaskInfo {
	s.Status = &v
	return s
}

func (s *CreateTableResponseTaskInfo) SetNextTaskId(v string) *CreateTableResponseTaskInfo {
	s.NextTaskId = &v
	return s
}
...
func (s *CreateTableThemeRequest) SetLevel(v int) *CreateTableThemeRequest {
	s.Level = &v
	return s
}
...
type CreateTableThemeResponse struct {
	...
	HttpStatusCode *int    `json:"HttpStatusCode,omitempty" xml:"HttpStatusCode,omitempty" require:"true"`
	Success        *bool   `json:"Success,omitempty" xml:"Success,omitempty" require:"true"`
	ThemeId        *int64  `json:"ThemeId,omitempty" xml:"ThemeId,omitempty" require:"true"`
}
...
func (s *CreateTableThemeResponse) SetRequestId(v string) *CreateTableThemeResponse {
	s.RequestId = &v
	return s
}

func (s *CreateTableThemeResponse) SetErrorCode(v string) *CreateTableThemeResponse {
	s.ErrorCode = &v
	return s
}

func (s *CreateTableThemeResponse) SetErrorMessage(v string) *CreateTableThemeResponse {
	s.ErrorMessage = &v
	return s
}

func (s *CreateTableThemeResponse) SetHttpStatusCode(v int) *CreateTableThemeResponse {
	s.HttpStatusCode = &v
	return s
}

func (s *CreateTableThemeResponse) SetSuccess(v bool) *CreateTableThemeResponse {
	s.Success = &v
	return s
}

func (s *CreateTableThemeResponse) SetThemeId(v int64) *CreateTableThemeResponse {
	s.ThemeId = &v
	return s
}
...
type GetInstanceErrorRankResponse struct {
	RequestId         *string                                        `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	InstanceErrorRank *GetInstanceErrorRankResponseInstanceErrorRank `json:"InstanceErrorRank,omitempty" xml:"InstanceErrorRank,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetInstanceErrorRankResponse) SetRequestId(v string) *GetInstanceErrorRankResponse {
	s.RequestId = &v
	return s
}

func (s *GetInstanceErrorRankResponse) SetInstanceErrorRank(v *GetInstanceErrorRankResponseInstanceErrorRank) *GetInstanceErrorRankResponse {
	s.InstanceErrorRank = v
	return s
}

type GetInstanceErrorRankResponseInstanceErrorRank struct {
	UpdateTime *int64                                                    `json:"UpdateTime,omitempty" xml:"UpdateTime,omitempty" require:"true"`
	ErrorRank  []*GetInstanceErrorRankResponseInstanceErrorRankErrorRank `json:"ErrorRank,omitempty" xml:"ErrorRank,omitempty" require:"true" type:"Repeated"`
}

func (s GetInstanceErrorRankResponseInstanceErrorRank) String() string {
	return tea.Prettify(s)
}

func (s GetInstanceErrorRankResponseInstanceErrorRank) GoString() string {
	return s.String()
}

func (s *GetInstanceErrorRankResponseInstanceErrorRank) SetUpdateTime(v int64) *GetInstanceErrorRankResponseInstanceErrorRank {
	s.UpdateTime = &v
	return s
}

func (s *GetInstanceErrorRankResponseInstanceErrorRank) SetErrorRank(v []*GetInstanceErrorRankResponseInstanceErrorRankErrorRank) *GetInstanceErrorRankResponseInstanceErrorRank {
	s.ErrorRank = v
	return s
}

type GetInstanceErrorRankResponseInstanceErrorRankErrorRank struct {
	NodeId    *int64  `json:"NodeId,omitempty" xml:"NodeId,omitempty" require:"true"`
	NodeName  *string `json:"NodeName,omitempty" xml:"NodeName,omitempty" require:"true"`
...
func (s GetInstanceErrorRankResponseInstanceErrorRankErrorRank) String() string {
	return tea.Prettify(s)
}

func (s GetInstanceErrorRankResponseInstanceErrorRankErrorRank) GoString() string {
	return s.String()
}

func (s *GetInstanceErrorRankResponseInstanceErrorRankErrorRank) SetNodeId(v int64) *GetInstanceErrorRankResponseInstanceErrorRankErrorRank {
	s.NodeId = &v
	return s
}

func (s *GetInstanceErrorRankResponseInstanceErrorRankErrorRank) SetNodeName(v string) *GetInstanceErrorRankResponseInstanceErrorRankErrorRank {
	s.NodeName = &v
	return s
}

func (s *GetInstanceErrorRankResponseInstanceErrorRankErrorRank) SetOwner(v string) *GetInstanceErrorRankResponseInstanceErrorRankErrorRank {
	s.Owner = &v
	return s
}

func (s *GetInstanceErrorRankResponseInstanceErrorRankErrorRank) SetCount(v int) *GetInstanceErrorRankResponseInstanceErrorRankErrorRank {
	s.Count = &v
	return s
}

func (s *GetInstanceErrorRankResponseInstanceErrorRankErrorRank) SetProjectId(v int64) *GetInstanceErrorRankResponseInstanceErrorRankErrorRank {
	s.ProjectId = &v
	return s
}

func (s *GetInstanceErrorRankResponseInstanceErrorRankErrorRank) SetPrgType(v int) *GetInstanceErrorRankResponseInstanceErrorRankErrorRank {
	s.PrgType = &v
	return s
}
...
type GetDDLJobStatusResponse struct {
	RequestId *string                      `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	Data      *GetDDLJobStatusResponseData `json:"Data,omitempty" xml:"Data,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetDDLJobStatusResponse) SetRequestId(v string) *GetDDLJobStatusResponse {
	s.RequestId = &v
	return s
}

func (s *GetDDLJobStatusResponse) SetData(v *GetDDLJobStatusResponseData) *GetDDLJobStatusResponse {
	s.Data = v
	return s
}

type GetDDLJobStatusResponseData struct {
	NextTaskId *string `json:"NextTaskId,omitempty" xml:"NextTaskId,omitempty" require:"true"`
	Content    *string `json:"Content,omitempty" xml:"Content,omitempty" require:"true"`
	Status     *string `json:"Status,omitempty" xml:"Status,omitempty" require:"true"`
	TaskId     *string `json:"TaskId,omitempty" xml:"TaskId,omitempty" require:"true"`
...
func (s GetDDLJobStatusResponseData) String() string {
	return tea.Prettify(s)
}

func (s GetDDLJobStatusResponseData) GoString() string {
	return s.String()
}

func (s *GetDDLJobStatusResponseData) SetNextTaskId(v string) *GetDDLJobStatusResponseData {
	s.NextTaskId = &v
	return s
}

func (s *GetDDLJobStatusResponseData) SetContent(v string) *GetDDLJobStatusResponseData {
	s.Content = &v
	return s
}

func (s *GetDDLJobStatusResponseData) SetStatus(v string) *GetDDLJobStatusResponseData {
	s.Status = &v
	return s
}

func (s *GetDDLJobStatusResponseData) SetTaskId(v string) *GetDDLJobStatusResponseData {
	s.TaskId = &v
	return s
}
...
type GetInstanceConsumeTimeRankResponse struct {
	RequestId               *string                                                    `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	InstanceConsumeTimeRank *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank `json:"InstanceConsumeTimeRank,omitempty" xml:"InstanceConsumeTimeRank,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetInstanceConsumeTimeRankResponse) SetRequestId(v string) *GetInstanceConsumeTimeRankResponse {
	s.RequestId = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponse) SetInstanceConsumeTimeRank(v *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank) *GetInstanceConsumeTimeRankResponse {
	s.InstanceConsumeTimeRank = v
	return s
}

type GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank struct {
	UpdateTime      *int64                                                                      `json:"UpdateTime,omitempty" xml:"UpdateTime,omitempty" require:"true"`
	ConsumeTimeRank []*GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank `json:"ConsumeTimeRank,omitempty" xml:"ConsumeTimeRank,omitempty" require:"true" type:"Repeated"`
}

func (s GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank) String() string {
	return tea.Prettify(s)
}

func (s GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank) GoString() string {
	return s.String()
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank) SetUpdateTime(v int64) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank {
	s.UpdateTime = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank) SetConsumeTimeRank(v []*GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRank {
	s.ConsumeTimeRank = v
	return s
}

type GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank struct {
	NodeName   *string `json:"NodeName,omitempty" xml:"NodeName,omitempty" require:"true"`
	NodeId     *int64  `json:"NodeId,omitempty" xml:"NodeId,omitempty" require:"true"`
	Bizdate    *int64  `json:"Bizdate,omitempty" xml:"Bizdate,omitempty" require:"true"`
	Owner      *string `json:"Owner,omitempty" xml:"Owner,omitempty" require:"true"`
	Consumed   *int64  `json:"Consumed,omitempty" xml:"Consumed,omitempty" require:"true"`
	InstanceId *int64  `json:"InstanceId,omitempty" xml:"InstanceId,omitempty" require:"true"`
	PrgType    *int    `json:"PrgType,omitempty" xml:"PrgType,omitempty" require:"true"`
}

func (s GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) String() string {
	return tea.Prettify(s)
}

func (s GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) GoString() string {
	return s.String()
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) SetNodeName(v string) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank {
	s.NodeName = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) SetNodeId(v int64) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank {
	s.NodeId = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) SetBizdate(v int64) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank {
	s.Bizdate = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) SetOwner(v string) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank {
	s.Owner = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) SetConsumed(v int64) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank {
	s.Consumed = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) SetInstanceId(v int64) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank {
	s.InstanceId = &v
	return s
}

func (s *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank) SetPrgType(v int) *GetInstanceConsumeTimeRankResponseInstanceConsumeTimeRankConsumeTimeRank {
	s.PrgType = &v
	return s
}
...
type CreateDataServiceApiAuthorityRequest struct {
	...
	AuthorizedProjectId *int64 `json:"AuthorizedProjectId,omitempty" xml:"AuthorizedProjectId,omitempty" require:"true"`
	EndTime             *int64 `json:"EndTime,omitempty" xml:"EndTime,omitempty" require:"true"`
}
...
func (s *CreateDataServiceApiAuthorityResponse) SetSuccess(v bool) *CreateDataServiceApiAuthorityResponse {
	s.Success = &v
	return s
}

func (s *CreateDataServiceApiAuthorityResponse) SetRequestId(v string) *CreateDataServiceApiAuthorityResponse {
	s.RequestId = &v
	return s
}
...
func (s *DeleteDataServiceApiAuthorityResponse) SetSuccess(v bool) *DeleteDataServiceApiAuthorityResponse {
	s.Success = &v
	return s
}

func (s *DeleteDataServiceApiAuthorityResponse) SetRequestId(v string) *DeleteDataServiceApiAuthorityResponse {
	s.RequestId = &v
	return s
}
...
type CreateDataServiceGroupRequest struct {
	TenantId          *int64  `json:"TenantId,omitempty" xml:"TenantId,omitempty" require:"true"`
	ProjectId         *int64  `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	ApiGatewayGroupId *string `json:"ApiGatewayGroupId,omitempty" xml:"ApiGatewayGroupId,omitempty" require:"true"`
...
func (s *CreateDataServiceGroupResponse) SetGroupId(v string) *CreateDataServiceGroupResponse {
	s.GroupId = &v
	return s
}

func (s *CreateDataServiceGroupResponse) SetRequestId(v string) *CreateDataServiceGroupResponse {
	s.RequestId = &v
	return s
}
...
func (s *UpdateMetaTableRequest) SetEnvType(v int) *UpdateMetaTableRequest {
	s.EnvType = &v
	return s
}
...
func (s *UpdateMetaTableRequest) SetVisibility(v int) *UpdateMetaTableRequest {
	s.Visibility = &v
	return s
}
...
type UpdateMetaTableResponse struct {
	RequestId    *string `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	UpdateResult *bool   `json:"UpdateResult,omitempty" xml:"UpdateResult,omitempty" require:"true"`
}
...
func (s *UpdateMetaTableResponse) SetRequestId(v string) *UpdateMetaTableResponse {
	s.RequestId = &v
	return s
}

func (s *UpdateMetaTableResponse) SetUpdateResult(v bool) *UpdateMetaTableResponse {
	s.UpdateResult = &v
	return s
}
...
type GetInstanceCountTrendResponse struct {
	RequestId      *string                                        `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	InstanceCounts []*GetInstanceCountTrendResponseInstanceCounts `json:"InstanceCounts,omitempty" xml:"InstanceCounts,omitempty" require:"true" type:"Repeated"`
}
...
func (s *GetInstanceCountTrendResponse) SetRequestId(v string) *GetInstanceCountTrendResponse {
	s.RequestId = &v
	return s
}

func (s *GetInstanceCountTrendResponse) SetInstanceCounts(v []*GetInstanceCountTrendResponseInstanceCounts) *GetInstanceCountTrendResponse {
	s.InstanceCounts = v
	return s
}

type GetInstanceCountTrendResponseInstanceCounts struct {
	Date  *int64 `json:"Date,omitempty" xml:"Date,omitempty" require:"true"`
	Count *int   `json:"Count,omitempty" xml:"Count,omitempty" require:"true"`
}

func (s GetInstanceCountTrendResponseInstanceCounts) String() string {
	return tea.Prettify(s)
}

func (s GetInstanceCountTrendResponseInstanceCounts) GoString() string {
	return s.String()
}

func (s *GetInstanceCountTrendResponseInstanceCounts) SetDate(v int64) *GetInstanceCountTrendResponseInstanceCounts {
	s.Date = &v
	return s
}

func (s *GetInstanceCountTrendResponseInstanceCounts) SetCount(v int) *GetInstanceCountTrendResponseInstanceCounts {
	s.Count = &v
	return s
}
...
func (s *DeleteTableRequest) SetEnvType(v int) *DeleteTableRequest {
	s.EnvType = &v
	return s
}
...
type DeleteTableResponse struct {
	RequestId *string                      `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	TaskInfo  *DeleteTableResponseTaskInfo `json:"TaskInfo,omitempty" xml:"TaskInfo,omitempty" require:"true" type:"Struct"`
}
...
func (s *DeleteTableResponse) SetRequestId(v string) *DeleteTableResponse {
	s.RequestId = &v
	return s
}

func (s *DeleteTableResponse) SetTaskInfo(v *DeleteTableResponseTaskInfo) *DeleteTableResponse {
	s.TaskInfo = v
	return s
}

type DeleteTableResponseTaskInfo struct {
	TaskId     *string `json:"TaskId,omitempty" xml:"TaskId,omitempty" require:"true"`
	Content    *string `json:"Content,omitempty" xml:"Content,omitempty" require:"true"`
	Status     *string `json:"Status,omitempty" xml:"Status,omitempty" require:"true"`
	NextTaskId *string `json:"NextTaskId,omitempty" xml:"NextTaskId,omitempty" require:"true"`
...
func (s DeleteTableResponseTaskInfo) String() string {
	return tea.Prettify(s)
}

func (s DeleteTableResponseTaskInfo) GoString() string {
	return s.String()
}

func (s *DeleteTableResponseTaskInfo) SetTaskId(v string) *DeleteTableResponseTaskInfo {
	s.TaskId = &v
	return s
}

func (s *DeleteTableResponseTaskInfo) SetContent(v string) *DeleteTableResponseTaskInfo {
	s.Content = &v
	return s
}

func (s *DeleteTableResponseTaskInfo) SetStatus(v string) *DeleteTableResponseTaskInfo {
	s.Status = &v
	return s
}

func (s *DeleteTableResponseTaskInfo) SetNextTaskId(v string) *DeleteTableResponseTaskInfo {
	s.NextTaskId = &v
	return s
}
...
func (s *ListTableThemeRequest) SetPageNum(v int) *ListTableThemeRequest {
	s.PageNum = &v
	return s
}

func (s *ListTableThemeRequest) SetPageSize(v int) *ListTableThemeRequest {
	s.PageSize = &v
	return s
}
...
type ListTableThemeResponse struct {
	...
	HttpStatusCode *int                        `json:"HttpStatusCode,omitempty" xml:"HttpStatusCode,omitempty" require:"true"`
	Success        *bool                       `json:"Success,omitempty" xml:"Success,omitempty" require:"true"`
	Data           *ListTableThemeResponseData `json:"Data,omitempty" xml:"Data,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListTableThemeResponse) SetRequestId(v string) *ListTableThemeResponse {
	s.RequestId = &v
	return s
}

func (s *ListTableThemeResponse) SetErrorCode(v string) *ListTableThemeResponse {
	s.ErrorCode = &v
	return s
}

func (s *ListTableThemeResponse) SetErrorMessage(v string) *ListTableThemeResponse {
	s.ErrorMessage = &v
	return s
}

func (s *ListTableThemeResponse) SetHttpStatusCode(v int) *ListTableThemeResponse {
	s.HttpStatusCode = &v
	return s
}

func (s *ListTableThemeResponse) SetSuccess(v bool) *ListTableThemeResponse {
	s.Success = &v
	return s
}

func (s *ListTableThemeResponse) SetData(v *ListTableThemeResponseData) *ListTableThemeResponse {
	s.Data = v
	return s
}

type ListTableThemeResponseData struct {
	TotalCount *int64                                 `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	ThemeList  []*ListTableThemeResponseDataThemeList `json:"ThemeList,omitempty" xml:"ThemeList,omitempty" require:"true" type:"Repeated"`
}

func (s ListTableThemeResponseData) String() string {
	return tea.Prettify(s)
}

func (s ListTableThemeResponseData) GoString() string {
	return s.String()
}

func (s *ListTableThemeResponseData) SetTotalCount(v int64) *ListTableThemeResponseData {
	s.TotalCount = &v
	return s
}

func (s *ListTableThemeResponseData) SetThemeList(v []*ListTableThemeResponseDataThemeList) *ListTableThemeResponseData {
	s.ThemeList = v
	return s
}

type ListTableThemeResponseDataThemeList struct {
	ThemeId         *int64  `json:"ThemeId,omitempty" xml:"ThemeId,omitempty" require:"true"`
	Name            *string `json:"Name,omitempty" xml:"Name,omitempty" require:"true"`
	Level           *int    `json:"Level,omitempty" xml:"Level,omitempty" require:"true"`
	ParentId        *int64  `json:"ParentId,omitempty" xml:"ParentId,omitempty" require:"true"`
...
func (s ListTableThemeResponseDataThemeList) String() string {
	return tea.Prettify(s)
}

func (s ListTableThemeResponseDataThemeList) GoString() string {
	return s.String()
}

func (s *ListTableThemeResponseDataThemeList) SetThemeId(v int64) *ListTableThemeResponseDataThemeList {
	s.ThemeId = &v
	return s
}

func (s *ListTableThemeResponseDataThemeList) SetName(v string) *ListTableThemeResponseDataThemeList {
	s.Name = &v
	return s
}

func (s *ListTableThemeResponseDataThemeList) SetLevel(v int) *ListTableThemeResponseDataThemeList {
	s.Level = &v
	return s
}

func (s *ListTableThemeResponseDataThemeList) SetParentId(v int64) *ListTableThemeResponseDataThemeList {
	s.ParentId = &v
	return s
}

func (s *ListTableThemeResponseDataThemeList) SetProjectId(v int64) *ListTableThemeResponseDataThemeList {
	s.ProjectId = &v
	return s
}

func (s *ListTableThemeResponseDataThemeList) SetCreator(v string) *ListTableThemeResponseDataThemeList {
	s.Creator = &v
	return s
}

func (s *ListTableThemeResponseDataThemeList) SetCreateTimeStamp(v int64) *ListTableThemeResponseDataThemeList {
	s.CreateTimeStamp = &v
	return s
}
...
type GetSuccessInstanceTrendResponse struct {
	RequestId           *string                                             `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	InstanceStatusTrend *GetSuccessInstanceTrendResponseInstanceStatusTrend `json:"InstanceStatusTrend,omitempty" xml:"InstanceStatusTrend,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetSuccessInstanceTrendResponse) SetRequestId(v string) *GetSuccessInstanceTrendResponse {
	s.RequestId = &v
	return s
}

func (s *GetSuccessInstanceTrendResponse) SetInstanceStatusTrend(v *GetSuccessInstanceTrendResponseInstanceStatusTrend) *GetSuccessInstanceTrendResponse {
	s.InstanceStatusTrend = v
	return s
}

type GetSuccessInstanceTrendResponseInstanceStatusTrend struct {
	TodayTrend     []*GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend     `json:"TodayTrend,omitempty" xml:"TodayTrend,omitempty" require:"true" type:"Repeated"`
	YesterdayTrend []*GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend `json:"YesterdayTrend,omitempty" xml:"YesterdayTrend,omitempty" require:"true" type:"Repeated"`
	AvgTrend       []*GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend       `json:"AvgTrend,omitempty" xml:"AvgTrend,omitempty" require:"true" type:"Repeated"`
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrend) String() string {
	return tea.Prettify(s)
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrend) GoString() string {
	return s.String()
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrend) SetTodayTrend(v []*GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend) *GetSuccessInstanceTrendResponseInstanceStatusTrend {
	s.TodayTrend = v
	return s
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrend) SetYesterdayTrend(v []*GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend) *GetSuccessInstanceTrendResponseInstanceStatusTrend {
	s.YesterdayTrend = v
	return s
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrend) SetAvgTrend(v []*GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend) *GetSuccessInstanceTrendResponseInstanceStatusTrend {
	s.AvgTrend = v
	return s
}

type GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend struct {
	Count     *int    `json:"Count,omitempty" xml:"Count,omitempty" require:"true"`
	TimePoint *string `json:"TimePoint,omitempty" xml:"TimePoint,omitempty" require:"true"`
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend) String() string {
	return tea.Prettify(s)
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend) GoString() string {
	return s.String()
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend) SetCount(v int) *GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend {
	s.Count = &v
	return s
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend) SetTimePoint(v string) *GetSuccessInstanceTrendResponseInstanceStatusTrendTodayTrend {
	s.TimePoint = &v
	return s
}

type GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend struct {
	Count     *int    `json:"Count,omitempty" xml:"Count,omitempty" require:"true"`
	TimePoint *string `json:"TimePoint,omitempty" xml:"TimePoint,omitempty" require:"true"`
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend) String() string {
	return tea.Prettify(s)
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend) GoString() string {
	return s.String()
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend) SetCount(v int) *GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend {
	s.Count = &v
	return s
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend) SetTimePoint(v string) *GetSuccessInstanceTrendResponseInstanceStatusTrendYesterdayTrend {
	s.TimePoint = &v
	return s
}

type GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend struct {
	Count     *int    `json:"Count,omitempty" xml:"Count,omitempty" require:"true"`
	TimePoint *string `json:"TimePoint,omitempty" xml:"TimePoint,omitempty" require:"true"`
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend) String() string {
	return tea.Prettify(s)
}

func (s GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend) GoString() string {
	return s.String()
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend) SetCount(v int) *GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend {
	s.Count = &v
	return s
}

func (s *GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend) SetTimePoint(v string) *GetSuccessInstanceTrendResponseInstanceStatusTrendAvgTrend {
	s.TimePoint = &v
	return s
}
...
type UpdateTableRequest struct {
	HasPart           *int                         `json:"HasPart,omitempty" xml:"HasPart,omitempty"`
	Columns           []*UpdateTableRequestColumns `json:"Columns,omitempty" xml:"Columns,omitempty" require:"true" type:"Repeated"`
	IsView            *int                         `json:"IsView,omitempty" xml:"IsView,omitempty"`
	Visibility        *int                         `json:"Visibility,omitempty" xml:"Visibility,omitempty"`
	LifeCycle         *int                         `json:"LifeCycle,omitempty" xml:"LifeCycle,omitempty"`
	CategoryId        *int64                       `json:"CategoryId,omitempty" xml:"CategoryId,omitempty"`
...
func (s *UpdateTableRequest) SetHasPart(v int) *UpdateTableRequest {
	s.HasPart = &v
	return s
}
...
func (s *UpdateTableRequest) SetIsView(v int) *UpdateTableRequest {
	s.IsView = &v
	return s
}

func (s *UpdateTableRequest) SetVisibility(v int) *UpdateTableRequest {
	s.Visibility = &v
	return s
}

func (s *UpdateTableRequest) SetLifeCycle(v int) *UpdateTableRequest {
	s.LifeCycle = &v
	return s
}
...
func (s *UpdateTableRequest) SetEnvType(v int) *UpdateTableRequest {
	s.EnvType = &v
	return s
}
...
func (s *UpdateTableRequestColumns) SetSeqNumber(v int) *UpdateTableRequestColumns {
	s.SeqNumber = &v
	return s
}

func (s *UpdateTableRequestColumns) SetLength(v int) *UpdateTableRequestColumns {
	s.Length = &v
	return s
}

func (s *UpdateTableRequestColumns) SetIsPartitionCol(v int) *UpdateTableRequestColumns {
	s.IsPartitionCol = &v
	return s
}

func (s *UpdateTableRequestColumns) SetIsPrimaryKey(v int) *UpdateTableRequestColumns {
	s.IsPrimaryKey = &v
	return s
}

func (s *UpdateTableRequestColumns) SetIsNullable(v int) *UpdateTableRequestColumns {
	s.IsNullable = &v
	return s
}
...
func (s *UpdateTableRequestThemes) SetThemeLevel(v int) *UpdateTableRequestThemes {
	s.ThemeLevel = &v
	return s
}
...
type UpdateTableResponse struct {
	RequestId *string                      `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	TaskInfo  *UpdateTableResponseTaskInfo `json:"TaskInfo,omitempty" xml:"TaskInfo,omitempty" require:"true" type:"Struct"`
}
...
func (s *UpdateTableResponse) SetRequestId(v string) *UpdateTableResponse {
	s.RequestId = &v
	return s
}

func (s *UpdateTableResponse) SetTaskInfo(v *UpdateTableResponseTaskInfo) *UpdateTableResponse {
	s.TaskInfo = v
	return s
}

type UpdateTableResponseTaskInfo struct {
	TaskId     *string `json:"TaskId,omitempty" xml:"TaskId,omitempty" require:"true"`
	Content    *string `json:"Content,omitempty" xml:"Content,omitempty" require:"true"`
	Status     *string `json:"Status,omitempty" xml:"Status,omitempty" require:"true"`
	NextTaskId *string `json:"NextTaskId,omitempty" xml:"NextTaskId,omitempty" require:"true"`
...
func (s UpdateTableResponseTaskInfo) String() string {
	return tea.Prettify(s)
}

func (s UpdateTableResponseTaskInfo) GoString() string {
	return s.String()
}

func (s *UpdateTableResponseTaskInfo) SetTaskId(v string) *UpdateTableResponseTaskInfo {
	s.TaskId = &v
	return s
}

func (s *UpdateTableResponseTaskInfo) SetContent(v string) *UpdateTableResponseTaskInfo {
	s.Content = &v
	return s
}

func (s *UpdateTableResponseTaskInfo) SetStatus(v string) *UpdateTableResponseTaskInfo {
	s.Status = &v
	return s
}

func (s *UpdateTableResponseTaskInfo) SetNextTaskId(v string) *UpdateTableResponseTaskInfo {
	s.NextTaskId = &v
	return s
}
...
type GetDataServiceFolderResponse struct {
	RequestId *string                             `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	Folder    *GetDataServiceFolderResponseFolder `json:"Folder,omitempty" xml:"Folder,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetDataServiceFolderResponse) SetRequestId(v string) *GetDataServiceFolderResponse {
	s.RequestId = &v
	return s
}

func (s *GetDataServiceFolderResponse) SetFolder(v *GetDataServiceFolderResponseFolder) *GetDataServiceFolderResponse {
	s.Folder = v
	return s
}

type GetDataServiceFolderResponseFolder struct {
	TenantId     *int64  `json:"TenantId,omitempty" xml:"TenantId,omitempty" require:"true"`
	ProjectId    *int64  `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	FolderId     *int64  `json:"FolderId,omitempty" xml:"FolderId,omitempty" require:"true"`
	FolderName   *string `json:"FolderName,omitempty" xml:"FolderName,omitempty" require:"true"`
...
func (s GetDataServiceFolderResponseFolder) String() string {
	return tea.Prettify(s)
}

func (s GetDataServiceFolderResponseFolder) GoString() string {
	return s.String()
}

func (s *GetDataServiceFolderResponseFolder) SetTenantId(v int64) *GetDataServiceFolderResponseFolder {
	s.TenantId = &v
	return s
}

func (s *GetDataServiceFolderResponseFolder) SetProjectId(v int64) *GetDataServiceFolderResponseFolder {
	s.ProjectId = &v
	return s
}

func (s *GetDataServiceFolderResponseFolder) SetFolderId(v int64) *GetDataServiceFolderResponseFolder {
	s.FolderId = &v
	return s
}

func (s *GetDataServiceFolderResponseFolder) SetFolderName(v string) *GetDataServiceFolderResponseFolder {
	s.FolderName = &v
	return s
}

func (s *GetDataServiceFolderResponseFolder) SetCreatedTime(v string) *GetDataServiceFolderResponseFolder {
	s.CreatedTime = &v
	return s
}

func (s *GetDataServiceFolderResponseFolder) SetModifiedTime(v string) *GetDataServiceFolderResponseFolder {
	s.ModifiedTime = &v
	return s
}

func (s *GetDataServiceFolderResponseFolder) SetGroupId(v string) *GetDataServiceFolderResponseFolder {
	s.GroupId = &v
	return s
}

func (s *GetDataServiceFolderResponseFolder) SetParentId(v int64) *GetDataServiceFolderResponseFolder {
	s.ParentId = &v
	return s
}
...
type ListTableLevelRequest struct {
	ProjectId *int64 `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	LevelType *int   `json:"LevelType,omitempty" xml:"LevelType,omitempty" require:"true"`
}
...
func (s *ListTableLevelRequest) SetLevelType(v int) *ListTableLevelRequest {
	s.LevelType = &v
	return s
}
...
type ListTableLevelResponse struct {
	...
	HttpStatusCode *int                                  `json:"HttpStatusCode,omitempty" xml:"HttpStatusCode,omitempty" require:"true"`
	Success        *bool                                 `json:"Success,omitempty" xml:"Success,omitempty" require:"true"`
	TableLevelInfo *ListTableLevelResponseTableLevelInfo `json:"TableLevelInfo,omitempty" xml:"TableLevelInfo,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListTableLevelResponse) SetRequestId(v string) *ListTableLevelResponse {
	s.RequestId = &v
	return s
}

func (s *ListTableLevelResponse) SetErrorCode(v string) *ListTableLevelResponse {
	s.ErrorCode = &v
	return s
}

func (s *ListTableLevelResponse) SetErrorMessage(v string) *ListTableLevelResponse {
	s.ErrorMessage = &v
	return s
}

func (s *ListTableLevelResponse) SetHttpStatusCode(v int) *ListTableLevelResponse {
	s.HttpStatusCode = &v
	return s
}

func (s *ListTableLevelResponse) SetSuccess(v bool) *ListTableLevelResponse {
	s.Success = &v
	return s
}

func (s *ListTableLevelResponse) SetTableLevelInfo(v *ListTableLevelResponseTableLevelInfo) *ListTableLevelResponse {
	s.TableLevelInfo = v
	return s
}

type ListTableLevelResponseTableLevelInfo struct {
	TotalCount *int64                                           `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	LevelList  []*ListTableLevelResponseTableLevelInfoLevelList `json:"LevelList,omitempty" xml:"LevelList,omitempty" require:"true" type:"Repeated"`
}

func (s ListTableLevelResponseTableLevelInfo) String() string {
	return tea.Prettify(s)
}

func (s ListTableLevelResponseTableLevelInfo) GoString() string {
	return s.String()
}

func (s *ListTableLevelResponseTableLevelInfo) SetTotalCount(v int64) *ListTableLevelResponseTableLevelInfo {
	s.TotalCount = &v
	return s
}

func (s *ListTableLevelResponseTableLevelInfo) SetLevelList(v []*ListTableLevelResponseTableLevelInfoLevelList) *ListTableLevelResponseTableLevelInfo {
	s.LevelList = v
	return s
}

type ListTableLevelResponseTableLevelInfoLevelList struct {
	LevelId     *int64  `json:"LevelId,omitempty" xml:"LevelId,omitempty" require:"true"`
	Name        *string `json:"Name,omitempty" xml:"Name,omitempty" require:"true"`
	ProjectId   *int64  `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	LevelType   *int    `json:"LevelType,omitempty" xml:"LevelType,omitempty" require:"true"`
...
func (s ListTableLevelResponseTableLevelInfoLevelList) String() string {
	return tea.Prettify(s)
}

func (s ListTableLevelResponseTableLevelInfoLevelList) GoString() string {
	return s.String()
}

func (s *ListTableLevelResponseTableLevelInfoLevelList) SetLevelId(v int64) *ListTableLevelResponseTableLevelInfoLevelList {
	s.LevelId = &v
	return s
}

func (s *ListTableLevelResponseTableLevelInfoLevelList) SetName(v string) *ListTableLevelResponseTableLevelInfoLevelList {
	s.Name = &v
	return s
}

func (s *ListTableLevelResponseTableLevelInfoLevelList) SetProjectId(v int64) *ListTableLevelResponseTableLevelInfoLevelList {
	s.ProjectId = &v
	return s
}

func (s *ListTableLevelResponseTableLevelInfoLevelList) SetLevelType(v int) *ListTableLevelResponseTableLevelInfoLevelList {
	s.LevelType = &v
	return s
}

func (s *ListTableLevelResponseTableLevelInfoLevelList) SetDescription(v string) *ListTableLevelResponseTableLevelInfoLevelList {
	s.Description = &v
	return s
}
...
func (s *ListDataServiceGroupsRequest) SetPageNumber(v int) *ListDataServiceGroupsRequest {
	s.PageNumber = &v
	return s
}

func (s *ListDataServiceGroupsRequest) SetPageSize(v int) *ListDataServiceGroupsRequest {
	s.PageSize = &v
	return s
}
...
type ListDataServiceGroupsResponse struct {
	RequestId         *string                                         `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	GroupPagingResult *ListDataServiceGroupsResponseGroupPagingResult `json:"GroupPagingResult,omitempty" xml:"GroupPagingResult,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListDataServiceGroupsResponse) SetRequestId(v string) *ListDataServiceGroupsResponse {
	s.RequestId = &v
	return s
}

func (s *ListDataServiceGroupsResponse) SetGroupPagingResult(v *ListDataServiceGroupsResponseGroupPagingResult) *ListDataServiceGroupsResponse {
	s.GroupPagingResult = v
	return s
}

type ListDataServiceGroupsResponseGroupPagingResult struct {
	PageNumber *int                                                    `json:"PageNumber,omitempty" xml:"PageNumber,omitempty" require:"true"`
	PageSize   *int                                                    `json:"PageSize,omitempty" xml:"PageSize,omitempty" require:"true"`
	TotalCount *int                                                    `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	Groups     []*ListDataServiceGroupsResponseGroupPagingResultGroups `json:"Groups,omitempty" xml:"Groups,omitempty" require:"true" type:"Repeated"`
}

func (s ListDataServiceGroupsResponseGroupPagingResult) String() string {
	return tea.Prettify(s)
}

func (s ListDataServiceGroupsResponseGroupPagingResult) GoString() string {
	return s.String()
}

func (s *ListDataServiceGroupsResponseGroupPagingResult) SetPageNumber(v int) *ListDataServiceGroupsResponseGroupPagingResult {
	s.PageNumber = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResult) SetPageSize(v int) *ListDataServiceGroupsResponseGroupPagingResult {
	s.PageSize = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResult) SetTotalCount(v int) *ListDataServiceGroupsResponseGroupPagingResult {
	s.TotalCount = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResult) SetGroups(v []*ListDataServiceGroupsResponseGroupPagingResultGroups) *ListDataServiceGroupsResponseGroupPagingResult {
	s.Groups = v
	return s
}

type ListDataServiceGroupsResponseGroupPagingResultGroups struct {
	TenantId          *int64  `json:"TenantId,omitempty" xml:"TenantId,omitempty" require:"true"`
	GroupId           *string `json:"GroupId,omitempty" xml:"GroupId,omitempty" require:"true"`
	ApiGatewayGroupId *string `json:"ApiGatewayGroupId,omitempty" xml:"ApiGatewayGroupId,omitempty" require:"true"`
	GroupName         *string `json:"GroupName,omitempty" xml:"GroupName,omitempty" require:"true"`
...
func (s ListDataServiceGroupsResponseGroupPagingResultGroups) String() string {
	return tea.Prettify(s)
}

func (s ListDataServiceGroupsResponseGroupPagingResultGroups) GoString() string {
	return s.String()
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetTenantId(v int64) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.TenantId = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetGroupId(v string) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.GroupId = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetApiGatewayGroupId(v string) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.ApiGatewayGroupId = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetGroupName(v string) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.GroupName = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetDescription(v string) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.Description = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetCreatedTime(v string) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.CreatedTime = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetModifiedTime(v string) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.ModifiedTime = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetCreatorId(v string) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.CreatorId = &v
	return s
}

func (s *ListDataServiceGroupsResponseGroupPagingResultGroups) SetProjectId(v int64) *ListDataServiceGroupsResponseGroupPagingResultGroups {
	s.ProjectId = &v
	return s
}
...
func (s *UpdateTableThemeResponse) SetRequestId(v string) *UpdateTableThemeResponse {
	s.RequestId = &v
	return s
}

func (s *UpdateTableThemeResponse) SetErrorCode(v string) *UpdateTableThemeResponse {
	s.ErrorCode = &v
	return s
}

func (s *UpdateTableThemeResponse) SetErrorMessage(v string) *UpdateTableThemeResponse {
	s.ErrorMessage = &v
	return s
}

func (s *UpdateTableThemeResponse) SetHttpStatusCode(v int) *UpdateTableThemeResponse {
	s.HttpStatusCode = &v
	return s
}

func (s *UpdateTableThemeResponse) SetSuccess(v bool) *UpdateTableThemeResponse {
	s.Success = &v
	return s
}

func (s *UpdateTableThemeResponse) SetUpdateResult(v bool) *UpdateTableThemeResponse {
	s.UpdateResult = &v
	return s
}
...
func (s *CreateDataServiceFolderResponse) SetFolderId(v int64) *CreateDataServiceFolderResponse {
	s.FolderId = &v
	return s
}

func (s *CreateDataServiceFolderResponse) SetRequestId(v string) *CreateDataServiceFolderResponse {
	s.RequestId = &v
	return s
}
...
type GetDataServiceGroupResponse struct {
	RequestId *string                           `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	Group     *GetDataServiceGroupResponseGroup `json:"Group,omitempty" xml:"Group,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetDataServiceGroupResponse) SetRequestId(v string) *GetDataServiceGroupResponse {
	s.RequestId = &v
	return s
}

func (s *GetDataServiceGroupResponse) SetGroup(v *GetDataServiceGroupResponseGroup) *GetDataServiceGroupResponse {
	s.Group = v
	return s
}

type GetDataServiceGroupResponseGroup struct {
	TenantId          *int64  `json:"TenantId,omitempty" xml:"TenantId,omitempty" require:"true"`
	ProjectId         *int64  `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	GroupId           *string `json:"GroupId,omitempty" xml:"GroupId,omitempty" require:"true"`
	ApiGatewayGroupId *string `json:"ApiGatewayGroupId,omitempty" xml:"ApiGatewayGroupId,omitempty" require:"true"`
...
func (s GetDataServiceGroupResponseGroup) String() string {
	return tea.Prettify(s)
}

func (s GetDataServiceGroupResponseGroup) GoString() string {
	return s.String()
}

func (s *GetDataServiceGroupResponseGroup) SetTenantId(v int64) *GetDataServiceGroupResponseGroup {
	s.TenantId = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetProjectId(v int64) *GetDataServiceGroupResponseGroup {
	s.ProjectId = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetGroupId(v string) *GetDataServiceGroupResponseGroup {
	s.GroupId = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetApiGatewayGroupId(v string) *GetDataServiceGroupResponseGroup {
	s.ApiGatewayGroupId = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetGroupName(v string) *GetDataServiceGroupResponseGroup {
	s.GroupName = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetDescription(v string) *GetDataServiceGroupResponseGroup {
	s.Description = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetCreatedTime(v string) *GetDataServiceGroupResponseGroup {
	s.CreatedTime = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetModifiedTime(v string) *GetDataServiceGroupResponseGroup {
	s.ModifiedTime = &v
	return s
}

func (s *GetDataServiceGroupResponseGroup) SetCreatorId(v string) *GetDataServiceGroupResponseGroup {
	s.CreatorId = &v
	return s
}
...
func (s *CreateTableLevelRequest) SetLevelType(v int) *CreateTableLevelRequest {
	s.LevelType = &v
	return s
}
...
func (s *CreateTableLevelResponse) SetRequestId(v string) *CreateTableLevelResponse {
	s.RequestId = &v
	return s
}

func (s *CreateTableLevelResponse) SetErrorCode(v string) *CreateTableLevelResponse {
	s.ErrorCode = &v
	return s
}

func (s *CreateTableLevelResponse) SetErrorMessage(v string) *CreateTableLevelResponse {
	s.ErrorMessage = &v
	return s
}

func (s *CreateTableLevelResponse) SetHttpStatusCode(v int) *CreateTableLevelResponse {
	s.HttpStatusCode = &v
	return s
}

func (s *CreateTableLevelResponse) SetSuccess(v bool) *CreateTableLevelResponse {
	s.Success = &v
	return s
}

func (s *CreateTableLevelResponse) SetLevelId(v int64) *CreateTableLevelResponse {
	s.LevelId = &v
	return s
}
...
func (s *UpdateMetaTableIntroWikiResponse) SetRequestId(v string) *UpdateMetaTableIntroWikiResponse {
	s.RequestId = &v
	return s
}

func (s *UpdateMetaTableIntroWikiResponse) SetUpdateResult(v bool) *UpdateMetaTableIntroWikiResponse {
	s.UpdateResult = &v
	return s
}
...
type DeleteTableLevelResponse struct {
	RequestId    *string `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	DeleteResult *bool   `json:"DeleteResult,omitempty" xml:"DeleteResult,omitempty" require:"true"`
}
...
func (s *DeleteTableLevelResponse) SetRequestId(v string) *DeleteTableLevelResponse {
	s.RequestId = &v
	return s
}

func (s *DeleteTableLevelResponse) SetDeleteResult(v bool) *DeleteTableLevelResponse {
	s.DeleteResult = &v
	return s
}
...
type UpdateTableLevelRequest struct {
	ProjectId   *int64  `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	LevelType   *int    `json:"LevelType,omitempty" xml:"LevelType,omitempty"`
...
func (s *UpdateTableLevelRequest) SetLevelType(v int) *UpdateTableLevelRequest {
	s.LevelType = &v
	return s
}
...
func (s *UpdateTableLevelResponse) SetRequestId(v string) *UpdateTableLevelResponse {
	s.RequestId = &v
	return s
}

func (s *UpdateTableLevelResponse) SetErrorCode(v string) *UpdateTableLevelResponse {
	s.ErrorCode = &v
	return s
}

func (s *UpdateTableLevelResponse) SetErrorMessage(v string) *UpdateTableLevelResponse {
	s.ErrorMessage = &v
	return s
}

func (s *UpdateTableLevelResponse) SetHttpStatusCode(v int) *UpdateTableLevelResponse {
	s.HttpStatusCode = &v
	return s
}

func (s *UpdateTableLevelResponse) SetSuccess(v bool) *UpdateTableLevelResponse {
	s.Success = &v
	return s
}

func (s *UpdateTableLevelResponse) SetUpdateResult(v bool) *UpdateTableLevelResponse {
	s.UpdateResult = &v
	return s
}
...
func (s *DeleteTableThemeResponse) SetRequestId(v string) *DeleteTableThemeResponse {
	s.RequestId = &v
	return s
}

func (s *DeleteTableThemeResponse) SetErrorCode(v string) *DeleteTableThemeResponse {
	s.ErrorCode = &v
	return s
}

func (s *DeleteTableThemeResponse) SetErrorMessage(v string) *DeleteTableThemeResponse {
	s.ErrorMessage = &v
	return s
}

func (s *DeleteTableThemeResponse) SetHttpStatusCode(v int) *DeleteTableThemeResponse {
	s.HttpStatusCode = &v
	return s
}

func (s *DeleteTableThemeResponse) SetSuccess(v bool) *DeleteTableThemeResponse {
	s.Success = &v
	return s
}

func (s *DeleteTableThemeResponse) SetDeleteResult(v bool) *DeleteTableThemeResponse {
	s.DeleteResult = &v
	return s
}
...
type ListProgramTypeCountResponse struct {
	RequestId            *string                                             `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	ProgramTypeAndCounts []*ListProgramTypeCountResponseProgramTypeAndCounts `json:"ProgramTypeAndCounts,omitempty" xml:"ProgramTypeAndCounts,omitempty" require:"true" type:"Repeated"`
}
...
func (s *ListProgramTypeCountResponse) SetRequestId(v string) *ListProgramTypeCountResponse {
	s.RequestId = &v
	return s
}

func (s *ListProgramTypeCountResponse) SetProgramTypeAndCounts(v []*ListProgramTypeCountResponseProgramTypeAndCounts) *ListProgramTypeCountResponse {
	s.ProgramTypeAndCounts = v
	return s
}

type ListProgramTypeCountResponseProgramTypeAndCounts struct {
	ProgramType *string `json:"ProgramType,omitempty" xml:"ProgramType,omitempty" require:"true"`
	Count       *int    `json:"Count,omitempty" xml:"Count,omitempty" require:"true"`
}

func (s ListProgramTypeCountResponseProgramTypeAndCounts) String() string {
	return tea.Prettify(s)
}

func (s ListProgramTypeCountResponseProgramTypeAndCounts) GoString() string {
	return s.String()
}

func (s *ListProgramTypeCountResponseProgramTypeAndCounts) SetProgramType(v string) *ListProgramTypeCountResponseProgramTypeAndCounts {
	s.ProgramType = &v
	return s
}

func (s *ListProgramTypeCountResponseProgramTypeAndCounts) SetCount(v int) *ListProgramTypeCountResponseProgramTypeAndCounts {
	s.Count = &v
	return s
}
...
func (s *UpdateTableModelInfoRequest) SetLevelType(v int) *UpdateTableModelInfoRequest {
	s.LevelType = &v
	return s
}
...
func (s *UpdateTableModelInfoResponse) SetRequestId(v string) *UpdateTableModelInfoResponse {
	s.RequestId = &v
	return s
}

func (s *UpdateTableModelInfoResponse) SetUpdateResult(v bool) *UpdateTableModelInfoResponse {
	s.UpdateResult = &v
	return s
}
...
func (s *ListProjectsRequest) SetPageNumber(v int) *ListProjectsRequest {
	s.PageNumber = &v
	return s
}

func (s *ListProjectsRequest) SetPageSize(v int) *ListProjectsRequest {
	s.PageSize = &v
	return s
}
...
type ListProjectsResponse struct {
	RequestId  *string                         `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	PageResult *ListProjectsResponsePageResult `json:"PageResult,omitempty" xml:"PageResult,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListProjectsResponse) SetRequestId(v string) *ListProjectsResponse {
	s.RequestId = &v
	return s
}

func (s *ListProjectsResponse) SetPageResult(v *ListProjectsResponsePageResult) *ListProjectsResponse {
	s.PageResult = v
	return s
}

type ListProjectsResponsePageResult struct {
	PageNumber  *int                                         `json:"PageNumber,omitempty" xml:"PageNumber,omitempty" require:"true"`
	PageSize    *int                                         `json:"PageSize,omitempty" xml:"PageSize,omitempty" require:"true"`
	TotalCount  *int                                         `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	ProjectList []*ListProjectsResponsePageResultProjectList `json:"ProjectList,omitempty" xml:"ProjectList,omitempty" require:"true" type:"Repeated"`
}

func (s ListProjectsResponsePageResult) String() string {
	return tea.Prettify(s)
}

func (s ListProjectsResponsePageResult) GoString() string {
	return s.String()
}

func (s *ListProjectsResponsePageResult) SetPageNumber(v int) *ListProjectsResponsePageResult {
	s.PageNumber = &v
	return s
}

func (s *ListProjectsResponsePageResult) SetPageSize(v int) *ListProjectsResponsePageResult {
	s.PageSize = &v
	return s
}

func (s *ListProjectsResponsePageResult) SetTotalCount(v int) *ListProjectsResponsePageResult {
	s.TotalCount = &v
	return s
}

func (s *ListProjectsResponsePageResult) SetProjectList(v []*ListProjectsResponsePageResultProjectList) *ListProjectsResponsePageResult {
	s.ProjectList = v
	return s
}

type ListProjectsResponsePageResultProjectList struct {
	ProjectName        *string `json:"ProjectName,omitempty" xml:"ProjectName,omitempty" require:"true"`
	...
	ProjectStatus      *int    `json:"ProjectStatus,omitempty" xml:"ProjectStatus,omitempty" require:"true"`
	ProjectId          *int64  `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	ProjectOwnerBaseId *string `json:"ProjectOwnerBaseId,omitempty" xml:"ProjectOwnerBaseId,omitempty" require:"true"`
	ProjectStatusCode  *string `json:"ProjectStatusCode,omitempty" xml:"ProjectStatusCode,omitempty" require:"true"`
}

func (s ListProjectsResponsePageResultProjectList) String() string {
	return tea.Prettify(s)
}

func (s ListProjectsResponsePageResultProjectList) GoString() string {
	return s.String()
}

func (s *ListProjectsResponsePageResultProjectList) SetProjectName(v string) *ListProjectsResponsePageResultProjectList {
	s.ProjectName = &v
	return s
}

func (s *ListProjectsResponsePageResultProjectList) SetProjectIdentifier(v string) *ListProjectsResponsePageResultProjectList {
	s.ProjectIdentifier = &v
	return s
}

func (s *ListProjectsResponsePageResultProjectList) SetProjectDescription(v string) *ListProjectsResponsePageResultProjectList {
	s.ProjectDescription = &v
	return s
}

func (s *ListProjectsResponsePageResultProjectList) SetProjectStatus(v int) *ListProjectsResponsePageResultProjectList {
	s.ProjectStatus = &v
	return s
}

func (s *ListProjectsResponsePageResultProjectList) SetProjectId(v int64) *ListProjectsResponsePageResultProjectList {
	s.ProjectId = &v
	return s
}

func (s *ListProjectsResponsePageResultProjectList) SetProjectOwnerBaseId(v string) *ListProjectsResponsePageResultProjectList {
	s.ProjectOwnerBaseId = &v
	return s
}

func (s *ListProjectsResponsePageResultProjectList) SetProjectStatusCode(v string) *ListProjectsResponsePageResultProjectList {
...
func (s *ListProjectMembersRequest) SetPageNumber(v int) *ListProjectMembersRequest {
	s.PageNumber = &v
	return s
}

func (s *ListProjectMembersRequest) SetPageSize(v int) *ListProjectMembersRequest {
	s.PageSize = &v
	return s
}
...
type ListProjectMembersResponse struct {
	RequestId *string                         `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	Data      *ListProjectMembersResponseData `json:"Data,omitempty" xml:"Data,omitempty" require:"true" type:"Struct"`
}
...
func (s *ListProjectMembersResponse) SetRequestId(v string) *ListProjectMembersResponse {
	s.RequestId = &v
	return s
}

func (s *ListProjectMembersResponse) SetData(v *ListProjectMembersResponseData) *ListProjectMembersResponse {
	s.Data = v
	return s
}

type ListProjectMembersResponseData struct {
	PageNumber        *int                                               `json:"PageNumber,omitempty" xml:"PageNumber,omitempty" require:"true"`
	PageSize          *int                                               `json:"PageSize,omitempty" xml:"PageSize,omitempty" require:"true"`
	TotalCount        *int                                               `json:"TotalCount,omitempty" xml:"TotalCount,omitempty" require:"true"`
	ProjectMemberList []*ListProjectMembersResponseDataProjectMemberList `json:"ProjectMemberList,omitempty" xml:"ProjectMemberList,omitempty" require:"true" type:"Repeated"`
}

func (s ListProjectMembersResponseData) String() string {
	return tea.Prettify(s)
}

func (s ListProjectMembersResponseData) GoString() string {
	return s.String()
}

func (s *ListProjectMembersResponseData) SetPageNumber(v int) *ListProjectMembersResponseData {
	s.PageNumber = &v
	return s
}

func (s *ListProjectMembersResponseData) SetPageSize(v int) *ListProjectMembersResponseData {
	s.PageSize = &v
	return s
}

func (s *ListProjectMembersResponseData) SetTotalCount(v int) *ListProjectMembersResponseData {
	s.TotalCount = &v
	return s
}

func (s *ListProjectMembersResponseData) SetProjectMemberList(v []*ListProjectMembersResponseDataProjectMemberList) *ListProjectMembersResponseData {
	s.ProjectMemberList = v
	return s
}

type ListProjectMembersResponseDataProjectMemberList struct {
	Nick              *string                                                           `json:"Nick,omitempty" xml:"Nick,omitempty" require:"true"`
	ProjectMemberId   *string                                                           `json:"ProjectMemberId,omitempty" xml:"ProjectMemberId,omitempty" require:"true"`
	ProjectMemberName *string                                                           `json:"ProjectMemberName,omitempty" xml:"ProjectMemberName,omitempty" require:"true"`
	ProjectMemberType *string                                                           `json:"ProjectMemberType,omitempty" xml:"ProjectMemberType,omitempty" require:"true"`
	Status            *string                                                           `json:"Status,omitempty" xml:"Status,omitempty" require:"true"`
	ProjectRoleList   []*ListProjectMembersResponseDataProjectMemberListProjectRoleList `json:"ProjectRoleList,omitempty" xml:"ProjectRoleList,omitempty" require:"true" type:"Repeated"`
}

func (s ListProjectMembersResponseDataProjectMemberList) String() string {
	return tea.Prettify(s)
}

func (s ListProjectMembersResponseDataProjectMemberList) GoString() string {
	return s.String()
}

func (s *ListProjectMembersResponseDataProjectMemberList) SetNick(v string) *ListProjectMembersResponseDataProjectMemberList {
	s.Nick = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberList) SetProjectMemberId(v string) *ListProjectMembersResponseDataProjectMemberList {
	s.ProjectMemberId = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberList) SetProjectMemberName(v string) *ListProjectMembersResponseDataProjectMemberList {
	s.ProjectMemberName = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberList) SetProjectMemberType(v string) *ListProjectMembersResponseDataProjectMemberList {
	s.ProjectMemberType = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberList) SetStatus(v string) *ListProjectMembersResponseDataProjectMemberList {
	s.Status = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberList) SetProjectRoleList(v []*ListProjectMembersResponseDataProjectMemberListProjectRoleList) *ListProjectMembersResponseDataProjectMemberList {
	s.ProjectRoleList = v
	return s
}

type ListProjectMembersResponseDataProjectMemberListProjectRoleList struct {
	ProjectRoleCode *string `json:"ProjectRoleCode,omitempty" xml:"ProjectRoleCode,omitempty" require:"true"`
	ProjectRoleId   *int    `json:"ProjectRoleId,omitempty" xml:"ProjectRoleId,omitempty" require:"true"`
	ProjectRoleName *string `json:"ProjectRoleName,omitempty" xml:"ProjectRoleName,omitempty" require:"true"`
	ProjectRoleType *string `json:"ProjectRoleType,omitempty" xml:"ProjectRoleType,omitempty" require:"true"`
}

func (s ListProjectMembersResponseDataProjectMemberListProjectRoleList) String() string {
	return tea.Prettify(s)
}

func (s ListProjectMembersResponseDataProjectMemberListProjectRoleList) GoString() string {
	return s.String()
}

func (s *ListProjectMembersResponseDataProjectMemberListProjectRoleList) SetProjectRoleCode(v string) *ListProjectMembersResponseDataProjectMemberListProjectRoleList {
	s.ProjectRoleCode = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberListProjectRoleList) SetProjectRoleId(v int) *ListProjectMembersResponseDataProjectMemberListProjectRoleList {
	s.ProjectRoleId = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberListProjectRoleList) SetProjectRoleName(v string) *ListProjectMembersResponseDataProjectMemberListProjectRoleList {
	s.ProjectRoleName = &v
	return s
}

func (s *ListProjectMembersResponseDataProjectMemberListProjectRoleList) SetProjectRoleType(v string) *ListProjectMembersResponseDataProjectMemberListProjectRoleList {
	s.ProjectRoleType = &v
	return s
}
...
func (s *CreateProjectMemberResponse) SetRequestId(v string) *CreateProjectMemberResponse {
	s.RequestId = &v
	return s
}
...
type ListProjectRolesResponse struct {
	RequestId       *string                                    `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	ProjectRoleList []*ListProjectRolesResponseProjectRoleList `json:"ProjectRoleList,omitempty" xml:"ProjectRoleList,omitempty" require:"true" type:"Repeated"`
}
...
func (s *ListProjectRolesResponse) SetRequestId(v string) *ListProjectRolesResponse {
	s.RequestId = &v
	return s
}

func (s *ListProjectRolesResponse) SetProjectRoleList(v []*ListProjectRolesResponseProjectRoleList) *ListProjectRolesResponse {
	s.ProjectRoleList = v
	return s
}

type ListProjectRolesResponseProjectRoleList struct {
	ProjectRoleCode *string `json:"ProjectRoleCode,omitempty" xml:"ProjectRoleCode,omitempty" require:"true"`
	ProjectRoleId   *int    `json:"ProjectRoleId,omitempty" xml:"ProjectRoleId,omitempty" require:"true"`
	ProjectRoleName *string `json:"ProjectRoleName,omitempty" xml:"ProjectRoleName,omitempty" require:"true"`
	ProjectRoleType *string `json:"ProjectRoleType,omitempty" xml:"ProjectRoleType,omitempty" require:"true"`
...
func (s ListProjectRolesResponseProjectRoleList) String() string {
	return tea.Prettify(s)
}

func (s ListProjectRolesResponseProjectRoleList) GoString() string {
	return s.String()
}

func (s *ListProjectRolesResponseProjectRoleList) SetProjectRoleCode(v string) *ListProjectRolesResponseProjectRoleList {
	s.ProjectRoleCode = &v
	return s
}

func (s *ListProjectRolesResponseProjectRoleList) SetProjectRoleId(v int) *ListProjectRolesResponseProjectRoleList {
	s.ProjectRoleId = &v
	return s
}

func (s *ListProjectRolesResponseProjectRoleList) SetProjectRoleName(v string) *ListProjectRolesResponseProjectRoleList {
	s.ProjectRoleName = &v
	return s
}

func (s *ListProjectRolesResponseProjectRoleList) SetProjectRoleType(v string) *ListProjectRolesResponseProjectRoleList {
	s.ProjectRoleType = &v
	return s
}
...
type AddProjectMemberToRoleRequest struct {
	ProjectId   *int64  `json:"ProjectId,omitempty" xml:"ProjectId,omitempty" require:"true"`
	UserId      *string `json:"UserId,omitempty" xml:"UserId,omitempty" require:"true"`
	RoleCode    *string `json:"RoleCode,omitempty" xml:"RoleCode,omitempty" require:"true"`
	ClientToken *string `json:"ClientToken,omitempty" xml:"ClientToken,omitempty"`
}
...
func (s *AddProjectMemberToRoleResponse) SetRequestId(v string) *AddProjectMemberToRoleResponse {
	s.RequestId = &v
	return s
}
...
func (s *RemoveProjectMemberFromRoleResponse) SetRequestId(v string) *RemoveProjectMemberFromRoleResponse {
	s.RequestId = &v
	return s
}
...
func (s *DeleteProjectMemberResponse) SetRequestId(v string) *DeleteProjectMemberResponse {
	s.RequestId = &v
	return s
}
...
type GetMetaTablePartitionResponseDataDataEntityList struct {
	...
	TableGuid         *string `json:"TableGuid,omitempty" xml:"TableGuid,omitempty" require:"true"`
	Comment           *string `json:"Comment,omitempty" xml:"Comment,omitempty" require:"true"`
	PartitionType     *string `json:"PartitionType,omitempty" xml:"PartitionType,omitempty" require:"true"`
	PartitionPath     *string `json:"PartitionPath,omitempty" xml:"PartitionPath,omitempty" require:"true"`
	PartitionLocation *string `json:"PartitionLocation,omitempty" xml:"PartitionLocation,omitempty" require:"true"`
}
...
func (s *GetMetaTablePartitionResponseDataDataEntityList) SetComment(v string) *GetMetaTablePartitionResponseDataDataEntityList {
	s.Comment = &v
	return s
}

func (s *GetMetaTablePartitionResponseDataDataEntityList) SetPartitionType(v string) *GetMetaTablePartitionResponseDataDataEntityList {
	s.PartitionType = &v
	return s
}

func (s *GetMetaTablePartitionResponseDataDataEntityList) SetPartitionPath(v string) *GetMetaTablePartitionResponseDataDataEntityList {
	s.PartitionPath = &v
	return s
}

func (s *GetMetaTablePartitionResponseDataDataEntityList) SetPartitionLocation(v string) *GetMetaTablePartitionResponseDataDataEntityList {
...
type GetMetaTableFullInfoResponseData struct {
	...
	DatabaseName     *string                                       `json:"DatabaseName,omitempty" xml:"DatabaseName,omitempty" require:"true"`
	PartitionKeys    *string                                       `json:"PartitionKeys,omitempty" xml:"PartitionKeys,omitempty" require:"true"`
	Location         *string                                       `json:"Location,omitempty" xml:"Location,omitempty" require:"true"`
...
func (s *GetMetaTableFullInfoResponseData) SetDatabaseName(v string) *GetMetaTableFullInfoResponseData {
	s.DatabaseName = &v
	return s
}

func (s *GetMetaTableFullInfoResponseData) SetPartitionKeys(v string) *GetMetaTableFullInfoResponseData {
	s.PartitionKeys = &v
	return s
}

func (s *GetMetaTableFullInfoResponseData) SetLocation(v string) *GetMetaTableFullInfoResponseData {
	s.Location = &v
	return s
}

func (s *GetMetaTableFullInfoResponseData) SetClusterId(v string) *GetMetaTableFullInfoResponseData {
	s.ClusterId = &v
	return s
}
...
func (s *GetMetaTableBasicInfoResponseData) SetDatabaseName(v string) *GetMetaTableBasicInfoResponseData {
	s.DatabaseName = &v
	return s
}

func (s *GetMetaTableBasicInfoResponseData) SetPartitionKeys(v string) *GetMetaTableBasicInfoResponseData {
	s.PartitionKeys = &v
	return s
}

func (s *GetMetaTableBasicInfoResponseData) SetLocation(v string) *GetMetaTableBasicInfoResponseData {
	s.Location = &v
	return s
}

func (s *GetMetaTableBasicInfoResponseData) SetClusterId(v string) *GetMetaTableBasicInfoResponseData {
	s.ClusterId = &v
	return s
}

func (s *GetMetaTableBasicInfoResponseData) SetCaption(v string) *GetMetaTableBasicInfoResponseData {
	s.Caption = &v
	return s
}
...
type GetMetaDBInfoResponseData struct {
	...
	Comment       *string `json:"Comment,omitempty" xml:"Comment,omitempty" require:"true"`
	Location      *string `json:"Location,omitempty" xml:"Location,omitempty" require:"true"`
	ClusterBizId  *string `json:"ClusterBizId,omitempty" xml:"ClusterBizId,omitempty" require:"true"`
}
...
func (s *GetMetaDBInfoResponseData) SetName(v string) *GetMetaDBInfoResponseData {
	s.Name = &v
	return s
}

func (s *GetMetaDBInfoResponseData) SetType(v string) *GetMetaDBInfoResponseData {
	s.Type = &v
	return s
}

func (s *GetMetaDBInfoResponseData) SetComment(v string) *GetMetaDBInfoResponseData {
	s.Comment = &v
	return s
}

func (s *GetMetaDBInfoResponseData) SetLocation(v string) *GetMetaDBInfoResponseData {
	s.Location = &v
	return s
}

func (s *GetMetaDBInfoResponseData) SetClusterBizId(v string) *GetMetaDBInfoResponseData {
	s.ClusterBizId = &v
	return s
}
...
func (s *SearchMetaTablesResponseDataDataEntityList) SetClusterId(v string) *SearchMetaTablesResponseDataDataEntityList {
	s.ClusterId = &v
	return s
}

func (s *SearchMetaTablesResponseDataDataEntityList) SetDatabaseName(v string) *SearchMetaTablesResponseDataDataEntityList {
	s.DatabaseName = &v
	return s
}
...
func (s *ListFilesResponseDataFiles) SetFileId(v int64) *ListFilesResponseDataFiles {
	s.FileId = &v
	return s
}
...
func (s *GetMetaDBTableListResponseDataTableEntityList) SetDatabaseName(v string) *GetMetaDBTableListResponseDataTableEntityList {
	s.DatabaseName = &v
	return s
}
...
func (s *GetMetaColumnLineageResponseDataDataEntityList) SetClusterId(v string) *GetMetaColumnLineageResponseDataDataEntityList {
	s.ClusterId = &v
	return s
}

func (s *GetMetaColumnLineageResponseDataDataEntityList) SetDatabaseName(v string) *GetMetaColumnLineageResponseDataDataEntityList {
	s.DatabaseName = &v
	return s
}

func (s *GetMetaColumnLineageResponseDataDataEntityList) SetTableName(v string) *GetMetaColumnLineageResponseDataDataEntityList {
	s.TableName = &v
	return s
}
...
func (s *GetDataServiceApiResponseData) SetFolderId(v int64) *GetDataServiceApiResponseData {
	s.FolderId = &v
	return s
}
...
func (s *ListDataServiceApisResponseDataApis) SetFolderId(v int64) *ListDataServiceApisResponseDataApis {
	s.FolderId = &v
	return s
}
...
func (client *Client) ListQualityResultsByEntityWithOptions(request *ListQualityResultsByEntityRequest, runtime *util.RuntimeOptions) (_result *ListQualityResultsByEntityResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListQualityResultsByEntity"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetNodeTypeListInfoWithOptions(request *GetNodeTypeListInfoRequest, runtime *util.RuntimeOptions) (_result *GetNodeTypeListInfoResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetNodeTypeListInfo"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetInstanceStatusCountWithOptions(request *GetInstanceStatusCountRequest, runtime *util.RuntimeOptions) (_result *GetInstanceStatusCountResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetInstanceStatusCount"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListDataServiceFoldersWithOptions(request *ListDataServiceFoldersRequest, runtime *util.RuntimeOptions) (_result *ListDataServiceFoldersResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListDataServiceFolders"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListQualityResultsByRuleWithOptions(request *ListQualityResultsByRuleRequest, runtime *util.RuntimeOptions) (_result *ListQualityResultsByRuleResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListQualityResultsByRule"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListMetaDBWithOptions(request *ListMetaDBRequest, runtime *util.RuntimeOptions) (_result *ListMetaDBResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListMetaDB"), tea.String("HTTPS"), tea.String("GET"), tea.String("2020-05-18"), tea.String("AK"), tea.ToMap(request), nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CreateTableWithOptions(request *CreateTableRequest, runtime *util.RuntimeOptions) (_result *CreateTableResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("CreateTable"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CreateTableThemeWithOptions(request *CreateTableThemeRequest, runtime *util.RuntimeOptions) (_result *CreateTableThemeResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("CreateTableTheme"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetInstanceErrorRankWithOptions(request *GetInstanceErrorRankRequest, runtime *util.RuntimeOptions) (_result *GetInstanceErrorRankResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetInstanceErrorRank"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetDDLJobStatusWithOptions(request *GetDDLJobStatusRequest, runtime *util.RuntimeOptions) (_result *GetDDLJobStatusResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetDDLJobStatus"), tea.String("HTTPS"), tea.String("GET"), tea.String("2020-05-18"), tea.String("AK"), tea.ToMap(request), nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetInstanceConsumeTimeRankWithOptions(request *GetInstanceConsumeTimeRankRequest, runtime *util.RuntimeOptions) (_result *GetInstanceConsumeTimeRankResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetInstanceConsumeTimeRank"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CreateDataServiceApiAuthorityWithOptions(request *CreateDataServiceApiAuthorityRequest, runtime *util.RuntimeOptions) (_result *CreateDataServiceApiAuthorityResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("CreateDataServiceApiAuthority"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) DeleteDataServiceApiAuthorityWithOptions(request *DeleteDataServiceApiAuthorityRequest, runtime *util.RuntimeOptions) (_result *DeleteDataServiceApiAuthorityResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("DeleteDataServiceApiAuthority"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CreateDataServiceGroupWithOptions(request *CreateDataServiceGroupRequest, runtime *util.RuntimeOptions) (_result *CreateDataServiceGroupResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("CreateDataServiceGroup"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateMetaTableWithOptions(request *UpdateMetaTableRequest, runtime *util.RuntimeOptions) (_result *UpdateMetaTableResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("UpdateMetaTable"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetInstanceCountTrendWithOptions(request *GetInstanceCountTrendRequest, runtime *util.RuntimeOptions) (_result *GetInstanceCountTrendResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetInstanceCountTrend"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) DeleteTableWithOptions(request *DeleteTableRequest, runtime *util.RuntimeOptions) (_result *DeleteTableResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("DeleteTable"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListTableThemeWithOptions(request *ListTableThemeRequest, runtime *util.RuntimeOptions) (_result *ListTableThemeResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListTableTheme"), tea.String("HTTPS"), tea.String("GET"), tea.String("2020-05-18"), tea.String("AK"), tea.ToMap(request), nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetSuccessInstanceTrendWithOptions(request *GetSuccessInstanceTrendRequest, runtime *util.RuntimeOptions) (_result *GetSuccessInstanceTrendResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetSuccessInstanceTrend"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateTableWithOptions(request *UpdateTableRequest, runtime *util.RuntimeOptions) (_result *UpdateTableResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("UpdateTable"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetDataServiceFolderWithOptions(request *GetDataServiceFolderRequest, runtime *util.RuntimeOptions) (_result *GetDataServiceFolderResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetDataServiceFolder"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListTableLevelWithOptions(request *ListTableLevelRequest, runtime *util.RuntimeOptions) (_result *ListTableLevelResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListTableLevel"), tea.String("HTTPS"), tea.String("GET"), tea.String("2020-05-18"), tea.String("AK"), tea.ToMap(request), nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListDataServiceGroupsWithOptions(request *ListDataServiceGroupsRequest, runtime *util.RuntimeOptions) (_result *ListDataServiceGroupsResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListDataServiceGroups"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateTableThemeWithOptions(request *UpdateTableThemeRequest, runtime *util.RuntimeOptions) (_result *UpdateTableThemeResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("UpdateTableTheme"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CreateDataServiceFolderWithOptions(request *CreateDataServiceFolderRequest, runtime *util.RuntimeOptions) (_result *CreateDataServiceFolderResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("CreateDataServiceFolder"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetDataServiceGroupWithOptions(request *GetDataServiceGroupRequest, runtime *util.RuntimeOptions) (_result *GetDataServiceGroupResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GetDataServiceGroup"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CreateTableLevelWithOptions(request *CreateTableLevelRequest, runtime *util.RuntimeOptions) (_result *CreateTableLevelResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("CreateTableLevel"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateMetaTableIntroWikiWithOptions(request *UpdateMetaTableIntroWikiRequest, runtime *util.RuntimeOptions) (_result *UpdateMetaTableIntroWikiResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("UpdateMetaTableIntroWiki"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) DeleteTableLevelWithOptions(request *DeleteTableLevelRequest, runtime *util.RuntimeOptions) (_result *DeleteTableLevelResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("DeleteTableLevel"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateTableLevelWithOptions(request *UpdateTableLevelRequest, runtime *util.RuntimeOptions) (_result *UpdateTableLevelResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("UpdateTableLevel"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) DeleteTableThemeWithOptions(request *DeleteTableThemeRequest, runtime *util.RuntimeOptions) (_result *DeleteTableThemeResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("DeleteTableTheme"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListProgramTypeCountWithOptions(request *ListProgramTypeCountRequest, runtime *util.RuntimeOptions) (_result *ListProgramTypeCountResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListProgramTypeCount"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateTableModelInfoWithOptions(request *UpdateTableModelInfoRequest, runtime *util.RuntimeOptions) (_result *UpdateTableModelInfoResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("UpdateTableModelInfo"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListProjectsWithOptions(request *ListProjectsRequest, runtime *util.RuntimeOptions) (_result *ListProjectsResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListProjects"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListProjectMembersWithOptions(request *ListProjectMembersRequest, runtime *util.RuntimeOptions) (_result *ListProjectMembersResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListProjectMembers"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) CreateProjectMemberWithOptions(request *CreateProjectMemberRequest, runtime *util.RuntimeOptions) (_result *CreateProjectMemberResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("CreateProjectMember"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ListProjectRolesWithOptions(request *ListProjectRolesRequest, runtime *util.RuntimeOptions) (_result *ListProjectRolesResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("ListProjectRoles"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) AddProjectMemberToRoleWithOptions(request *AddProjectMemberToRoleRequest, runtime *util.RuntimeOptions) (_result *AddProjectMemberToRoleResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("AddProjectMemberToRole"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) RemoveProjectMemberFromRoleWithOptions(request *RemoveProjectMemberFromRoleRequest, runtime *util.RuntimeOptions) (_result *RemoveProjectMemberFromRoleResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("RemoveProjectMemberFromRole"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) DeleteProjectMemberWithOptions(request *DeleteProjectMemberRequest, runtime *util.RuntimeOptions) (_result *DeleteProjectMemberResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("DeleteProjectMember"), tea.String("HTTPS"), tea.String("POST"), tea.String("2020-05-18"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
