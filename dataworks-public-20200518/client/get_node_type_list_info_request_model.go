...
type iGetNodeTypeListInfoRequest interface {
	dara.Model
	String() string
	GoString() string
	SetKeyword(v string) *GetNodeTypeListInfoRequest
	GetKeyword() *string
	SetLocale(v string) *GetNodeTypeListInfoRequest
	GetLocale() *string
	SetPageNumber(v int32) *GetNodeTypeListInfoRequest
	GetPageNumber() *int32
	SetPageSize(v int32) *GetNodeTypeListInfoRequest
	GetPageSize() *int32
	SetProjectId(v int64) *GetNodeTypeListInfoRequest
	GetProjectId() *int64
	SetProjectIdentifier(v string) *GetNodeTypeListInfoRequest
...
func (s *GetNodeTypeListInfoRequest) GetKeyword() *string {
	return s.Keyword
}

func (s *GetNodeTypeListInfoRequest) GetLocale() *string {
	return s.Locale
}

func (s *GetNodeTypeListInfoRequest) GetPageNumber() *int32 {
	return s.PageNumber
}

func (s *GetNodeTypeListInfoRequest) GetPageSize() *int32 {
	return s.PageSize
}

func (s *GetNodeTypeListInfoRequest) GetProjectId() *int64 {
	return s.ProjectId
}

func (s *GetNodeTypeListInfoRequest) GetProjectIdentifier() *string {
...
func (s *GetNodeTypeListInfoRequest) Validate() error {
