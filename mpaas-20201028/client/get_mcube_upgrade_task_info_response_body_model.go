...
func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetCreater() *string {
	return s.Creater
}
...
func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetIsOfficial() *int32 {
	return s.IsOfficial
}

func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetIsRc() *int32 {
	return s.IsRc
}

func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetIsRelease() *int32 {
	return s.IsRelease
}
...
func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetNetType() *string {
	return s.NetType
}

func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetOsVersion() *string {
	return s.OsVersion
}
...
func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetPushContent() *string {
	return s.PushContent
}

func (s *GetMcubeUpgradeTaskInfoResponseBodyGetTaskResultTaskInfo) GetQrcodeUrl() *string {
	return s.QrcodeUrl
}
