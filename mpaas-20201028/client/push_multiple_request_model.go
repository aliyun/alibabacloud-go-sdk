...
type iPushMultipleRequest interface {
	...
	SetNotifyLevel(v map[string]interface{}) *PushMultipleRequest
	...
	SetVendorTemplate(v string) *PushMultipleRequest
...
func (s *PushMultipleRequest) GetNotifyLevel() map[string]interface{} {
...
func (s *PushMultipleRequest) GetVendorTemplate() *string {
...
func (s *PushMultipleRequest) SetNotifyLevel(v map[string]interface{}) *PushMultipleRequest {
	s.NotifyLevel = v
	return s
}
...
func (s *PushMultipleRequest) SetVendorTemplate(v string) *PushMultipleRequest {
	s.VendorTemplate = &v
	return s
}
