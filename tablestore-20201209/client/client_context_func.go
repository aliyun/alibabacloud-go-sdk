...
func (client *Client) BindAgentStorage2VpcWithContext(ctx context.Context, request *BindAgentStorage2VpcRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *BindAgentStorage2VpcResponse, _err error) {
...
func (client *Client) CheckAgentStoragePolicyWithContext(ctx context.Context, request *CheckAgentStoragePolicyRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *CheckAgentStoragePolicyResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) DeleteAgentStoragePolicyWithContext(ctx context.Context, request *DeleteAgentStoragePolicyRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *DeleteAgentStoragePolicyResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListVpcInfoByAgentStorageWithContext(ctx context.Context, request *ListVpcInfoByAgentStorageRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListVpcInfoByAgentStorageResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) UnbindAgentStorage2VpcWithContext(ctx context.Context, request *UnbindAgentStorage2VpcRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *UnbindAgentStorage2VpcResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) UpdateAgentStoragePolicyWithContext(ctx context.Context, request *UpdateAgentStoragePolicyRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *UpdateAgentStoragePolicyResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
