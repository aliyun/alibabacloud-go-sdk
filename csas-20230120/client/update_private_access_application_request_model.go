...
type iUpdatePrivateAccessApplicationRequest interface {
	...
	GetTagIds() []*string
	SetUnauthorizedAccessConfig(v *PAApplicationUnauthorizedAccessConfig) *UpdatePrivateAccessApplicationRequest
...
func (s *UpdatePrivateAccessApplicationRequest) GetUnauthorizedAccessConfig() *PAApplicationUnauthorizedAccessConfig {
...
func (s *UpdatePrivateAccessApplicationRequest) SetUnauthorizedAccessConfig(v *PAApplicationUnauthorizedAccessConfig) *UpdatePrivateAccessApplicationRequest {
