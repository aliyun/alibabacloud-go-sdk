...
func (s *CreateRecallManagementServiceVersionConfigRequestRecallConfig) GetItemConditionExpression() *string {
...
func (s *CreateRecallManagementServiceVersionConfigRequestRecallConfig) GetSortFields() *string {
	return s.SortFields
}
...
func (s *CreateRecallManagementServiceVersionConfigRequestRecallConfig) SetItemConditionExpression(v string) *CreateRecallManagementServiceVersionConfigRequestRecallConfig {
...
func (s *CreateRecallManagementServiceVersionConfigRequestRecallConfig) SetSortFields(v string) *CreateRecallManagementServiceVersionConfigRequestRecallConfig {
	s.SortFields = &v
	return s
}
