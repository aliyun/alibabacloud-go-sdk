...
type iDeleteGroupResponseBody interface {
	...
	String() string
	GoString() string
	SetMessage(v string) *DeleteGroupResponseBody
	GetMessage() *string
...
func (s *DeleteGroupResponseBody) GetMessage() *string {
	return s.Message
}
...
func (s *DeleteGroupResponseBody) SetMessage(v string) *DeleteGroupResponseBody {
	s.Message = &v
	return s
}
