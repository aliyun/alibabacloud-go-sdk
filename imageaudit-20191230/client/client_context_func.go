...
func (client *Client) ScanImageWithContext(ctx context.Context, request *ScanImageRequest, runtime *dara.RuntimeOptions) (_result *ScanImageResponse, _err error) {
...
func (client *Client) ScanTextWithContext(ctx context.Context, request *ScanTextRequest, runtime *dara.RuntimeOptions) (_result *ScanTextResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
