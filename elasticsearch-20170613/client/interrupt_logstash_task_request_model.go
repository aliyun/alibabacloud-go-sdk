...
type iInterruptLogstashTaskRequest interface {
	dara.Model
	String() string
	GoString() string
	SetClientToken(v string) *InterruptLogstashTaskRequest
...
func (s *InterruptLogstashTaskRequest) GetClientToken() *string {
...
func (s *InterruptLogstashTaskRequest) Validate() error {
