...
func (s *ListApmRequest) SetEsInstanceId(v string) *ListApmRequest {
	s.EsInstanceId = &v
	return s
}
...
type RpcListInstanceRequest struct {
	EsVersion *string `json:"esVersion,omitempty" xml:"esVersion,omitempty"`
	VpcId     *string `json:"vpcId,omitempty" xml:"vpcId,omitempty"`
	VswitchId *string `json:"vswitchId,omitempty" xml:"vswitchId,omitempty"`
}

func (s RpcListInstanceRequest) String() string {
	return tea.Prettify(s)
}

func (s RpcListInstanceRequest) GoString() string {
	return s.String()
}

func (s *RpcListInstanceRequest) SetEsVersion(v string) *RpcListInstanceRequest {
	s.EsVersion = &v
	return s
}

func (s *RpcListInstanceRequest) SetVpcId(v string) *RpcListInstanceRequest {
	s.VpcId = &v
	return s
}

func (s *RpcListInstanceRequest) SetVswitchId(v string) *RpcListInstanceRequest {
	s.VswitchId = &v
	return s
}

type RpcListInstanceResponseBody struct {
	// Id of the request
	RequestId *string `json:"requestId,omitempty" xml:"requestId,omitempty"`
	// es 列表
	Result []*RpcListInstanceResponseBodyResult `json:"Result,omitempty" xml:"Result,omitempty" type:"Repeated"`
}

func (s RpcListInstanceResponseBody) String() string {
	return tea.Prettify(s)
}

func (s RpcListInstanceResponseBody) GoString() string {
	return s.String()
}

func (s *RpcListInstanceResponseBody) SetRequestId(v string) *RpcListInstanceResponseBody {
	s.RequestId = &v
	return s
}

func (s *RpcListInstanceResponseBody) SetResult(v []*RpcListInstanceResponseBodyResult) *RpcListInstanceResponseBody {
	s.Result = v
	return s
}

type RpcListInstanceResponseBodyResult struct {
	AdvancedDedicateMaster     *bool   `json:"AdvancedDedicateMaster,omitempty" xml:"AdvancedDedicateMaster,omitempty"`
	CreatedAt                  *string `json:"CreatedAt,omitempty" xml:"CreatedAt,omitempty"`
	...
	EndTime                    *int64  `json:"EndTime,omitempty" xml:"EndTime,omitempty"`
	EsVersion                  *string `json:"EsVersion,omitempty" xml:"EsVersion,omitempty"`
	HaveCerebro                *bool   `json:"HaveCerebro,omitempty" xml:"HaveCerebro,omitempty"`
	HaveClientNode             *bool   `json:"HaveClientNode,omitempty" xml:"HaveClientNode,omitempty"`
	HaveElasticDataNode        *bool   `json:"HaveElasticDataNode,omitempty" xml:"HaveElasticDataNode,omitempty"`
	HaveGrafana                *bool   `json:"HaveGrafana,omitempty" xml:"HaveGrafana,omitempty"`
	HaveKibana                 *bool   `json:"HaveKibana,omitempty" xml:"HaveKibana,omitempty"`
...
func (s RpcListInstanceResponseBodyResult) String() string {
	return tea.Prettify(s)
}

func (s RpcListInstanceResponseBodyResult) GoString() string {
	return s.String()
}

func (s *RpcListInstanceResponseBodyResult) SetAdvancedDedicateMaster(v bool) *RpcListInstanceResponseBodyResult {
	s.AdvancedDedicateMaster = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetCreatedAt(v string) *RpcListInstanceResponseBodyResult {
	s.CreatedAt = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetDataNode(v bool) *RpcListInstanceResponseBodyResult {
	s.DataNode = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetDedicateMaster(v bool) *RpcListInstanceResponseBodyResult {
	s.DedicateMaster = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetDescription(v string) *RpcListInstanceResponseBodyResult {
	s.Description = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetDomain(v string) *RpcListInstanceResponseBodyResult {
	s.Domain = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetEnableKibanaPrivateNetwork(v bool) *RpcListInstanceResponseBodyResult {
	s.EnableKibanaPrivateNetwork = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetEnableKibanaPublicNetwork(v bool) *RpcListInstanceResponseBodyResult {
	s.EnableKibanaPublicNetwork = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetEnablePublic(v bool) *RpcListInstanceResponseBodyResult {
	s.EnablePublic = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetEndTime(v int64) *RpcListInstanceResponseBodyResult {
	s.EndTime = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetEsVersion(v string) *RpcListInstanceResponseBodyResult {
	s.EsVersion = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetHaveCerebro(v bool) *RpcListInstanceResponseBodyResult {
	s.HaveCerebro = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetHaveClientNode(v bool) *RpcListInstanceResponseBodyResult {
	s.HaveClientNode = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetHaveElasticDataNode(v bool) *RpcListInstanceResponseBodyResult {
	s.HaveElasticDataNode = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetHaveGrafana(v bool) *RpcListInstanceResponseBodyResult {
	s.HaveGrafana = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetHaveKibana(v bool) *RpcListInstanceResponseBodyResult {
	s.HaveKibana = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetInited(v bool) *RpcListInstanceResponseBodyResult {
	s.Inited = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetInstanceId(v string) *RpcListInstanceResponseBodyResult {
	s.InstanceId = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetInstanceType(v string) *RpcListInstanceResponseBodyResult {
	s.InstanceType = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetIsNewDeployment(v bool) *RpcListInstanceResponseBodyResult {
	s.IsNewDeployment = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetKibanaProtocol(v string) *RpcListInstanceResponseBodyResult {
	s.KibanaProtocol = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetNodeAmount(v int64) *RpcListInstanceResponseBodyResult {
	s.NodeAmount = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetPaymentType(v string) *RpcListInstanceResponseBodyResult {
	s.PaymentType = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetProtocol(v string) *RpcListInstanceResponseBodyResult {
	s.Protocol = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetResourceGroupId(v string) *RpcListInstanceResponseBodyResult {
	s.ResourceGroupId = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetStatus(v string) *RpcListInstanceResponseBodyResult {
	s.Status = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetUpdatedAt(v string) *RpcListInstanceResponseBodyResult {
	s.UpdatedAt = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetVersion(v string) *RpcListInstanceResponseBodyResult {
	s.Version = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetWarmNode(v bool) *RpcListInstanceResponseBodyResult {
	s.WarmNode = &v
	return s
}

func (s *RpcListInstanceResponseBodyResult) SetZoneCount(v int64) *RpcListInstanceResponseBodyResult {
	s.ZoneCount = &v
	return s
}

type RpcListInstanceResponse struct {
	Headers map[string]*string           `json:"headers,omitempty" xml:"headers,omitempty" require:"true"`
	Body    *RpcListInstanceResponseBody `json:"body,omitempty" xml:"body,omitempty" require:"true"`
}

func (s RpcListInstanceResponse) String() string {
	return tea.Prettify(s)
}

func (s RpcListInstanceResponse) GoString() string {
	return s.String()
}

func (s *RpcListInstanceResponse) SetHeaders(v map[string]*string) *RpcListInstanceResponse {
	s.Headers = v
	return s
}

func (s *RpcListInstanceResponse) SetBody(v *RpcListInstanceResponseBody) *RpcListInstanceResponse {
	s.Body = v
	return s
}
...
func (s *ListAllNodeResponseBodyResult) SetHostName(v string) *ListAllNodeResponseBodyResult {
	s.HostName = &v
	return s
}
...
func (client *Client) StartApmWithOptions(instanceId *string, headers map[string]*string, runtime *util.RuntimeOptions) (_result *StartApmResponse, _err error) {
	...
	_result = &StartApmResponse{}
	_body, _err := client.DoROARequest(tea.String("StartApm"), tea.String("2017-06-13"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/openapi/apm/"+tea.StringValue(instanceId)+"/start"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) StopApmWithOptions(instanceId *string, headers map[string]*string, runtime *util.RuntimeOptions) (_result *StopApmResponse, _err error) {
	...
	_result = &StopApmResponse{}
	_body, _err := client.DoROARequest(tea.String("StopApm"), tea.String("2017-06-13"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/openapi/apm/"+tea.StringValue(instanceId)+"/stop"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) RpcListInstance(request *RpcListInstanceRequest) (_result *RpcListInstanceResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &RpcListInstanceResponse{}
	_body, _err := client.RpcListInstanceWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) RpcListInstanceWithOptions(request *RpcListInstanceRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *RpcListInstanceResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	_result = &RpcListInstanceResponse{}
	_body, _err := client.DoROARequest(tea.String("RpcListInstance"), tea.String("2017-06-13"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/openapi/instances/rpc"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UpdateDescriptionWithOptions(InstanceId *string, request *UpdateDescriptionRequest, headers map[string]*string, runtime *util.RuntimeOptions) (_result *UpdateDescriptionResponse, _err error) {
	...
	_result = &UpdateDescriptionResponse{}
	_body, _err := client.DoROARequestWithForm(tea.String("UpdateDescription"), tea.String("2017-06-13"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/openapi/instances/"+tea.StringValue(InstanceId)+"/description"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
