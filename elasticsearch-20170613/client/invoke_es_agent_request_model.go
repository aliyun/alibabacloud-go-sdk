...
type iInvokeEsAgentRequest interface {
	dara.Model
	String() string
	GoString() string
	SetBody(v map[string]interface{}) *InvokeEsAgentRequest
	GetBody() map[string]interface{}
}

type InvokeEsAgentRequest struct {
...
func (s InvokeEsAgentRequest) String() string {
	return dara.Prettify(s)
}

func (s InvokeEsAgentRequest) GoString() string {
	return s.String()
}

func (s *InvokeEsAgentRequest) GetBody() map[string]interface{} {
	return s.Body
}

func (s *InvokeEsAgentRequest) SetBody(v map[string]interface{}) *InvokeEsAgentRequest {
	s.Body = v
	return s
}

func (s *InvokeEsAgentRequest) Validate() error {
