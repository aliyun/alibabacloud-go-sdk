...
type GetExpressConnectRouterRequest struct {
	ClientToken *string `json:"ClientToken,omitempty" xml:"ClientToken,omitempty"`
	DryRun      *bool   `json:"DryRun,omitempty" xml:"DryRun,omitempty"`
	EcrId       *string `json:"EcrId,omitempty" xml:"EcrId,omitempty"`
}

func (s GetExpressConnectRouterRequest) String() string {
	return tea.Prettify(s)
}

func (s GetExpressConnectRouterRequest) GoString() string {
	return s.String()
}

func (s *GetExpressConnectRouterRequest) SetClientToken(v string) *GetExpressConnectRouterRequest {
	s.ClientToken = &v
	return s
}

func (s *GetExpressConnectRouterRequest) SetDryRun(v bool) *GetExpressConnectRouterRequest {
	s.DryRun = &v
	return s
}

func (s *GetExpressConnectRouterRequest) SetEcrId(v string) *GetExpressConnectRouterRequest {
	s.EcrId = &v
	return s
}

type GetExpressConnectRouterResponseBody struct {
	AccessDeniedDetail *string                                    `json:"AccessDeniedDetail,omitempty" xml:"AccessDeniedDetail,omitempty"`
	AlibabaSideAsn     *int64                                     `json:"AlibabaSideAsn,omitempty" xml:"AlibabaSideAsn,omitempty"`
	BizStatus          *string                                    `json:"BizStatus,omitempty" xml:"BizStatus,omitempty"`
	Code               *string                                    `json:"Code,omitempty" xml:"Code,omitempty"`
	...
	Status             *string                                    `json:"Status,omitempty" xml:"Status,omitempty"`
	Success            *bool                                      `json:"Success,omitempty" xml:"Success,omitempty"`
	Tags               []*GetExpressConnectRouterResponseBodyTags `json:"Tags,omitempty" xml:"Tags,omitempty" type:"Repeated"`
}

func (s GetExpressConnectRouterResponseBody) String() string {
	return tea.Prettify(s)
}

func (s GetExpressConnectRouterResponseBody) GoString() string {
	return s.String()
}

func (s *GetExpressConnectRouterResponseBody) SetAccessDeniedDetail(v string) *GetExpressConnectRouterResponseBody {
	s.AccessDeniedDetail = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetAlibabaSideAsn(v int64) *GetExpressConnectRouterResponseBody {
	s.AlibabaSideAsn = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetBizStatus(v string) *GetExpressConnectRouterResponseBody {
	s.BizStatus = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetCode(v string) *GetExpressConnectRouterResponseBody {
	s.Code = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetDescription(v string) *GetExpressConnectRouterResponseBody {
	s.Description = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetDynamicCode(v string) *GetExpressConnectRouterResponseBody {
	s.DynamicCode = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetDynamicMessage(v string) *GetExpressConnectRouterResponseBody {
	s.DynamicMessage = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetEcrId(v string) *GetExpressConnectRouterResponseBody {
	s.EcrId = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetGmtCreate(v string) *GetExpressConnectRouterResponseBody {
	s.GmtCreate = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetGmtModified(v string) *GetExpressConnectRouterResponseBody {
	s.GmtModified = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetHttpStatusCode(v int32) *GetExpressConnectRouterResponseBody {
	s.HttpStatusCode = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetMessage(v string) *GetExpressConnectRouterResponseBody {
	s.Message = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetName(v string) *GetExpressConnectRouterResponseBody {
	s.Name = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetOwnerId(v int64) *GetExpressConnectRouterResponseBody {
	s.OwnerId = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetRequestId(v string) *GetExpressConnectRouterResponseBody {
	s.RequestId = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetResourceGroupId(v string) *GetExpressConnectRouterResponseBody {
	s.ResourceGroupId = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetStatus(v string) *GetExpressConnectRouterResponseBody {
	s.Status = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetSuccess(v bool) *GetExpressConnectRouterResponseBody {
	s.Success = &v
	return s
}

func (s *GetExpressConnectRouterResponseBody) SetTags(v []*GetExpressConnectRouterResponseBodyTags) *GetExpressConnectRouterResponseBody {
	s.Tags = v
	return s
}

type GetExpressConnectRouterResponseBodyTags struct {
	AliUid       *int64  `json:"AliUid,omitempty" xml:"AliUid,omitempty"`
	Category     *int32  `json:"Category,omitempty" xml:"Category,omitempty"`
	Id           *int64  `json:"Id,omitempty" xml:"Id,omitempty"`
	RegionNo     *string `json:"RegionNo,omitempty" xml:"RegionNo,omitempty"`
...
func (s GetExpressConnectRouterResponseBodyTags) String() string {
	return tea.Prettify(s)
}

func (s GetExpressConnectRouterResponseBodyTags) GoString() string {
	return s.String()
}

func (s *GetExpressConnectRouterResponseBodyTags) SetAliUid(v int64) *GetExpressConnectRouterResponseBodyTags {
	s.AliUid = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetCategory(v int32) *GetExpressConnectRouterResponseBodyTags {
	s.Category = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetId(v int64) *GetExpressConnectRouterResponseBodyTags {
	s.Id = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetRegionNo(v string) *GetExpressConnectRouterResponseBodyTags {
	s.RegionNo = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetResourceId(v string) *GetExpressConnectRouterResponseBodyTags {
	s.ResourceId = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetResuorceType(v string) *GetExpressConnectRouterResponseBodyTags {
	s.ResuorceType = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetScope(v int32) *GetExpressConnectRouterResponseBodyTags {
	s.Scope = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetTagKey(v string) *GetExpressConnectRouterResponseBodyTags {
	s.TagKey = &v
	return s
}

func (s *GetExpressConnectRouterResponseBodyTags) SetTagValue(v string) *GetExpressConnectRouterResponseBodyTags {
	s.TagValue = &v
	return s
}

type GetExpressConnectRouterResponse struct {
	Headers    map[string]*string                   `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                               `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *GetExpressConnectRouterResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}

func (s GetExpressConnectRouterResponse) String() string {
	return tea.Prettify(s)
}

func (s GetExpressConnectRouterResponse) GoString() string {
	return s.String()
}

func (s *GetExpressConnectRouterResponse) SetHeaders(v map[string]*string) *GetExpressConnectRouterResponse {
	s.Headers = v
	return s
}

func (s *GetExpressConnectRouterResponse) SetStatusCode(v int32) *GetExpressConnectRouterResponse {
	s.StatusCode = &v
	return s
}

func (s *GetExpressConnectRouterResponse) SetBody(v *GetExpressConnectRouterResponseBody) *GetExpressConnectRouterResponse {
	s.Body = v
	return s
}
...
func (client *Client) GetExpressConnectRouterWithOptions(request *GetExpressConnectRouterRequest, runtime *util.RuntimeOptions) (_result *GetExpressConnectRouterResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapi.Params{
		Action:      tea.String("GetExpressConnectRouter"),
		Version:     tea.String("2023-09-01"),
		Protocol:    tea.String("HTTPS"),
		Pathname:    tea.String("/"),
		Method:      tea.String("POST"),
	...
	_result = &GetExpressConnectRouterResponse{}
	_body, _err := client.CallApi(params, req, runtime)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) GetExpressConnectRouter(request *GetExpressConnectRouterRequest) (_result *GetExpressConnectRouterResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	_result = &GetExpressConnectRouterResponse{}
	_body, _err := client.GetExpressConnectRouterWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
