...
func (s *ListJobExecutionsResponseBodyDataRecords) GetAppGroupId() *int64 {
	return s.AppGroupId
}
...
func (s *ListJobExecutionsResponseBodyDataRecords) SetAppGroupId(v int64) *ListJobExecutionsResponseBodyDataRecords {
	s.AppGroupId = &v
	return s
}
