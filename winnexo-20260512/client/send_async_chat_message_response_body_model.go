...
type iSendAsyncChatMessageResponseBody interface {
	...
	SetWorkMode(v string) *SendAsyncChatMessageResponseBody
	GetWorkMode() *string
}
...
func (s *SendAsyncChatMessageResponseBody) GetWorkMode() *string {
	return s.WorkMode
}
...
func (s *SendAsyncChatMessageResponseBody) SetWorkMode(v string) *SendAsyncChatMessageResponseBody {
	s.WorkMode = &v
	return s
}
