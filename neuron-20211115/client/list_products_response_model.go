...
type iListProductsResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *ProductListResult) *ListProductsResponse
	GetBody() *ProductListResult
}

type ListProductsResponse struct {
	Headers    map[string]*string `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32             `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *ProductListResult `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *ListProductsResponse) GetBody() *ProductListResult {
	return s.Body
}
...
func (s *ListProductsResponse) SetBody(v *ProductListResult) *ListProductsResponse {
	s.Body = v
	return s
}
