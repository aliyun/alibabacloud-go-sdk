...
type iSendTTSVerifyLinkResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *SendTTSVerifyLinkResult) *SendTTSVerifyLinkResponse
	GetBody() *SendTTSVerifyLinkResult
}

type SendTTSVerifyLinkResponse struct {
	Headers    map[string]*string       `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                   `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *SendTTSVerifyLinkResult `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *SendTTSVerifyLinkResponse) GetBody() *SendTTSVerifyLinkResult {
	return s.Body
}
...
func (s *SendTTSVerifyLinkResponse) SetBody(v *SendTTSVerifyLinkResult) *SendTTSVerifyLinkResponse {
	s.Body = v
	return s
}
