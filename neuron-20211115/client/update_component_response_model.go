...
type iUpdateComponentResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *PdpComponent) *UpdateComponentResponse
...
func (s *UpdateComponentResponse) GetBody() *PdpComponent {
	return s.Body
}
...
func (s *UpdateComponentResponse) SetBody(v *PdpComponent) *UpdateComponentResponse {
	s.Body = v
	return s
}
