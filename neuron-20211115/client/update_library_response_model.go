...
type iUpdateLibraryResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *Library) *UpdateLibraryResponse
	GetBody() *Library
}
...
func (s *UpdateLibraryResponse) GetBody() *Library {
	return s.Body
}
...
func (s *UpdateLibraryResponse) SetBody(v *Library) *UpdateLibraryResponse {
	s.Body = v
	return s
}
