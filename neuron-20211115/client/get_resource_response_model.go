...
type iGetResourceResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *PdpResource) *GetResourceResponse
	GetBody() *PdpResource
}
...
func (s *GetResourceResponse) GetBody() *PdpResource {
	return s.Body
}
...
func (s *GetResourceResponse) SetBody(v *PdpResource) *GetResourceResponse {
	s.Body = v
	return s
}
