...
type iListResourcesResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *PdpResourcePageResult) *ListResourcesResponse
	GetBody() *PdpResourcePageResult
}

type ListResourcesResponse struct {
	Headers    map[string]*string     `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                 `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *PdpResourcePageResult `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *ListResourcesResponse) GetBody() *PdpResourcePageResult {
	return s.Body
}
...
func (s *ListResourcesResponse) SetBody(v *PdpResourcePageResult) *ListResourcesResponse {
	s.Body = v
	return s
}
