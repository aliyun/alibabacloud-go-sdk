...
type iGetDeploymentResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *DeployDetailInfo) *GetDeploymentResponse
	GetBody() *DeployDetailInfo
}

type GetDeploymentResponse struct {
	Headers    map[string]*string `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32             `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *DeployDetailInfo  `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *GetDeploymentResponse) GetBody() *DeployDetailInfo {
	return s.Body
}
...
func (s *GetDeploymentResponse) SetBody(v *DeployDetailInfo) *GetDeploymentResponse {
	s.Body = v
	return s
}
