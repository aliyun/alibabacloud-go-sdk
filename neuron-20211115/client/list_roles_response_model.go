...
type iListRolesResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *RolePageResult) *ListRolesResponse
...
func (s *ListRolesResponse) GetBody() *RolePageResult {
	return s.Body
}
...
func (s *ListRolesResponse) SetBody(v *RolePageResult) *ListRolesResponse {
	s.Body = v
	return s
}
