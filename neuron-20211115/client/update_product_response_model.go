...
type iUpdateProductResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *Product) *UpdateProductResponse
	GetBody() *Product
}
...
func (s *UpdateProductResponse) GetBody() *Product {
	return s.Body
}
...
func (s *UpdateProductResponse) SetBody(v *Product) *UpdateProductResponse {
	s.Body = v
	return s
}
