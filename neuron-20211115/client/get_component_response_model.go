...
type iGetComponentResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *PdpComponent) *GetComponentResponse
...
func (s *GetComponentResponse) GetBody() *PdpComponent {
	return s.Body
}
...
func (s *GetComponentResponse) SetBody(v *PdpComponent) *GetComponentResponse {
	s.Body = v
	return s
}
