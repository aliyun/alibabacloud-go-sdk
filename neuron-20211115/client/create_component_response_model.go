...
type iCreateComponentResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *PdpComponent) *CreateComponentResponse
	GetBody() *PdpComponent
}

type CreateComponentResponse struct {
	Headers    map[string]*string `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32             `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *PdpComponent      `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *CreateComponentResponse) GetBody() *PdpComponent {
	return s.Body
}
...
func (s *CreateComponentResponse) SetBody(v *PdpComponent) *CreateComponentResponse {
	s.Body = v
	return s
}
