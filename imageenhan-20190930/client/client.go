...
type GenerateDynamicImageResponse struct {
	...
	Data      *GenerateDynamicImageResponseData `json:"Data,omitempty" xml:"Data,omitempty" require:"true" type:"Struct"`
}
...
func (s *GenerateDynamicImageResponse) SetRequestId(v string) *GenerateDynamicImageResponse {
	s.RequestId = &v
	return s
}

func (s *GenerateDynamicImageResponse) SetData(v *GenerateDynamicImageResponseData) *GenerateDynamicImageResponse {
	s.Data = v
	return s
}

type GenerateDynamicImageResponseData struct {
	Url *string `json:"Url,omitempty" xml:"Url,omitempty" require:"true"`
}

func (s GenerateDynamicImageResponseData) String() string {
	return tea.Prettify(s)
}

func (s GenerateDynamicImageResponseData) GoString() string {
	return s.String()
}

func (s *GenerateDynamicImageResponseData) SetUrl(v string) *GenerateDynamicImageResponseData {
	s.Url = &v
	return s
}
...
func (client *Client) GenerateDynamicImage(request *GenerateDynamicImageRequest, runtime *util.RuntimeOptions) (_result *GenerateDynamicImageResponse, _err error) {
	...
	_body, _err := client.DoRequest(tea.String("GenerateDynamicImage"), tea.String("HTTPS"), tea.String("POST"), tea.String("2019-09-30"), tea.String("AK"), nil, tea.ToMap(request), runtime)
	if _err != nil {
		return _result, _err
	}
