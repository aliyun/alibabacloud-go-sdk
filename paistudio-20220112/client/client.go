...
func (client *Client) ListNodeTypesWithOptions(request *ListNodeTypesRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListNodeTypesResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return ListNodeTypesResponse
func (client *Client) ListNodeTypes(request *ListNodeTypesRequest) (_result *ListNodeTypesResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ListNodeTypesResponse{}
	_body, _err := client.ListNodeTypesWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) ListQuotaActiveUserUsagesWithOptions(QuotaId *string, request *ListQuotaActiveUserUsagesRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListQuotaActiveUserUsagesResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return ListQuotaActiveUserUsagesResponse
func (client *Client) ListQuotaActiveUserUsages(QuotaId *string, request *ListQuotaActiveUserUsagesRequest) (_result *ListQuotaActiveUserUsagesResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ListQuotaActiveUserUsagesResponse{}
	_body, _err := client.ListQuotaActiveUserUsagesWithOptions(QuotaId, request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) OperateNodeWithOptions(NodeId *string, request *OperateNodeRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *OperateNodeResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return OperateNodeResponse
func (client *Client) OperateNode(NodeId *string, request *OperateNodeRequest) (_result *OperateNodeResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &OperateNodeResponse{}
	_body, _err := client.OperateNodeWithOptions(NodeId, request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
