...
func (client *Client) SetSchedulerInfoWithOptions(request *SetSchedulerInfoRequest, runtime *util.RuntimeOptions) (_result *SetSchedulerInfoResponse, _err error) {
	...
	_body, _err := client.DoRPCRequest(tea.String("SetSchedulerInfo"), tea.String("2018-04-12"), tea.String("HTTPS"), tea.String("GET"), tea.String("AK"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) EcdDeleteDesktopsWithOptions(request *EcdDeleteDesktopsRequest, runtime *util.RuntimeOptions) (_result *EcdDeleteDesktopsResponse, _err error) {
	...
	_body, _err := client.DoRPCRequest(tea.String("EcdDeleteDesktops"), tea.String("2018-04-12"), tea.String("HTTPS"), tea.String("GET"), tea.String("AK"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) GetSchedulerInfoWithOptions(request *GetSchedulerInfoRequest, runtime *util.RuntimeOptions) (_result *GetSchedulerInfoResponse, _err error) {
	...
	_body, _err := client.DoRPCRequest(tea.String("GetSchedulerInfo"), tea.String("2018-04-12"), tea.String("HTTPS"), tea.String("GET"), tea.String("AK"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) AddExistedNodesWithOptions(request *AddExistedNodesRequest, runtime *util.RuntimeOptions) (_result *AddExistedNodesResponse, _err error) {
	...
	_body, _err := client.DoRPCRequest(tea.String("AddExistedNodes"), tea.String("2018-04-12"), tea.String("HTTPS"), tea.String("GET"), tea.String("AK"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
