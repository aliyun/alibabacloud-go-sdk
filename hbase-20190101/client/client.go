...
func (client *Client) Init(config *openapi.Config) (_err error) {
	...
	client.EndpointMap = map[string]*string{
		...
		"ap-south-1":                  tea.String("hbase.aliyuncs.com"),
		"ap-southeast-2":              tea.String("hbase.aliyuncs.com"),
		...
		"cn-wulanchabu":               tea.String("hbase.aliyuncs.com"),
		"cn-yushanfang":               tea.String("hbase.aliyuncs.com"),
		"cn-zhangbei":                 tea.String("hbase.aliyuncs.com"),
		...
		"eu-west-1-oxs":               tea.String("hbase.aliyuncs.com"),
		"rus-west-1-pop":              tea.String("hbase.aliyuncs.com"),
	}
