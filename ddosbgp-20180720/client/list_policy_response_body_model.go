...
func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) GetComment() *string {
	return s.Comment
}
...
func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) GetMode() *int32 {
	return s.Mode
}
...
func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) GetRule() *string {
	return s.Rule
}
...
func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) GetType() *int32 {
	return s.Type
}

func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) SetComment(v string) *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList {
	s.Comment = &v
	return s
}
...
func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) SetMode(v int32) *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList {
	s.Mode = &v
	return s
}
...
func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) SetRule(v string) *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList {
	s.Rule = &v
	return s
}
...
func (s *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList) SetType(v int32) *ListPolicyResponseBodyPolicyListContentFingerPrintRuleList {
	s.Type = &v
	return s
}
