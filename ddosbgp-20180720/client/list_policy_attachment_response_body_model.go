...
func (s *ListPolicyAttachmentResponseBodyAttachmentList) GetStatus() *string {
	return s.Status
}
...
func (s *ListPolicyAttachmentResponseBodyAttachmentList) SetStatus(v string) *ListPolicyAttachmentResponseBodyAttachmentList {
	s.Status = &v
	return s
}
