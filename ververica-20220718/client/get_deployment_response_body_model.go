...
func (s *GetDeploymentResponseBody) GetData() *Deployment {
	return s.Data
}
...
func (s *GetDeploymentResponseBody) GetHttpCode() *int32 {
	return s.HttpCode
}
