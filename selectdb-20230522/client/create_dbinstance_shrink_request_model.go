...
type iCreateDBInstanceShrinkRequest interface {
	...
	SetFEClassCode(v string) *CreateDBInstanceShrinkRequest
	GetFEClassCode() *string
	SetFENodeCount(v string) *CreateDBInstanceShrinkRequest
...
func (s *CreateDBInstanceShrinkRequest) GetFEClassCode() *string {
	return s.FEClassCode
}

func (s *CreateDBInstanceShrinkRequest) GetFENodeCount() *string {
...
func (s *CreateDBInstanceShrinkRequest) SetFEClassCode(v string) *CreateDBInstanceShrinkRequest {
	s.FEClassCode = &v
	return s
}

func (s *CreateDBInstanceShrinkRequest) SetFENodeCount(v string) *CreateDBInstanceShrinkRequest {
	s.FENodeCount = &v
	return s
}
