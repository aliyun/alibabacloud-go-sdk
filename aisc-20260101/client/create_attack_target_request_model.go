...
type iCreateAttackTargetRequest interface {
	dara.Model
	String() string
	GoString() string
	SetApiKey(v string) *CreateAttackTargetRequest
	GetApiKey() *string
	SetConnectionConfig(v string) *CreateAttackTargetRequest
	GetConnectionConfig() *string
	SetConnectionMethod(v string) *CreateAttackTargetRequest
	GetConnectionMethod() *string
	SetDescription(v string) *CreateAttackTargetRequest
	GetDescription() *string
	SetEndpoint(v string) *CreateAttackTargetRequest
	GetEndpoint() *string
	SetModelName(v string) *CreateAttackTargetRequest
	GetModelName() *string
	SetProvider(v string) *CreateAttackTargetRequest
	GetProvider() *string
	SetTargetName(v string) *CreateAttackTargetRequest
	GetTargetName() *string
	SetTargetType(v string) *CreateAttackTargetRequest
	GetTargetType() *string
}

type CreateAttackTargetRequest struct {
...
func (s CreateAttackTargetRequest) String() string {
	return dara.Prettify(s)
}

func (s CreateAttackTargetRequest) GoString() string {
	return s.String()
}

func (s *CreateAttackTargetRequest) GetApiKey() *string {
	return s.ApiKey
}

func (s *CreateAttackTargetRequest) GetConnectionConfig() *string {
	return s.ConnectionConfig
}

func (s *CreateAttackTargetRequest) GetConnectionMethod() *string {
	return s.ConnectionMethod
}

func (s *CreateAttackTargetRequest) GetDescription() *string {
	return s.Description
}

func (s *CreateAttackTargetRequest) GetEndpoint() *string {
	return s.Endpoint
}

func (s *CreateAttackTargetRequest) GetModelName() *string {
	return s.ModelName
}

func (s *CreateAttackTargetRequest) GetProvider() *string {
	return s.Provider
}

func (s *CreateAttackTargetRequest) GetTargetName() *string {
	return s.TargetName
}

func (s *CreateAttackTargetRequest) GetTargetType() *string {
	return s.TargetType
}

func (s *CreateAttackTargetRequest) SetApiKey(v string) *CreateAttackTargetRequest {
	s.ApiKey = &v
	return s
}

func (s *CreateAttackTargetRequest) SetConnectionConfig(v string) *CreateAttackTargetRequest {
	s.ConnectionConfig = &v
	return s
}

func (s *CreateAttackTargetRequest) SetConnectionMethod(v string) *CreateAttackTargetRequest {
	s.ConnectionMethod = &v
	return s
}

func (s *CreateAttackTargetRequest) SetDescription(v string) *CreateAttackTargetRequest {
	s.Description = &v
	return s
}

func (s *CreateAttackTargetRequest) SetEndpoint(v string) *CreateAttackTargetRequest {
	s.Endpoint = &v
	return s
}

func (s *CreateAttackTargetRequest) SetModelName(v string) *CreateAttackTargetRequest {
	s.ModelName = &v
	return s
}

func (s *CreateAttackTargetRequest) SetProvider(v string) *CreateAttackTargetRequest {
	s.Provider = &v
	return s
}

func (s *CreateAttackTargetRequest) SetTargetName(v string) *CreateAttackTargetRequest {
	s.TargetName = &v
	return s
}

func (s *CreateAttackTargetRequest) SetTargetType(v string) *CreateAttackTargetRequest {
	s.TargetType = &v
	return s
}

func (s *CreateAttackTargetRequest) Validate() error {
