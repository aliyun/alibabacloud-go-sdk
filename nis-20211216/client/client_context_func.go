...
func (client *Client) GetNisTrafficMetricsWithContext(ctx context.Context, tmpReq *GetNisTrafficMetricsRequest, runtime *dara.RuntimeOptions) (_result *GetNisTrafficMetricsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
