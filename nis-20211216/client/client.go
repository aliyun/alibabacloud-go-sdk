...
func (client *Client) SendNapalStreamMessageWithSSE(tmpReq *SendNapalStreamMessageRequest, runtime *dara.RuntimeOptions, _yield chan *SendNapalStreamMessageResponse, _yieldErr chan error) {
	defer close(_yield)
	client.sendNapalStreamMessageWithSSE_opYieldFunc(_yield, _yieldErr, tmpReq, runtime)
	return
}
...
//
// @return SendNapalStreamMessageResponse
func (client *Client) SendNapalStreamMessageWithOptions(tmpReq *SendNapalStreamMessageRequest, runtime *dara.RuntimeOptions) (_result *SendNapalStreamMessageResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return SendNapalStreamMessageResponse
func (client *Client) SendNapalStreamMessage(request *SendNapalStreamMessageRequest) (_result *SendNapalStreamMessageResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &SendNapalStreamMessageResponse{}
	_body, _err := client.SendNapalStreamMessageWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) sendNapalStreamMessageWithSSE_opYieldFunc(_yield chan *SendNapalStreamMessageResponse, _yieldErr chan error, tmpReq *SendNapalStreamMessageRequest, runtime *dara.RuntimeOptions) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err := tmpReq.Validate()
		if _err != nil {
			_yieldErr <- _err
