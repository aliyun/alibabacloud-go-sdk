...
func (client *Client) Init(config *openapi.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(tea.String("dingtalk"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
...
func (client *Client) BatchCreateWithOptions(request *BatchCreateRequest, headers *BatchCreateHeaders, runtime *util.RuntimeOptions) (_result *BatchCreateResponse, _err error) {
	...
	_result = &BatchCreateResponse{}
	_body, _err := client.DoROARequest(tea.String("BatchCreate"), tea.String("edu_1.0"), tea.String("HTTP"), tea.String("POST"), tea.String("AK"), tea.String("/edu/cards"), tea.String("json"), req, runtime)
	if _err != nil {
		return _result, _err
	}
