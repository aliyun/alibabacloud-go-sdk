...
func (client *Client) GetConfigByNameWithContext(ctx context.Context, request *GetConfigByNameRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetConfigByNameResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListInstanceInfoWithContext(ctx context.Context, request *ListInstanceInfoRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListInstanceInfoResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
