...
type iUpdateContextStoreRequest interface {
	...
	SetStatus(v string) *UpdateContextStoreRequest
	GetStatus() *string
...
func (s *UpdateContextStoreRequest) GetStatus() *string {
	return s.Status
}
...
func (s *UpdateContextStoreRequest) SetStatus(v string) *UpdateContextStoreRequest {
	s.Status = &v
	return s
}
