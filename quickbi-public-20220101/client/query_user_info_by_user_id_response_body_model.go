...
func (s *QueryUserInfoByUserIdResponseBodyResult) GetCopilotModules() []*string {
...
func (s *QueryUserInfoByUserIdResponseBodyResult) SetCopilotModules(v []*string) *QueryUserInfoByUserIdResponseBodyResult {
	s.CopilotModules = v
	return s
}
