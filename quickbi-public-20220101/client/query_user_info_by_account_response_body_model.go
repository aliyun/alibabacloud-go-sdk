...
func (s *QueryUserInfoByAccountResponseBodyResult) GetIsDeleted() *bool {
	return s.IsDeleted
}
...
func (s *QueryUserInfoByAccountResponseBodyResult) SetIsDeleted(v bool) *QueryUserInfoByAccountResponseBodyResult {
	s.IsDeleted = &v
	return s
}
