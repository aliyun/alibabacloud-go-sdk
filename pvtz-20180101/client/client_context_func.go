...
func (client *Client) DescribeIntranetUserCanAnalysisVpcsWithContext(ctx context.Context, request *DescribeIntranetUserCanAnalysisVpcsRequest, runtime *dara.RuntimeOptions) (_result *DescribeIntranetUserCanAnalysisVpcsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) DescribePvtzStatisticsGlobalOverviewWithContext(ctx context.Context, request *DescribePvtzStatisticsGlobalOverviewRequest, runtime *dara.RuntimeOptions) (_result *DescribePvtzStatisticsGlobalOverviewResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) DescribePvtzStatisticsHistoryWithContext(ctx context.Context, request *DescribePvtzStatisticsHistoryRequest, runtime *dara.RuntimeOptions) (_result *DescribePvtzStatisticsHistoryResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) DescribePvtzStatisticsSummaryWithContext(ctx context.Context, request *DescribePvtzStatisticsSummaryRequest, runtime *dara.RuntimeOptions) (_result *DescribePvtzStatisticsSummaryResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) DescribePvtzStatisticsZoneOverviewWithContext(ctx context.Context, request *DescribePvtzStatisticsZoneOverviewRequest, runtime *dara.RuntimeOptions) (_result *DescribePvtzStatisticsZoneOverviewResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
