...
type iResetSnapshotResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ResetSnapshotResponseBody
	GetRequestId() *string
}
...
func (s *ResetSnapshotResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ResetSnapshotResponseBody) Validate() error {
