...
type iModifyOfficeSiteAttributeResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ModifyOfficeSiteAttributeResponseBody
	GetRequestId() *string
}
...
func (s *ModifyOfficeSiteAttributeResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ModifyOfficeSiteAttributeResponseBody) Validate() error {
