...
type iUpdateFotaTaskResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *UpdateFotaTaskResponseBody
	GetRequestId() *string
}
...
func (s *UpdateFotaTaskResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *UpdateFotaTaskResponseBody) Validate() error {
