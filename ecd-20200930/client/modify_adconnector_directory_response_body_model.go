...
type iModifyADConnectorDirectoryResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ModifyADConnectorDirectoryResponseBody
	GetRequestId() *string
}
...
func (s *ModifyADConnectorDirectoryResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ModifyADConnectorDirectoryResponseBody) Validate() error {
