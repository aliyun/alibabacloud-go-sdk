...
type iConfigADConnectorUserResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ConfigADConnectorUserResponseBody
	GetRequestId() *string
}
...
func (s *ConfigADConnectorUserResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ConfigADConnectorUserResponseBody) Validate() error {
