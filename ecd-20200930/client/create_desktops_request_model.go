...
type iCreateDesktopsRequest interface {
	...
	SetReservePoolId(v string) *CreateDesktopsRequest
...
func (s *CreateDesktopsRequest) GetReservePoolId() *string {
...
func (s *CreateDesktopsRequest) SetReservePoolId(v string) *CreateDesktopsRequest {
	s.ReservePoolId = &v
	return s
}
