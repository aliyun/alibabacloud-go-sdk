...
type iListSnapshotsResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *ListSnapshotsOutput) *ListSnapshotsResponse
	GetBody() *ListSnapshotsOutput
}

type ListSnapshotsResponse struct {
	Headers    map[string]*string   `json:"headers" xml:"headers"`
	StatusCode *int32               `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *ListSnapshotsOutput `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *ListSnapshotsResponse) GetBody() *ListSnapshotsOutput {
	return s.Body
}
...
func (s *ListSnapshotsResponse) SetBody(v *ListSnapshotsOutput) *ListSnapshotsResponse {
	s.Body = v
	return s
}
