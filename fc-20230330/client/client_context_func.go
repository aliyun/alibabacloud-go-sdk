...
func (client *Client) CreateSnapshotWithContext(ctx context.Context, functionName *string, request *CreateSnapshotRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *CreateSnapshotResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) DeleteSnapshotWithContext(ctx context.Context, functionName *string, snapshotId *string, request *DeleteSnapshotRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *DeleteSnapshotResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GetSnapshotWithContext(ctx context.Context, functionName *string, snapshotId *string, request *GetSnapshotRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetSnapshotResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListSnapshotsWithContext(ctx context.Context, request *ListSnapshotsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListSnapshotsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
