...
func (client *Client) DescribeCouponListWithContext(ctx context.Context, request *DescribeCouponListRequest, runtime *dara.RuntimeOptions) (_result *DescribeCouponListResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) OpenCallbackWithContext(ctx context.Context, request *OpenCallbackRequest, runtime *dara.RuntimeOptions) (_result *OpenCallbackResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) QueryForCssOrderWithContext(ctx context.Context, request *QueryForCssOrderRequest, runtime *dara.RuntimeOptions) (_result *QueryForCssOrderResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) VnoBatchRefundOrderWithContext(ctx context.Context, request *VnoBatchRefundOrderRequest, runtime *dara.RuntimeOptions) (_result *VnoBatchRefundOrderResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
