...
type GetGraphQueryTemplatesRequest struct {
	...
	ServiceUnit *string `json:"ServiceUnit,omitempty" xml:"ServiceUnit,omitempty"`
}

func (s GetGraphQueryTemplatesRequest) String() string {
	return tea.Prettify(s)
}

func (s GetGraphQueryTemplatesRequest) GoString() string {
	return s.String()
}

func (s *GetGraphQueryTemplatesRequest) SetEnv(v string) *GetGraphQueryTemplatesRequest {
	s.Env = &v
	return s
}

func (s *GetGraphQueryTemplatesRequest) SetServiceUnit(v string) *GetGraphQueryTemplatesRequest {
	s.ServiceUnit = &v
	return s
}

type GetGraphQueryTemplatesResponseBody struct {
	Data      []*GetGraphQueryTemplatesResponseBodyData `json:"Data,omitempty" xml:"Data,omitempty" type:"Repeated"`
	RequestId *string                                   `json:"RequestId,omitempty" xml:"RequestId,omitempty"`
}

func (s GetGraphQueryTemplatesResponseBody) String() string {
	return tea.Prettify(s)
}

func (s GetGraphQueryTemplatesResponseBody) GoString() string {
	return s.String()
}

func (s *GetGraphQueryTemplatesResponseBody) SetData(v []*GetGraphQueryTemplatesResponseBodyData) *GetGraphQueryTemplatesResponseBody {
	s.Data = v
	return s
}

func (s *GetGraphQueryTemplatesResponseBody) SetRequestId(v string) *GetGraphQueryTemplatesResponseBody {
	s.RequestId = &v
	return s
}

type GetGraphQueryTemplatesResponseBodyData struct {
	GmtCreate       *string `json:"GmtCreate,omitempty" xml:"GmtCreate,omitempty"`
	GmtModified     *string `json:"GmtModified,omitempty" xml:"GmtModified,omitempty"`
	GremlinTemplate *string `json:"GremlinTemplate,omitempty" xml:"GremlinTemplate,omitempty"`
	Id              *int64  `json:"Id,omitempty" xml:"Id,omitempty"`
	LastModifier    *string `json:"LastModifier,omitempty" xml:"LastModifier,omitempty"`
	Scenario        *string `json:"Scenario,omitempty" xml:"Scenario,omitempty"`
	ScenarioDesc    *string `json:"ScenarioDesc,omitempty" xml:"ScenarioDesc,omitempty"`
	Status          *int32  `json:"Status,omitempty" xml:"Status,omitempty"`
}

func (s GetGraphQueryTemplatesResponseBodyData) String() string {
	return tea.Prettify(s)
}

func (s GetGraphQueryTemplatesResponseBodyData) GoString() string {
	return s.String()
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetGmtCreate(v string) *GetGraphQueryTemplatesResponseBodyData {
	s.GmtCreate = &v
	return s
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetGmtModified(v string) *GetGraphQueryTemplatesResponseBodyData {
	s.GmtModified = &v
	return s
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetGremlinTemplate(v string) *GetGraphQueryTemplatesResponseBodyData {
	s.GremlinTemplate = &v
	return s
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetId(v int64) *GetGraphQueryTemplatesResponseBodyData {
	s.Id = &v
	return s
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetLastModifier(v string) *GetGraphQueryTemplatesResponseBodyData {
	s.LastModifier = &v
	return s
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetScenario(v string) *GetGraphQueryTemplatesResponseBodyData {
	s.Scenario = &v
	return s
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetScenarioDesc(v string) *GetGraphQueryTemplatesResponseBodyData {
	s.ScenarioDesc = &v
	return s
}

func (s *GetGraphQueryTemplatesResponseBodyData) SetStatus(v int32) *GetGraphQueryTemplatesResponseBodyData {
	s.Status = &v
	return s
}
...
type GetGraphQueryTemplatesResponse struct {
	Headers    map[string]*string                  `json:"headers,omitempty" xml:"headers,omitempty" require:"true"`
	StatusCode *int32                              `json:"statusCode,omitempty" xml:"statusCode,omitempty" require:"true"`
	Body       *GetGraphQueryTemplatesResponseBody `json:"body,omitempty" xml:"body,omitempty" require:"true"`
}

func (s GetGraphQueryTemplatesResponse) String() string {
	return tea.Prettify(s)
}

func (s GetGraphQueryTemplatesResponse) GoString() string {
	return s.String()
}

func (s *GetGraphQueryTemplatesResponse) SetHeaders(v map[string]*string) *GetGraphQueryTemplatesResponse {
	s.Headers = v
	return s
}

func (s *GetGraphQueryTemplatesResponse) SetStatusCode(v int32) *GetGraphQueryTemplatesResponse {
	s.StatusCode = &v
	return s
}

func (s *GetGraphQueryTemplatesResponse) SetBody(v *GetGraphQueryTemplatesResponseBody) *GetGraphQueryTemplatesResponse {
	s.Body = v
	return s
}
...
func (client *Client) GetGraphQueryTemplatesWithOptions(request *GetGraphQueryTemplatesRequest, runtime *util.RuntimeOptions) (_result *GetGraphQueryTemplatesResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	if !tea.BoolValue(util.IsUnset(request.ServiceUnit)) {
	...
	params := &openapi.Params{
		Action:      tea.String("GetGraphQueryTemplates"),
		Version:     tea.String("2020-05-12"),
		Protocol:    tea.String("HTTPS"),
		Pathname:    tea.String("/"),
		Method:      tea.String("POST"),
	...
	_result = &GetGraphQueryTemplatesResponse{}
	_body, _err := client.CallApi(params, req, runtime)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) GetGraphQueryTemplates(request *GetGraphQueryTemplatesRequest) (_result *GetGraphQueryTemplatesResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	_result = &GetGraphQueryTemplatesResponse{}
	_body, _err := client.GetGraphQueryTemplatesWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
