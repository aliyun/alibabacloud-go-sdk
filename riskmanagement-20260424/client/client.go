...
func (client *Client) DownloadResourceControlEventsWithOptions(tmpReq *DownloadResourceControlEventsRequest, runtime *dara.RuntimeOptions) (_result *DownloadResourceControlEventsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return DownloadResourceControlEventsResponse
func (client *Client) DownloadResourceControlEvents(request *DownloadResourceControlEventsRequest) (_result *DownloadResourceControlEventsResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &DownloadResourceControlEventsResponse{}
	_body, _err := client.DownloadResourceControlEventsWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryAccountSafetyIncidentWithOptions(tmpReq *QueryAccountSafetyIncidentRequest, runtime *dara.RuntimeOptions) (_result *QueryAccountSafetyIncidentResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
