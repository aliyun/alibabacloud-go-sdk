...
type QueryTicketActionsRequest struct {
	ActionCodeList []*int64 `json:"ActionCodeList,omitempty" xml:"ActionCodeList,omitempty" type:"Repeated"`
	InstanceId     *string  `json:"InstanceId,omitempty" xml:"InstanceId,omitempty"`
...
func (s *QueryTicketActionsRequest) SetActionCodeList(v []*int64) *QueryTicketActionsRequest {
	s.ActionCodeList = v
	return s
}
...
func (client *Client) Init(config *openapi.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(tea.String("xixikf"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
