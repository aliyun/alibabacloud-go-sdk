...
type iQueryRobotTaskDetailResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetCode(v string) *QueryRobotTaskDetailResponseBody
	GetCode() *string
	SetData(v string) *QueryRobotTaskDetailResponseBody
	GetData() *string
	SetMessage(v string) *QueryRobotTaskDetailResponseBody
	GetMessage() *string
	SetRequestId(v string) *QueryRobotTaskDetailResponseBody
	GetRequestId() *string
}
...
func (s *QueryRobotTaskDetailResponseBody) GetCode() *string {
	return s.Code
}

func (s *QueryRobotTaskDetailResponseBody) GetData() *string {
	return s.Data
}

func (s *QueryRobotTaskDetailResponseBody) GetMessage() *string {
	return s.Message
}

func (s *QueryRobotTaskDetailResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *QueryRobotTaskDetailResponseBody) Validate() error {
