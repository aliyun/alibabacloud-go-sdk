...
type iQueryRobotTaskCallDetailResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetCode(v string) *QueryRobotTaskCallDetailResponseBody
	GetCode() *string
	SetData(v string) *QueryRobotTaskCallDetailResponseBody
	GetData() *string
	SetMessage(v string) *QueryRobotTaskCallDetailResponseBody
	GetMessage() *string
	SetRequestId(v string) *QueryRobotTaskCallDetailResponseBody
	GetRequestId() *string
}
...
func (s *QueryRobotTaskCallDetailResponseBody) GetCode() *string {
	return s.Code
}

func (s *QueryRobotTaskCallDetailResponseBody) GetData() *string {
	return s.Data
}

func (s *QueryRobotTaskCallDetailResponseBody) GetMessage() *string {
	return s.Message
}

func (s *QueryRobotTaskCallDetailResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *QueryRobotTaskCallDetailResponseBody) Validate() error {
