...
func (client *Client) CreateCallOutboundInstantWithOptions(request *CreateCallOutboundInstantRequest, runtime *dara.RuntimeOptions) (_result *CreateCallOutboundInstantResponse, _err error) {
...
//
// @return CreateCallOutboundInstantResponse
func (client *Client) CreateCallOutboundInstant(request *CreateCallOutboundInstantRequest) (_result *CreateCallOutboundInstantResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &CreateCallOutboundInstantResponse{}
	_body, _err := client.CreateCallOutboundInstantWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) QueryTaskConcurrencyWithOptions(request *QueryTaskConcurrencyRequest, runtime *dara.RuntimeOptions) (_result *QueryTaskConcurrencyResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return QueryTaskConcurrencyResponse
func (client *Client) QueryTaskConcurrency(request *QueryTaskConcurrencyRequest) (_result *QueryTaskConcurrencyResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &QueryTaskConcurrencyResponse{}
	_body, _err := client.QueryTaskConcurrencyWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
