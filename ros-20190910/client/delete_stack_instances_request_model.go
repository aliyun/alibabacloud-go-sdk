...
type iDeleteStackInstancesRequest interface {
	dara.Model
	String() string
	GoString() string
	SetAccountIds(v []*string) *DeleteStackInstancesRequest
	GetAccountIds() []*string
	SetClientToken(v string) *DeleteStackInstancesRequest
	GetClientToken() *string
	SetDeploymentTargets(v *DeleteStackInstancesRequestDeploymentTargets) *DeleteStackInstancesRequest
	GetDeploymentTargets() *DeleteStackInstancesRequestDeploymentTargets
	SetOperationDescription(v string) *DeleteStackInstancesRequest
	GetOperationDescription() *string
	SetOperationPreferences(v map[string]interface{}) *DeleteStackInstancesRequest
	GetOperationPreferences() map[string]interface{}
	SetRegionId(v string) *DeleteStackInstancesRequest
	GetRegionId() *string
	SetRegionIds(v []*string) *DeleteStackInstancesRequest
	GetRegionIds() []*string
	SetRetainStacks(v bool) *DeleteStackInstancesRequest
	GetRetainStacks() *bool
	SetStackGroupName(v string) *DeleteStackInstancesRequest
...
func (s *DeleteStackInstancesRequest) GetAccountIds() []*string {
	return s.AccountIds
}

func (s *DeleteStackInstancesRequest) GetClientToken() *string {
	return s.ClientToken
}

func (s *DeleteStackInstancesRequest) GetDeploymentTargets() *DeleteStackInstancesRequestDeploymentTargets {
	return s.DeploymentTargets
}

func (s *DeleteStackInstancesRequest) GetOperationDescription() *string {
	return s.OperationDescription
}

func (s *DeleteStackInstancesRequest) GetOperationPreferences() map[string]interface{} {
	return s.OperationPreferences
}

func (s *DeleteStackInstancesRequest) GetRegionId() *string {
	return s.RegionId
}

func (s *DeleteStackInstancesRequest) GetRegionIds() []*string {
	return s.RegionIds
}

func (s *DeleteStackInstancesRequest) GetRetainStacks() *bool {
	return s.RetainStacks
}

func (s *DeleteStackInstancesRequest) GetStackGroupName() *string {
...
func (s *DeleteStackInstancesRequestDeploymentTargets) GetAccountIds() []*string {
	return s.AccountIds
}

func (s *DeleteStackInstancesRequestDeploymentTargets) GetRdFolderIds() []*string {
...
func (s *DeleteStackInstancesRequestDeploymentTargets) Validate() error {
