...
type iGetTemplateParameterConstraintsRequest interface {
	...
	String() string
	GoString() string
	SetClientToken(v string) *GetTemplateParameterConstraintsRequest
	GetClientToken() *string
	SetParameters(v []*GetTemplateParameterConstraintsRequestParameters) *GetTemplateParameterConstraintsRequest
	GetParameters() []*GetTemplateParameterConstraintsRequestParameters
	SetParametersKeyFilter(v []*string) *GetTemplateParameterConstraintsRequest
	GetParametersKeyFilter() []*string
	SetParametersOrder(v []*string) *GetTemplateParameterConstraintsRequest
	GetParametersOrder() []*string
	SetRegionId(v string) *GetTemplateParameterConstraintsRequest
	GetRegionId() *string
	SetStackId(v string) *GetTemplateParameterConstraintsRequest
	GetStackId() *string
	SetTemplateBody(v string) *GetTemplateParameterConstraintsRequest
	GetTemplateBody() *string
	SetTemplateId(v string) *GetTemplateParameterConstraintsRequest
...
func (s *GetTemplateParameterConstraintsRequest) GetClientToken() *string {
	return s.ClientToken
}

func (s *GetTemplateParameterConstraintsRequest) GetParameters() []*GetTemplateParameterConstraintsRequestParameters {
	return s.Parameters
}

func (s *GetTemplateParameterConstraintsRequest) GetParametersKeyFilter() []*string {
	return s.ParametersKeyFilter
}

func (s *GetTemplateParameterConstraintsRequest) GetParametersOrder() []*string {
	return s.ParametersOrder
}
...
func (s *GetTemplateParameterConstraintsRequest) GetStackId() *string {
	return s.StackId
}

func (s *GetTemplateParameterConstraintsRequest) GetTemplateBody() *string {
	return s.TemplateBody
}

func (s *GetTemplateParameterConstraintsRequest) GetTemplateId() *string {
	return s.TemplateId
}
...
func (s *GetTemplateParameterConstraintsRequestParameters) GetParameterKey() *string {
	return s.ParameterKey
}

func (s *GetTemplateParameterConstraintsRequestParameters) GetParameterValue() *string {
...
func (s *GetTemplateParameterConstraintsRequestParameters) Validate() error {
	return dara.Validate(s)
}
