...
func (client *Client) Init(config *openapiutil.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(dara.String("videoseg"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
...
func (client *Client) SegmentVideoBodyWithOptions(request *SegmentVideoBodyRequest, runtime *dara.RuntimeOptions) (_result *SegmentVideoBodyResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapiutil.Params{
		Action:      dara.String("SegmentVideoBody"),
		Version:     dara.String("2020-03-20"),
		Protocol:    dara.String("HTTPS"),
		Pathname:    dara.String("/"),
		Method:      dara.String("POST"),
...
func (client *Client) SegmentVideoBodyAdvance(request *SegmentVideoBodyAdvanceRequest, runtime *dara.RuntimeOptions) (_result *SegmentVideoBodyResponse, _err error) {
	// Step 0: init client
	...
	if !dara.IsNil(request.VideoUrlObject) {
		...
		segmentVideoBodyReq.VideoUrl = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
