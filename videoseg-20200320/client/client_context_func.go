...
func (client *Client) SegmentVideoBodyWithContext(ctx context.Context, request *SegmentVideoBodyRequest, runtime *dara.RuntimeOptions) (_result *SegmentVideoBodyResponse, _err error) {
	_err = request.Validate()
	if _err != nil {
		return _result, _err
	}
