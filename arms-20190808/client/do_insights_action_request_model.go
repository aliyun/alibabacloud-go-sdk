...
type iDoInsightsActionRequest interface {
	dara.Model
	String() string
	GoString() string
	SetData(v string) *DoInsightsActionRequest
	GetData() *string
	SetModule(v string) *DoInsightsActionRequest
	GetModule() *string
	SetRegionId(v string) *DoInsightsActionRequest
	GetRegionId() *string
}
...
func (s DoInsightsActionRequest) GoString() string {
	return s.String()
}

func (s *DoInsightsActionRequest) GetData() *string {
	return s.Data
}

func (s *DoInsightsActionRequest) GetModule() *string {
	return s.Module
}

func (s *DoInsightsActionRequest) GetRegionId() *string {
	return s.RegionId
}

func (s *DoInsightsActionRequest) SetData(v string) *DoInsightsActionRequest {
	s.Data = &v
	return s
}
...
func (s *DoInsightsActionRequest) Validate() error {
