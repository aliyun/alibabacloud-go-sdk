...
type iSetImageSensitiveFileStatusRequest interface {
	dara.Model
	String() string
	GoString() string
	SetIdList(v []*int64) *SetImageSensitiveFileStatusRequest
	GetIdList() []*int64
	SetImageUuids(v string) *SetImageSensitiveFileStatusRequest
	GetImageUuids() *string
	SetScanRange(v []*string) *SetImageSensitiveFileStatusRequest
	GetScanRange() []*string
	SetSensitiveFileKey(v string) *SetImageSensitiveFileStatusRequest
	GetSensitiveFileKey() *string
	SetStatus(v int32) *SetImageSensitiveFileStatusRequest
	GetStatus() *int32
}

type SetImageSensitiveFileStatusRequest struct {
...
func (s SetImageSensitiveFileStatusRequest) String() string {
	return dara.Prettify(s)
}

func (s SetImageSensitiveFileStatusRequest) GoString() string {
	return s.String()
}

func (s *SetImageSensitiveFileStatusRequest) GetIdList() []*int64 {
	return s.IdList
}

func (s *SetImageSensitiveFileStatusRequest) GetImageUuids() *string {
	return s.ImageUuids
}

func (s *SetImageSensitiveFileStatusRequest) GetScanRange() []*string {
	return s.ScanRange
}

func (s *SetImageSensitiveFileStatusRequest) GetSensitiveFileKey() *string {
	return s.SensitiveFileKey
}

func (s *SetImageSensitiveFileStatusRequest) GetStatus() *int32 {
	return s.Status
}

func (s *SetImageSensitiveFileStatusRequest) SetIdList(v []*int64) *SetImageSensitiveFileStatusRequest {
	s.IdList = v
	return s
}

func (s *SetImageSensitiveFileStatusRequest) SetImageUuids(v string) *SetImageSensitiveFileStatusRequest {
	s.ImageUuids = &v
	return s
}

func (s *SetImageSensitiveFileStatusRequest) SetScanRange(v []*string) *SetImageSensitiveFileStatusRequest {
	s.ScanRange = v
	return s
}

func (s *SetImageSensitiveFileStatusRequest) SetSensitiveFileKey(v string) *SetImageSensitiveFileStatusRequest {
	s.SensitiveFileKey = &v
	return s
}

func (s *SetImageSensitiveFileStatusRequest) SetStatus(v int32) *SetImageSensitiveFileStatusRequest {
	s.Status = &v
	return s
}

func (s *SetImageSensitiveFileStatusRequest) Validate() error {
