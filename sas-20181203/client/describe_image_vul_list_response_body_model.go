...
func (s *DescribeImageVulListResponseBodyVulRecords) GetAgentlessCanFix() *bool {
...
func (s *DescribeImageVulListResponseBodyVulRecords) SetAgentlessCanFix(v bool) *DescribeImageVulListResponseBodyVulRecords {
	s.AgentlessCanFix = &v
	return s
}
