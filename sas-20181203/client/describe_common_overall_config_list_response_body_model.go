...
type iDescribeCommonOverallConfigListResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetOverallList(v []*DescribeCommonOverallConfigListResponseBodyOverallList) *DescribeCommonOverallConfigListResponseBody
	GetOverallList() []*DescribeCommonOverallConfigListResponseBodyOverallList
	SetRequestId(v string) *DescribeCommonOverallConfigListResponseBody
	GetRequestId() *string
}
...
func (s *DescribeCommonOverallConfigListResponseBody) GetOverallList() []*DescribeCommonOverallConfigListResponseBodyOverallList {
	return s.OverallList
}

func (s *DescribeCommonOverallConfigListResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *DescribeCommonOverallConfigListResponseBody) Validate() error {
	if s.OverallList != nil {
		for _, item := range s.OverallList {
			if item != nil {
...
type DescribeCommonOverallConfigListResponseBodyOverallList struct {
	...
	AuthVersionList []*string `json:"AuthVersionList,omitempty" xml:"AuthVersionList,omitempty" type:"Repeated"`
...
func (s *DescribeCommonOverallConfigListResponseBodyOverallList) GetAuthVersionList() []*string {
	return s.AuthVersionList
}

func (s *DescribeCommonOverallConfigListResponseBodyOverallList) GetConfig() *string {
	return s.Config
}

func (s *DescribeCommonOverallConfigListResponseBodyOverallList) GetTotalCount() *int32 {
	return s.TotalCount
}

func (s *DescribeCommonOverallConfigListResponseBodyOverallList) GetType() *string {
	return s.Type
}

func (s *DescribeCommonOverallConfigListResponseBodyOverallList) SetAuthVersionList(v []*string) *DescribeCommonOverallConfigListResponseBodyOverallList {
	s.AuthVersionList = v
	return s
}
...
func (s *DescribeCommonOverallConfigListResponseBodyOverallList) Validate() error {
