...
type iBatchOperateCommonOverallConfigRequest interface {
	dara.Model
	String() string
	GoString() string
	SetConfig(v string) *BatchOperateCommonOverallConfigRequest
	GetConfig() *string
	SetTypeList(v []*string) *BatchOperateCommonOverallConfigRequest
	GetTypeList() []*string
}
...
func (s *BatchOperateCommonOverallConfigRequest) GetConfig() *string {
	return s.Config
}

func (s *BatchOperateCommonOverallConfigRequest) GetTypeList() []*string {
	return s.TypeList
}
...
func (s *BatchOperateCommonOverallConfigRequest) Validate() error {
