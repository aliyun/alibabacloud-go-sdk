...
type iDescribeCommonTargetConfigRequest interface {
	dara.Model
	String() string
	GoString() string
	SetType(v string) *DescribeCommonTargetConfigRequest
	GetType() *string
}
...
func (s *DescribeCommonTargetConfigRequest) GetType() *string {
	return s.Type
}
...
func (s *DescribeCommonTargetConfigRequest) Validate() error {
