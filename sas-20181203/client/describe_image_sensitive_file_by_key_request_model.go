...
type iDescribeImageSensitiveFileByKeyRequest interface {
	dara.Model
	String() string
	GoString() string
	SetCurrentPage(v int32) *DescribeImageSensitiveFileByKeyRequest
	GetCurrentPage() *int32
	SetImageUuid(v string) *DescribeImageSensitiveFileByKeyRequest
	GetImageUuid() *string
	SetLang(v string) *DescribeImageSensitiveFileByKeyRequest
	GetLang() *string
	SetPageSize(v int32) *DescribeImageSensitiveFileByKeyRequest
	GetPageSize() *int32
	SetScanRange(v []*string) *DescribeImageSensitiveFileByKeyRequest
	GetScanRange() []*string
	SetSensitiveFileKey(v string) *DescribeImageSensitiveFileByKeyRequest
...
func (s *DescribeImageSensitiveFileByKeyRequest) GetCurrentPage() *int32 {
	return s.CurrentPage
}

func (s *DescribeImageSensitiveFileByKeyRequest) GetImageUuid() *string {
	return s.ImageUuid
}

func (s *DescribeImageSensitiveFileByKeyRequest) GetLang() *string {
	return s.Lang
}

func (s *DescribeImageSensitiveFileByKeyRequest) GetPageSize() *int32 {
	return s.PageSize
}

func (s *DescribeImageSensitiveFileByKeyRequest) GetScanRange() []*string {
	return s.ScanRange
}

func (s *DescribeImageSensitiveFileByKeyRequest) GetSensitiveFileKey() *string {
...
func (s *DescribeImageSensitiveFileByKeyRequest) Validate() error {
