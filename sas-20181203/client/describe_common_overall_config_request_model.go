...
type iDescribeCommonOverallConfigRequest interface {
	dara.Model
	String() string
	GoString() string
	SetSourceIp(v string) *DescribeCommonOverallConfigRequest
	GetSourceIp() *string
	SetType(v string) *DescribeCommonOverallConfigRequest
	GetType() *string
}
...
func (s *DescribeCommonOverallConfigRequest) GetSourceIp() *string {
	return s.SourceIp
}

func (s *DescribeCommonOverallConfigRequest) GetType() *string {
	return s.Type
}
...
func (s *DescribeCommonOverallConfigRequest) Validate() error {
