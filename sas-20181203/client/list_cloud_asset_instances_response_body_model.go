...
type ListCloudAssetInstancesResponseBodyInstances struct {
	...
	SaleCspm   *int32  `json:"SaleCspm,omitempty" xml:"SaleCspm,omitempty"`
	SaleType   *int32  `json:"SaleType,omitempty" xml:"SaleType,omitempty"`
...
func (s *ListCloudAssetInstancesResponseBodyInstances) GetAssetUuid() *string {
	return s.AssetUuid
}
...
func (s *ListCloudAssetInstancesResponseBodyInstances) GetSaleCspm() *int32 {
	return s.SaleCspm
}

func (s *ListCloudAssetInstancesResponseBodyInstances) GetSaleType() *int32 {
	return s.SaleType
}
...
func (s *ListCloudAssetInstancesResponseBodyInstances) SetAssetUuid(v string) *ListCloudAssetInstancesResponseBodyInstances {
	s.AssetUuid = &v
	return s
}
...
func (s *ListCloudAssetInstancesResponseBodyInstances) SetSaleCspm(v int32) *ListCloudAssetInstancesResponseBodyInstances {
	s.SaleCspm = &v
	return s
}

func (s *ListCloudAssetInstancesResponseBodyInstances) SetSaleType(v int32) *ListCloudAssetInstancesResponseBodyInstances {
	s.SaleType = &v
	return s
}
