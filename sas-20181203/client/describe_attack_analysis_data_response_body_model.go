...
type iDescribeAttackAnalysisDataResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetData(v string) *DescribeAttackAnalysisDataResponseBody
	GetData() *string
	SetPage(v int32) *DescribeAttackAnalysisDataResponseBody
	GetPage() *int32
	SetPageSize(v int32) *DescribeAttackAnalysisDataResponseBody
	GetPageSize() *int32
	SetRequestId(v string) *DescribeAttackAnalysisDataResponseBody
	GetRequestId() *string
	SetTotal(v int32) *DescribeAttackAnalysisDataResponseBody
	GetTotal() *int32
}
...
func (s *DescribeAttackAnalysisDataResponseBody) GetData() *string {
	return s.Data
}

func (s *DescribeAttackAnalysisDataResponseBody) GetPage() *int32 {
	return s.Page
}

func (s *DescribeAttackAnalysisDataResponseBody) GetPageSize() *int32 {
	return s.PageSize
}

func (s *DescribeAttackAnalysisDataResponseBody) GetRequestId() *string {
	return s.RequestId
}

func (s *DescribeAttackAnalysisDataResponseBody) GetTotal() *int32 {
	return s.Total
}
...
func (s *DescribeAttackAnalysisDataResponseBody) Validate() error {
