...
type iSetImageSensitiveFileStatusShrinkRequest interface {
	dara.Model
	String() string
	GoString() string
	SetIdList(v []*int64) *SetImageSensitiveFileStatusShrinkRequest
	GetIdList() []*int64
	SetImageUuids(v string) *SetImageSensitiveFileStatusShrinkRequest
	GetImageUuids() *string
	SetScanRangeShrink(v string) *SetImageSensitiveFileStatusShrinkRequest
	GetScanRangeShrink() *string
	SetSensitiveFileKey(v string) *SetImageSensitiveFileStatusShrinkRequest
	GetSensitiveFileKey() *string
	SetStatus(v int32) *SetImageSensitiveFileStatusShrinkRequest
	GetStatus() *int32
}

type SetImageSensitiveFileStatusShrinkRequest struct {
...
func (s SetImageSensitiveFileStatusShrinkRequest) String() string {
	return dara.Prettify(s)
}

func (s SetImageSensitiveFileStatusShrinkRequest) GoString() string {
	return s.String()
}

func (s *SetImageSensitiveFileStatusShrinkRequest) GetIdList() []*int64 {
	return s.IdList
}

func (s *SetImageSensitiveFileStatusShrinkRequest) GetImageUuids() *string {
	return s.ImageUuids
}

func (s *SetImageSensitiveFileStatusShrinkRequest) GetScanRangeShrink() *string {
	return s.ScanRangeShrink
}

func (s *SetImageSensitiveFileStatusShrinkRequest) GetSensitiveFileKey() *string {
	return s.SensitiveFileKey
}

func (s *SetImageSensitiveFileStatusShrinkRequest) GetStatus() *int32 {
	return s.Status
}

func (s *SetImageSensitiveFileStatusShrinkRequest) SetIdList(v []*int64) *SetImageSensitiveFileStatusShrinkRequest {
	s.IdList = v
	return s
}

func (s *SetImageSensitiveFileStatusShrinkRequest) SetImageUuids(v string) *SetImageSensitiveFileStatusShrinkRequest {
	s.ImageUuids = &v
	return s
}

func (s *SetImageSensitiveFileStatusShrinkRequest) SetScanRangeShrink(v string) *SetImageSensitiveFileStatusShrinkRequest {
	s.ScanRangeShrink = &v
	return s
}

func (s *SetImageSensitiveFileStatusShrinkRequest) SetSensitiveFileKey(v string) *SetImageSensitiveFileStatusShrinkRequest {
	s.SensitiveFileKey = &v
	return s
}

func (s *SetImageSensitiveFileStatusShrinkRequest) SetStatus(v int32) *SetImageSensitiveFileStatusShrinkRequest {
	s.Status = &v
	return s
}

func (s *SetImageSensitiveFileStatusShrinkRequest) Validate() error {
