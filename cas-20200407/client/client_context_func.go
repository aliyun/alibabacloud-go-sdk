...
func (client *Client) CreateRollbackTaskWithContext(ctx context.Context, request *CreateRollbackTaskRequest, runtime *dara.RuntimeOptions) (_result *CreateRollbackTaskResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ShareCertificateWithContext(ctx context.Context, request *ShareCertificateRequest, runtime *dara.RuntimeOptions) (_result *ShareCertificateResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
