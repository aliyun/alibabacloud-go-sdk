...
func (client *Client) BatchTranslateForHtmlWithOptions(tmpReq *BatchTranslateForHtmlRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *BatchTranslateForHtmlResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
	...
	request := &BatchTranslateForHtmlShrinkRequest{}
	openapiutil.Convert(tmpReq, request)
	if !dara.IsNil(tmpReq.Ext) {
		request.ExtShrink = openapiutil.ArrayToStringWithSpecifiedStyle(tmpReq.Ext, dara.String("ext"), dara.String("json"))
	}
	...
	params := &openapiutil.Params{
		Action:      dara.String("BatchTranslateForHtml"),
		Version:     dara.String("2025-07-07"),
		Protocol:    dara.String("HTTPS"),
		Pathname:    dara.String("/anytrans/translate/batchForHtml"),
		Method:      dara.String("POST"),
		AuthType:    dara.String("AK"),
		Style:       dara.String("ROA"),
		ReqBodyType: dara.String("formData"),
	...
	_result = &BatchTranslateForHtmlResponse{}
	_body, _err := client.CallApi(params, req, runtime)
	if _err != nil {
		return _result, _err
	}
...
//
// @return BatchTranslateForHtmlResponse
func (client *Client) BatchTranslateForHtml(request *BatchTranslateForHtmlRequest) (_result *BatchTranslateForHtmlResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &BatchTranslateForHtmlResponse{}
	_body, _err := client.BatchTranslateForHtmlWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) GetDocTranslateTaskWithOptions(request *GetDocTranslateTaskRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetDocTranslateTaskResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
...
func (client *Client) GetDocTranslateTask(request *GetDocTranslateTaskRequest) (_result *GetDocTranslateTaskResponse, _err error) {
	...
	headers := make(map[string]*string)
	_result = &GetDocTranslateTaskResponse{}
	_body, _err := client.GetDocTranslateTaskWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) SubmitDocTranslateTaskWithOptions(tmpReq *SubmitDocTranslateTaskRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *SubmitDocTranslateTaskResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return SubmitDocTranslateTaskResponse
func (client *Client) SubmitDocTranslateTask(request *SubmitDocTranslateTaskRequest) (_result *SubmitDocTranslateTaskResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &SubmitDocTranslateTaskResponse{}
	_body, _err := client.SubmitDocTranslateTaskWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
