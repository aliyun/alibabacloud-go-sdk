...
func (client *Client) BatchTranslateForHtmlWithContext(ctx context.Context, tmpReq *BatchTranslateForHtmlRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *BatchTranslateForHtmlResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) TermQueryWithContext(ctx context.Context, tmpReq *TermQueryRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *TermQueryResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
