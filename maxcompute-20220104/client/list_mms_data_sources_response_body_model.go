...
func (s *ListMmsDataSourcesResponseBodyDataObjectList) GetScanErrMsg() *string {
	return s.ScanErrMsg
}
...
func (s *ListMmsDataSourcesResponseBodyDataObjectList) GetScanStatus() *string {
	return s.ScanStatus
}
...
func (s *ListMmsDataSourcesResponseBodyDataObjectList) SetScanErrMsg(v string) *ListMmsDataSourcesResponseBodyDataObjectList {
	s.ScanErrMsg = &v
	return s
}
...
func (s *ListMmsDataSourcesResponseBodyDataObjectList) SetScanStatus(v string) *ListMmsDataSourcesResponseBodyDataObjectList {
	s.ScanStatus = &v
	return s
}
