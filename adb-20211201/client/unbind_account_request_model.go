...
type iUnbindAccountRequest interface {
	dara.Model
	String() string
	GoString() string
	SetAccountName(v string) *UnbindAccountRequest
	GetAccountName() *string
	SetDBClusterId(v string) *UnbindAccountRequest
...
func (s *UnbindAccountRequest) GetAccountName() *string {
	return s.AccountName
}

func (s *UnbindAccountRequest) GetDBClusterId() *string {
...
func (s *UnbindAccountRequest) Validate() error {
