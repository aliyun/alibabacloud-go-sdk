...
type JyGetMobileRequest struct {
	// 认证Token
	AccessToken          *string `json:"AccessToken,omitempty" xml:"AccessToken,omitempty"`
	OutId                *string `json:"OutId,omitempty" xml:"OutId,omitempty"`
	OwnerId              *int64  `json:"OwnerId,omitempty" xml:"OwnerId,omitempty"`
...
func (s JyGetMobileRequest) String() string {
	return tea.Prettify(s)
}

func (s JyGetMobileRequest) GoString() string {
	return s.String()
}

func (s *JyGetMobileRequest) SetAccessToken(v string) *JyGetMobileRequest {
	s.AccessToken = &v
	return s
}

func (s *JyGetMobileRequest) SetOutId(v string) *JyGetMobileRequest {
	s.OutId = &v
	return s
}

func (s *JyGetMobileRequest) SetOwnerId(v int64) *JyGetMobileRequest {
	s.OwnerId = &v
	return s
}

func (s *JyGetMobileRequest) SetResourceOwnerAccount(v string) *JyGetMobileRequest {
	s.ResourceOwnerAccount = &v
	return s
}

func (s *JyGetMobileRequest) SetResourceOwnerId(v int64) *JyGetMobileRequest {
	s.ResourceOwnerId = &v
	return s
}

type JyGetMobileResponseBody struct {
	Code                *string                                     `json:"Code,omitempty" xml:"Code,omitempty"`
	GetMobileResultData *JyGetMobileResponseBodyGetMobileResultData `json:"GetMobileResultData,omitempty" xml:"GetMobileResultData,omitempty" type:"Struct"`
	Message             *string                                     `json:"Message,omitempty" xml:"Message,omitempty"`
	RequestId           *string                                     `json:"RequestId,omitempty" xml:"RequestId,omitempty"`
}

func (s JyGetMobileResponseBody) String() string {
	return tea.Prettify(s)
}

func (s JyGetMobileResponseBody) GoString() string {
	return s.String()
}

func (s *JyGetMobileResponseBody) SetCode(v string) *JyGetMobileResponseBody {
	s.Code = &v
	return s
}

func (s *JyGetMobileResponseBody) SetGetMobileResultData(v *JyGetMobileResponseBodyGetMobileResultData) *JyGetMobileResponseBody {
	s.GetMobileResultData = v
	return s
}

func (s *JyGetMobileResponseBody) SetMessage(v string) *JyGetMobileResponseBody {
	s.Message = &v
	return s
}

func (s *JyGetMobileResponseBody) SetRequestId(v string) *JyGetMobileResponseBody {
	s.RequestId = &v
	return s
}

type JyGetMobileResponseBodyGetMobileResultData struct {
	Mobile *string `json:"Mobile,omitempty" xml:"Mobile,omitempty"`
}

func (s JyGetMobileResponseBodyGetMobileResultData) String() string {
	return tea.Prettify(s)
}

func (s JyGetMobileResponseBodyGetMobileResultData) GoString() string {
	return s.String()
}

func (s *JyGetMobileResponseBodyGetMobileResultData) SetMobile(v string) *JyGetMobileResponseBodyGetMobileResultData {
	s.Mobile = &v
	return s
}

type JyGetMobileResponse struct {
	Headers map[string]*string       `json:"headers,omitempty" xml:"headers,omitempty" require:"true"`
	Body    *JyGetMobileResponseBody `json:"body,omitempty" xml:"body,omitempty" require:"true"`
}

func (s JyGetMobileResponse) String() string {
	return tea.Prettify(s)
}

func (s JyGetMobileResponse) GoString() string {
	return s.String()
}

func (s *JyGetMobileResponse) SetHeaders(v map[string]*string) *JyGetMobileResponse {
	s.Headers = v
	return s
}

func (s *JyGetMobileResponse) SetBody(v *JyGetMobileResponseBody) *JyGetMobileResponse {
	s.Body = v
	return s
}
...
func (client *Client) JyGetMobileWithOptions(request *JyGetMobileRequest, runtime *util.RuntimeOptions) (_result *JyGetMobileResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) JyGetMobile(request *JyGetMobileRequest) (_result *JyGetMobileResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	_result = &JyGetMobileResponse{}
	_body, _err := client.JyGetMobileWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
