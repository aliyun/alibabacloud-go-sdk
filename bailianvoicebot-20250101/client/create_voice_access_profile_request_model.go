...
type iCreateVoiceAccessProfileRequest interface {
	...
	String() string
	GoString() string
	SetBusinessUnitId(v string) *CreateVoiceAccessProfileRequest
...
func (s *CreateVoiceAccessProfileRequest) GetBusinessUnitId() *string {
...
func (s *CreateVoiceAccessProfileRequest) SetBusinessUnitId(v string) *CreateVoiceAccessProfileRequest {
	s.BusinessUnitId = &v
	return s
}
