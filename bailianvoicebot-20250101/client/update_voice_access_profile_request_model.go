...
type iUpdateVoiceAccessProfileRequest interface {
	...
	SetBusinessUnitId(v string) *UpdateVoiceAccessProfileRequest
...
func (s *UpdateVoiceAccessProfileRequest) GetBusinessUnitId() *string {
...
func (s *UpdateVoiceAccessProfileRequest) SetBusinessUnitId(v string) *UpdateVoiceAccessProfileRequest {
	s.BusinessUnitId = &v
	return s
}
