...
type iListBackgroundMusicsRequest interface {
	...
	String() string
	GoString() string
	SetBusinessUnitId(v string) *ListBackgroundMusicsRequest
...
func (s *ListBackgroundMusicsRequest) GetBusinessUnitId() *string {
...
func (s *ListBackgroundMusicsRequest) SetBusinessUnitId(v string) *ListBackgroundMusicsRequest {
	s.BusinessUnitId = &v
	return s
}
