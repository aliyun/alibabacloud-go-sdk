...
type iPreviewVoiceRequest interface {
	...
	String() string
	GoString() string
	SetBusinessUnitId(v string) *PreviewVoiceRequest
...
func (s *PreviewVoiceRequest) GetBusinessUnitId() *string {
...
func (s *PreviewVoiceRequest) SetBusinessUnitId(v string) *PreviewVoiceRequest {
	s.BusinessUnitId = &v
	return s
}
