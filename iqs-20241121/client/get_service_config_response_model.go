...
type iGetServiceConfigResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *ServiceConfigResult) *GetServiceConfigResponse
...
func (s *GetServiceConfigResponse) GetBody() *ServiceConfigResult {
	return s.Body
}
...
func (s *GetServiceConfigResponse) SetBody(v *ServiceConfigResult) *GetServiceConfigResponse {
	s.Body = v
	return s
}
