...
func (client *Client) GetSessionContentWithOptions(request *GetSessionContentRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetSessionContentResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return GetSessionContentResponse
func (client *Client) GetSessionContent(request *GetSessionContentRequest) (_result *GetSessionContentResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &GetSessionContentResponse{}
	_body, _err := client.GetSessionContentWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
