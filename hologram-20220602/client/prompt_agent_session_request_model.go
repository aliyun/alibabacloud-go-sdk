...
type iPromptAgentSessionRequest interface {
	...
	String() string
	GoString() string
	SetCallerContext(v string) *PromptAgentSessionRequest
...
func (s *PromptAgentSessionRequest) GetCallerContext() *string {
...
func (s *PromptAgentSessionRequest) SetCallerContext(v string) *PromptAgentSessionRequest {
	s.CallerContext = &v
	return s
}
