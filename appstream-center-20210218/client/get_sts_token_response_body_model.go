...
func (s *GetStsTokenResponseBodyStsTokenModel) GetAliUid() *int64 {
	return s.AliUid
}
...
func (s *GetStsTokenResponseBodyStsTokenModel) SetAliUid(v int64) *GetStsTokenResponseBodyStsTokenModel {
	s.AliUid = &v
	return s
}
