...
type DescribeKnowledgeBaseAnswerResponseBodySources struct {
	...
	ImageResources []*DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources `json:"ImageResources,omitempty" xml:"ImageResources,omitempty" type:"Repeated"`
...
func (s *DescribeKnowledgeBaseAnswerResponseBodySources) GetImageResources() []*DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources {
...
func (s *DescribeKnowledgeBaseAnswerResponseBodySources) SetImageResources(v []*DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) *DescribeKnowledgeBaseAnswerResponseBodySources {
	s.ImageResources = v
	return s
}
...
type DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources struct {
...
func (s DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) String() string {
	return dara.Prettify(s)
}

func (s DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) GoString() string {
	return s.String()
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) GetDocumentIndex() *int32 {
	return s.DocumentIndex
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) GetId() *string {
	return s.Id
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) GetItemRef() *string {
	return s.ItemRef
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) GetMimeType() *string {
	return s.MimeType
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) GetUri() *string {
	return s.Uri
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) SetDocumentIndex(v int32) *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources {
	s.DocumentIndex = &v
	return s
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) SetId(v string) *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources {
	s.Id = &v
	return s
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) SetItemRef(v string) *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources {
	s.ItemRef = &v
	return s
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) SetMimeType(v string) *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources {
	s.MimeType = &v
	return s
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) SetUri(v string) *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources {
	s.Uri = &v
	return s
}

func (s *DescribeKnowledgeBaseAnswerResponseBodySourcesImageResources) Validate() error {
