...
type iDeleteKnowledgeBaseResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *DeleteKnowledgeBaseResponseBody) *DeleteKnowledgeBaseResponse
	GetBody() *DeleteKnowledgeBaseResponseBody
}

type DeleteKnowledgeBaseResponse struct {
	Headers    map[string]*string               `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                           `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *DeleteKnowledgeBaseResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *DeleteKnowledgeBaseResponse) GetBody() *DeleteKnowledgeBaseResponseBody {
	return s.Body
}
...
func (s *DeleteKnowledgeBaseResponse) SetBody(v *DeleteKnowledgeBaseResponseBody) *DeleteKnowledgeBaseResponse {
	s.Body = v
	return s
}
