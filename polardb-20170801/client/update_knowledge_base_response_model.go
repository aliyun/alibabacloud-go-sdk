...
type iUpdateKnowledgeBaseResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *UpdateKnowledgeBaseResponseBody) *UpdateKnowledgeBaseResponse
	GetBody() *UpdateKnowledgeBaseResponseBody
}

type UpdateKnowledgeBaseResponse struct {
	Headers    map[string]*string               `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                           `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *UpdateKnowledgeBaseResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *UpdateKnowledgeBaseResponse) GetBody() *UpdateKnowledgeBaseResponseBody {
	return s.Body
}
...
func (s *UpdateKnowledgeBaseResponse) SetBody(v *UpdateKnowledgeBaseResponseBody) *UpdateKnowledgeBaseResponse {
	s.Body = v
	return s
}
