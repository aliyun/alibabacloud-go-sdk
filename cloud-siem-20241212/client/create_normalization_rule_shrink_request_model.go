...
type iCreateNormalizationRuleShrinkRequest interface {
	...
	SetExtendFieldStoreMode(v string) *CreateNormalizationRuleShrinkRequest
	...
	SetNormalizationSecurityDomainId(v string) *CreateNormalizationRuleShrinkRequest
...
func (s *CreateNormalizationRuleShrinkRequest) GetExtendFieldStoreMode() *string {
...
func (s *CreateNormalizationRuleShrinkRequest) GetNormalizationSecurityDomainId() *string {
...
func (s *CreateNormalizationRuleShrinkRequest) SetExtendFieldStoreMode(v string) *CreateNormalizationRuleShrinkRequest {
...
func (s *CreateNormalizationRuleShrinkRequest) SetNormalizationSecurityDomainId(v string) *CreateNormalizationRuleShrinkRequest {
