...
func (client *Client) GenerateEvaluationReportWithOptions(tmpReq *GenerateEvaluationReportRequest, runtime *dara.RuntimeOptions) (_result *GenerateEvaluationReportResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return GenerateEvaluationReportResponse
func (client *Client) GenerateEvaluationReport(request *GenerateEvaluationReportRequest) (_result *GenerateEvaluationReportResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &GenerateEvaluationReportResponse{}
	_body, _err := client.GenerateEvaluationReportWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
