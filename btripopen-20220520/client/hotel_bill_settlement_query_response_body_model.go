...
type HotelBillSettlementQueryResponseBodyModuleDataList struct {
	...
	BudgetNumber   *string `json:"budget_number,omitempty" xml:"budget_number,omitempty"`
	BusinessReason *string `json:"business_reason,omitempty" xml:"business_reason,omitempty"`
	// example:
	//
	// 因公司要求，需要到XX同XX公司谈业务
	...
	CustomApplyId  *string `json:"custom_apply_id,omitempty" xml:"custom_apply_id,omitempty"`
	// example:
	//
	...
	ExternalPersonType *string `json:"external_person_type,omitempty" xml:"external_person_type,omitempty"`
	// example:
	//
	// 20101
	...
	// example:
	//
	// 全季北京广渠路酒店(Season Beijing guangqu road branch)
...
func (s *HotelBillSettlementQueryResponseBodyModuleDataList) GetBudgetNumber() *string {
	return s.BudgetNumber
}

func (s *HotelBillSettlementQueryResponseBodyModuleDataList) GetBusinessReason() *string {
	return s.BusinessReason
}
...
func (s *HotelBillSettlementQueryResponseBodyModuleDataList) GetCustomApplyId() *string {
	return s.CustomApplyId
}
...
func (s *HotelBillSettlementQueryResponseBodyModuleDataList) GetExternalPersonType() *string {
	return s.ExternalPersonType
}
...
func (s *HotelBillSettlementQueryResponseBodyModuleDataList) SetBudgetNumber(v string) *HotelBillSettlementQueryResponseBodyModuleDataList {
	s.BudgetNumber = &v
	return s
}

func (s *HotelBillSettlementQueryResponseBodyModuleDataList) SetBusinessReason(v string) *HotelBillSettlementQueryResponseBodyModuleDataList {
	s.BusinessReason = &v
	return s
}
...
func (s *HotelBillSettlementQueryResponseBodyModuleDataList) SetCustomApplyId(v string) *HotelBillSettlementQueryResponseBodyModuleDataList {
	s.CustomApplyId = &v
	return s
}
...
func (s *HotelBillSettlementQueryResponseBodyModuleDataList) SetExternalPersonType(v string) *HotelBillSettlementQueryResponseBodyModuleDataList {
	s.ExternalPersonType = &v
	return s
}
