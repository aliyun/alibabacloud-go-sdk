...
type iIeCarBillSettlementQueryRequest interface {
	...
	String() string
	GoString() string
	SetApplyId(v string) *IeCarBillSettlementQueryRequest
	GetApplyId() *string
...
func (s *IeCarBillSettlementQueryRequest) GetApplyId() *string {
	return s.ApplyId
}
...
func (s *IeCarBillSettlementQueryRequest) SetApplyId(v string) *IeCarBillSettlementQueryRequest {
	s.ApplyId = &v
	return s
}
