...
type iHotelOrderPreValidateShrinkRequest interface {
	...
	GetRoomNum() *int32
	SetRpType(v int32) *HotelOrderPreValidateShrinkRequest
	GetRpType() *int32
...
func (s *HotelOrderPreValidateShrinkRequest) GetRpType() *int32 {
	return s.RpType
}
...
func (s *HotelOrderPreValidateShrinkRequest) SetRpType(v int32) *HotelOrderPreValidateShrinkRequest {
	s.RpType = &v
	return s
}
