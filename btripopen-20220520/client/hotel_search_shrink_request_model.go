...
type iHotelSearchShrinkRequest interface {
	...
	SetPoi(v string) *HotelSearchShrinkRequest
	GetPoi() *string
...
func (s *HotelSearchShrinkRequest) GetPoi() *string {
	return s.Poi
}
...
func (s *HotelSearchShrinkRequest) SetPoi(v string) *HotelSearchShrinkRequest {
	s.Poi = &v
	return s
}
