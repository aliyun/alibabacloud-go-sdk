...
type iTrainBillSettlementQueryRequest interface {
	...
	String() string
	GoString() string
	SetApplyId(v string) *TrainBillSettlementQueryRequest
	GetApplyId() *string
...
func (s *TrainBillSettlementQueryRequest) GetApplyId() *string {
	return s.ApplyId
}
...
func (s *TrainBillSettlementQueryRequest) SetApplyId(v string) *TrainBillSettlementQueryRequest {
	s.ApplyId = &v
	return s
}
