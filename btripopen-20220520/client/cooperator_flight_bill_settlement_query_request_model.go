...
type iCooperatorFlightBillSettlementQueryRequest interface {
	...
	String() string
	GoString() string
	SetApplyId(v string) *CooperatorFlightBillSettlementQueryRequest
	GetApplyId() *string
...
func (s *CooperatorFlightBillSettlementQueryRequest) GetApplyId() *string {
	return s.ApplyId
}
...
func (s *CooperatorFlightBillSettlementQueryRequest) SetApplyId(v string) *CooperatorFlightBillSettlementQueryRequest {
	s.ApplyId = &v
	return s
}
