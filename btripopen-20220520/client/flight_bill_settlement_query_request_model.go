...
type iFlightBillSettlementQueryRequest interface {
	...
	String() string
	GoString() string
	SetApplyId(v string) *FlightBillSettlementQueryRequest
	GetApplyId() *string
...
func (s *FlightBillSettlementQueryRequest) GetApplyId() *string {
	return s.ApplyId
}
...
func (s *FlightBillSettlementQueryRequest) SetApplyId(v string) *FlightBillSettlementQueryRequest {
	s.ApplyId = &v
	return s
}
