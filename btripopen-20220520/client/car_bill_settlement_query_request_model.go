...
type iCarBillSettlementQueryRequest interface {
	...
	String() string
	GoString() string
	SetApplyId(v string) *CarBillSettlementQueryRequest
	GetApplyId() *string
...
func (s *CarBillSettlementQueryRequest) GetApplyId() *string {
	return s.ApplyId
}
...
func (s *CarBillSettlementQueryRequest) SetApplyId(v string) *CarBillSettlementQueryRequest {
	s.ApplyId = &v
	return s
}
