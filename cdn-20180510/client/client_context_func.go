...
func (client *Client) GenerateCdnDiagnoseWithContext(ctx context.Context, request *GenerateCdnDiagnoseRequest, runtime *dara.RuntimeOptions) (_result *GenerateCdnDiagnoseResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
