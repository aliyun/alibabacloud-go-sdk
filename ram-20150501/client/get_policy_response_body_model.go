...
type iGetPolicyResponseBody interface {
	...
	String() string
	GoString() string
	SetDefaultPolicyVersion(v *GetPolicyResponseBodyDefaultPolicyVersion) *GetPolicyResponseBody
	GetDefaultPolicyVersion() *GetPolicyResponseBodyDefaultPolicyVersion
...
func (s *GetPolicyResponseBody) GetDefaultPolicyVersion() *GetPolicyResponseBodyDefaultPolicyVersion {
	return s.DefaultPolicyVersion
}
...
func (s *GetPolicyResponseBody) Validate() error {
	if s.DefaultPolicyVersion != nil {
		if err := s.DefaultPolicyVersion.Validate(); err != nil {
			return err
		}
	}
	if s.Policy != nil {
...
func (s *GetPolicyResponseBodyDefaultPolicyVersion) GetCreateDate() *string {
	return s.CreateDate
}

func (s *GetPolicyResponseBodyDefaultPolicyVersion) GetIsDefaultVersion() *bool {
	return s.IsDefaultVersion
}

func (s *GetPolicyResponseBodyDefaultPolicyVersion) GetPolicyDocument() *string {
	return s.PolicyDocument
}

func (s *GetPolicyResponseBodyDefaultPolicyVersion) GetVersionId() *string {
	return s.VersionId
}
...
func (s *GetPolicyResponseBodyDefaultPolicyVersion) Validate() error {
