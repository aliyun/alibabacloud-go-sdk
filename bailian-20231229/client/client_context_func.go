...
func (client *Client) AddChunkWithContext(ctx context.Context, WorkspaceId *string, tmpReq *AddChunkRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *AddChunkResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
...
func (client *Client) DeleteConnectorWithContext(ctx context.Context, ConnectorId *string, WorkspaceId *string, request *DeleteConnectorRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *DeleteConnectorResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) DeleteFilesWithContext(ctx context.Context, WorkspaceId *string, tmpReq *DeleteFilesRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *DeleteFilesResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListPublishedAgentWithContext(ctx context.Context, workspaceId *string, tmpReq *ListPublishedAgentRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListPublishedAgentResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
	...
	request := &ListPublishedAgentShrinkRequest{}
	openapiutil.Convert(tmpReq, request)
	if !dara.IsNil(tmpReq.SubTypes) {
		request.SubTypesShrink = openapiutil.ArrayToStringWithSpecifiedStyle(tmpReq.SubTypes, dara.String("subTypes"), dara.String("json"))
	}
	...
	if !dara.IsNil(request.SubTypesShrink) {
...
func (client *Client) UpdateConnectorWithContext(ctx context.Context, WorkspaceId *string, ConnectorId *string, request *UpdateConnectorRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *UpdateConnectorResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) UpdateIndexWithContext(ctx context.Context, WorkspaceId *string, request *UpdateIndexRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *UpdateIndexResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
