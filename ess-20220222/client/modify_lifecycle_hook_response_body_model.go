...
type iModifyLifecycleHookResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ModifyLifecycleHookResponseBody
	GetRequestId() *string
}
...
func (s *ModifyLifecycleHookResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ModifyLifecycleHookResponseBody) Validate() error {
