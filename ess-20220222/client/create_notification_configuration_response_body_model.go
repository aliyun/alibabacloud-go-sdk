...
type iCreateNotificationConfigurationResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *CreateNotificationConfigurationResponseBody
	GetRequestId() *string
}
...
func (s *CreateNotificationConfigurationResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *CreateNotificationConfigurationResponseBody) Validate() error {
