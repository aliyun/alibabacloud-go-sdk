...
type iModifyScalingGroupResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ModifyScalingGroupResponseBody
	GetRequestId() *string
}
...
func (s *ModifyScalingGroupResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ModifyScalingGroupResponseBody) Validate() error {
