...
type iDetachVServerGroupsResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *DetachVServerGroupsResponseBody
	GetRequestId() *string
}
...
func (s *DetachVServerGroupsResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *DetachVServerGroupsResponseBody) Validate() error {
