...
type iDetachDBInstancesResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *DetachDBInstancesResponseBody
	GetRequestId() *string
}
...
func (s *DetachDBInstancesResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *DetachDBInstancesResponseBody) Validate() error {
