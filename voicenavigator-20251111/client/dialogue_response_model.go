...
type iDialogueResponse interface {
	...
	GetStatusCode() *int32
	SetId(v string) *DialogueResponse
	GetId() *string
	SetEvent(v string) *DialogueResponse
	GetEvent() *string
...
func (s *DialogueResponse) GetId() *string {
	return s.Id
}

func (s *DialogueResponse) GetEvent() *string {
	return s.Event
}
...
func (s *DialogueResponse) SetId(v string) *DialogueResponse {
	s.Id = &v
	return s
}

func (s *DialogueResponse) SetEvent(v string) *DialogueResponse {
	s.Event = &v
	return s
}
