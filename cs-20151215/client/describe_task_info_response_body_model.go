...
type iDescribeTaskInfoResponseBody interface {
	...
	SetOutputs(v map[string]interface{}) *DescribeTaskInfoResponseBody
...
func (s *DescribeTaskInfoResponseBody) GetOutputs() map[string]interface{} {
	return s.Outputs
}
...
func (s *DescribeTaskInfoResponseBody) SetOutputs(v map[string]interface{}) *DescribeTaskInfoResponseBody {
	s.Outputs = v
	return s
}
