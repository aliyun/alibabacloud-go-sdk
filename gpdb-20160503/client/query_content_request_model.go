...
func (s *QueryContentRequestRerankModel) GetRerankMetadataFields() *string {
...
func (s *QueryContentRequestRerankModel) SetRerankMetadataFields(v string) *QueryContentRequestRerankModel {
