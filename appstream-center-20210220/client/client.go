...
func (client *Client) ClientUserLogoutWithOptions(request *ClientUserLogoutRequest, runtime *dara.RuntimeOptions) (_result *ClientUserLogoutResponse, _err error) {
...
//
// @return ClientUserLogoutResponse
func (client *Client) ClientUserLogout(request *ClientUserLogoutRequest) (_result *ClientUserLogoutResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &ClientUserLogoutResponse{}
	_body, _err := client.ClientUserLogoutWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
