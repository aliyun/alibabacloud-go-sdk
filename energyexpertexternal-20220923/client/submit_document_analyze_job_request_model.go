...
type iSubmitDocumentAnalyzeJobRequest interface {
	dara.Model
	String() string
	GoString() string
	SetAnalysisType(v string) *SubmitDocumentAnalyzeJobRequest
	GetAnalysisType() *string
	SetFileName(v string) *SubmitDocumentAnalyzeJobRequest
	GetFileName() *string
	SetFileUrl(v string) *SubmitDocumentAnalyzeJobRequest
	GetFileUrl() *string
	SetFolderId(v string) *SubmitDocumentAnalyzeJobRequest
	GetFolderId() *string
	SetTemplateId(v string) *SubmitDocumentAnalyzeJobRequest
...
func (s *SubmitDocumentAnalyzeJobRequest) GetAnalysisType() *string {
	return s.AnalysisType
}

func (s *SubmitDocumentAnalyzeJobRequest) GetFileName() *string {
	return s.FileName
}

func (s *SubmitDocumentAnalyzeJobRequest) GetFileUrl() *string {
	return s.FileUrl
}

func (s *SubmitDocumentAnalyzeJobRequest) GetFolderId() *string {
	return s.FolderId
}

func (s *SubmitDocumentAnalyzeJobRequest) GetTemplateId() *string {
	return s.TemplateId
}
...
func (s *SubmitDocumentAnalyzeJobRequest) Validate() error {
