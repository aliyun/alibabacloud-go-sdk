...
type ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound struct {
	...
	SatisfactionCount *int64 `json:"SatisfactionCount,omitempty" xml:"SatisfactionCount,omitempty"`
	// example:
	//
	// 1.4
...
func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound) GetSatisfactionCount() *int64 {
	return s.SatisfactionCount
}
...
func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound) SetSatisfactionCount(v int64) *ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound {
	s.SatisfactionCount = &v
	return s
}
...
func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound) GetSatisfactionCount() *int64 {
	return s.SatisfactionCount
}
...
func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound) SetSatisfactionCount(v int64) *ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound {
	s.SatisfactionCount = &v
	return s
}
...
func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall) GetSatisfactionCount() *int64 {
	return s.SatisfactionCount
}
...
func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall) GetTotalOffSiteOnlineTime() *int64 {
	return s.TotalOffSiteOnlineTime
}

func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall) GetTotalOfficePhoneOnlineTime() *int64 {
	return s.TotalOfficePhoneOnlineTime
}

func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall) GetTotalOnSiteOnlineTime() *int64 {
...
func (s *ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall) SetSatisfactionCount(v int64) *ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall {
	s.SatisfactionCount = &v
	return s
}
