...
type iDataSchemaPropertiesValue interface {
	...
	SetCreatedBy(v string) *DataSchemaPropertiesValue
	GetCreatedBy() *string
}
...
func (s *DataSchemaPropertiesValue) GetCreatedBy() *string {
	return s.CreatedBy
}
...
func (s *DataSchemaPropertiesValue) SetCreatedBy(v string) *DataSchemaPropertiesValue {
	s.CreatedBy = &v
	return s
}
