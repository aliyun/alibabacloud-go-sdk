...
func (s *ListIntervalAgentSkillGroupReportResponseBodyDataInbound) GetSatisfactionCount() *int64 {
...
func (s *ListIntervalAgentSkillGroupReportResponseBodyDataInbound) SetSatisfactionCount(v int64) *ListIntervalAgentSkillGroupReportResponseBodyDataInbound {
...
func (s *ListIntervalAgentSkillGroupReportResponseBodyDataOutbound) GetSatisfactionCount() *int64 {
	return s.SatisfactionCount
}
...
func (s *ListIntervalAgentSkillGroupReportResponseBodyDataOutbound) SetSatisfactionCount(v int64) *ListIntervalAgentSkillGroupReportResponseBodyDataOutbound {
	s.SatisfactionCount = &v
	return s
}
...
func (s *ListIntervalAgentSkillGroupReportResponseBodyDataOverall) GetSatisfactionCount() *int64 {
	return s.SatisfactionCount
}
...
func (s *ListIntervalAgentSkillGroupReportResponseBodyDataOverall) GetTotalOffSiteOnlineTime() *int64 {
	return s.TotalOffSiteOnlineTime
}

func (s *ListIntervalAgentSkillGroupReportResponseBodyDataOverall) GetTotalOfficePhoneOnlineTime() *int64 {
	return s.TotalOfficePhoneOnlineTime
}

func (s *ListIntervalAgentSkillGroupReportResponseBodyDataOverall) GetTotalOnSiteOnlineTime() *int64 {
...
func (s *ListIntervalAgentSkillGroupReportResponseBodyDataOverall) SetSatisfactionCount(v int64) *ListIntervalAgentSkillGroupReportResponseBodyDataOverall {
	s.SatisfactionCount = &v
	return s
}
