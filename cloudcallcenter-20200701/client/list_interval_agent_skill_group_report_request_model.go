...
type iListIntervalAgentSkillGroupReportRequest interface {
	...
	GetInterval() *string
	SetMediaType(v string) *ListIntervalAgentSkillGroupReportRequest
	GetMediaType() *string
	SetShowDefaultIfEmpty(v bool) *ListIntervalAgentSkillGroupReportRequest
	GetShowDefaultIfEmpty() *bool
...
type ListIntervalAgentSkillGroupReportRequest struct {
	...
	ShowDefaultIfEmpty *bool   `json:"ShowDefaultIfEmpty,omitempty" xml:"ShowDefaultIfEmpty,omitempty"`
	// This parameter is required.
	//
	// example:
	//
...
func (s *ListIntervalAgentSkillGroupReportRequest) GetMediaType() *string {
	return s.MediaType
}

func (s *ListIntervalAgentSkillGroupReportRequest) GetShowDefaultIfEmpty() *bool {
	return s.ShowDefaultIfEmpty
}
...
func (s *ListIntervalAgentSkillGroupReportRequest) SetShowDefaultIfEmpty(v bool) *ListIntervalAgentSkillGroupReportRequest {
	s.ShowDefaultIfEmpty = &v
	return s
}
