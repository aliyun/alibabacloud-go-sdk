...
type iTagResourcesRequest interface {
	...
	SetCategory(v string) *TagResourcesRequest
	GetCategory() *string
	SetResourceIds(v []*string) *TagResourcesRequest
	GetResourceIds() []*string
	SetTagOwnerUid(v int64) *TagResourcesRequest
...
func (s *TagResourcesRequest) GetCategory() *string {
	return s.Category
}
...
func (s *TagResourcesRequest) GetTagOwnerUid() *int64 {
...
func (s *TagResourcesRequest) SetCategory(v string) *TagResourcesRequest {
	s.Category = &v
	return s
}
...
func (s *TagResourcesRequest) SetTagOwnerUid(v int64) *TagResourcesRequest {
	s.TagOwnerUid = &v
	return s
}
