...
type iUpdateModelServiceResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *UpdateModelServiceResponseBody) *UpdateModelServiceResponse
	GetBody() *UpdateModelServiceResponseBody
}

type UpdateModelServiceResponse struct {
	Headers    map[string]*string              `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                          `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *UpdateModelServiceResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *UpdateModelServiceResponse) GetBody() *UpdateModelServiceResponseBody {
	return s.Body
}
