...
func (s *DescribeAlertsWithEventResponseBodyDataResponseData) GetAlertStatus() *string {
...
func (s *DescribeAlertsWithEventResponseBodyDataResponseData) GetInvestigationReport() *string {
...
func (s *DescribeAlertsWithEventResponseBodyDataResponseData) SetAlertStatus(v string) *DescribeAlertsWithEventResponseBodyDataResponseData {
	s.AlertStatus = &v
	return s
}
...
func (s *DescribeAlertsWithEventResponseBodyDataResponseData) SetInvestigationReport(v string) *DescribeAlertsWithEventResponseBodyDataResponseData {
