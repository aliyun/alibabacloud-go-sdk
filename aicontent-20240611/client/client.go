...
func (client *Client) ModelRouterUpdateApiKeyStatusWithOptions(id *string, request *ModelRouterUpdateApiKeyStatusRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ModelRouterUpdateApiKeyStatusResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return ModelRouterUpdateApiKeyStatusResponse
func (client *Client) ModelRouterUpdateApiKeyStatus(id *string, request *ModelRouterUpdateApiKeyStatusRequest) (_result *ModelRouterUpdateApiKeyStatusResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ModelRouterUpdateApiKeyStatusResponse{}
	_body, _err := client.ModelRouterUpdateApiKeyStatusWithOptions(id, request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
