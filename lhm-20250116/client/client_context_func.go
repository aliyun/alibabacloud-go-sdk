...
func (client *Client) GetAllRulesSummaryWithContext(ctx context.Context, request *GetAllRulesSummaryRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetAllRulesSummaryResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GetCategoryDetailWithContext(ctx context.Context, request *GetCategoryDetailRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetCategoryDetailResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) SaveSkillAuditRecordWithContext(ctx context.Context, request *SaveSkillAuditRecordRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *SaveSkillAuditRecordResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
