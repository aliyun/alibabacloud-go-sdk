...
func (client *Client) BatchDeleteTopicsWithContext(ctx context.Context, tmpReq *BatchDeleteTopicsRequest, runtime *dara.RuntimeOptions) (_result *BatchDeleteTopicsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
