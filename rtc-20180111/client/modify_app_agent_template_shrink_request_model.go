...
func (s *ModifyAppAgentTemplateShrinkRequest) GetAgentSilenceConfigShrink() *string {
...
func (s *ModifyAppAgentTemplateShrinkRequest) SetAgentSilenceConfigShrink(v string) *ModifyAppAgentTemplateShrinkRequest {
