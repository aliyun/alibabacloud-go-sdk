...
type iSyncDepartmentUserRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *SyncDepartmentUserRequest
	GetOpUserId() *string
...
func (s *SyncDepartmentUserRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *SyncDepartmentUserRequest) SetOpUserId(v string) *SyncDepartmentUserRequest {
	s.OpUserId = &v
	return s
}
