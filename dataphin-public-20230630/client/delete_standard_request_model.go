...
type iDeleteStandardRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *DeleteStandardRequest
	GetOpUserId() *string
}
...
func (s *DeleteStandardRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *DeleteStandardRequest) SetOpUserId(v string) *DeleteStandardRequest {
	s.OpUserId = &v
	return s
}
