...
type iUpdateFileNameRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *UpdateFileNameRequest
	GetOpUserId() *string
...
func (s *UpdateFileNameRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *UpdateFileNameRequest) SetOpUserId(v string) *UpdateFileNameRequest {
	s.OpUserId = &v
	return s
}
