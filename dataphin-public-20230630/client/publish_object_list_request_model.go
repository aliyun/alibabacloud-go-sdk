...
type iPublishObjectListRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *PublishObjectListRequest
	GetOpUserId() *string
...
func (s *PublishObjectListRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *PublishObjectListRequest) SetOpUserId(v string) *PublishObjectListRequest {
	s.OpUserId = &v
	return s
}
