...
type iUpdateUdfShrinkRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *UpdateUdfShrinkRequest
	GetOpUserId() *string
...
func (s *UpdateUdfShrinkRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *UpdateUdfShrinkRequest) SetOpUserId(v string) *UpdateUdfShrinkRequest {
	s.OpUserId = &v
	return s
}
