...
type iUpdateBizUnitRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *UpdateBizUnitRequest
	GetOpUserId() *string
...
func (s *UpdateBizUnitRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *UpdateBizUnitRequest) SetOpUserId(v string) *UpdateBizUnitRequest {
	s.OpUserId = &v
	return s
}
