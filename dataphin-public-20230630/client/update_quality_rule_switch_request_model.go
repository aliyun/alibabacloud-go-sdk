...
type iUpdateQualityRuleSwitchRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *UpdateQualityRuleSwitchRequest
	GetOpUserId() *string
...
func (s *UpdateQualityRuleSwitchRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *UpdateQualityRuleSwitchRequest) SetOpUserId(v string) *UpdateQualityRuleSwitchRequest {
	s.OpUserId = &v
	return s
}
