...
type iGetSecurityIdentifyResultRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *GetSecurityIdentifyResultRequest
	GetOpUserId() *string
}
...
func (s *GetSecurityIdentifyResultRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *GetSecurityIdentifyResultRequest) SetOpUserId(v string) *GetSecurityIdentifyResultRequest {
	s.OpUserId = &v
	return s
}
