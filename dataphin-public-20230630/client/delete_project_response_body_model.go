...
type iDeleteProjectResponseBody interface {
	...
	GetCode() *string
	SetHttpStatusCode(v int32) *DeleteProjectResponseBody
...
func (s *DeleteProjectResponseBody) GetHttpStatusCode() *int32 {
...
func (s *DeleteProjectResponseBody) SetHttpStatusCode(v int32) *DeleteProjectResponseBody {
	s.HttpStatusCode = &v
	return s
}
