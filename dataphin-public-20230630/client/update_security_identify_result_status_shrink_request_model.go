...
type iUpdateSecurityIdentifyResultStatusShrinkRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *UpdateSecurityIdentifyResultStatusShrinkRequest
	GetOpUserId() *string
...
func (s *UpdateSecurityIdentifyResultStatusShrinkRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *UpdateSecurityIdentifyResultStatusShrinkRequest) SetOpUserId(v string) *UpdateSecurityIdentifyResultStatusShrinkRequest {
	s.OpUserId = &v
	return s
}
