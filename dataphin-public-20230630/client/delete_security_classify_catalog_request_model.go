...
type iDeleteSecurityClassifyCatalogRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *DeleteSecurityClassifyCatalogRequest
	GetOpUserId() *string
}
...
func (s *DeleteSecurityClassifyCatalogRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *DeleteSecurityClassifyCatalogRequest) SetOpUserId(v string) *DeleteSecurityClassifyCatalogRequest {
	s.OpUserId = &v
	return s
}
