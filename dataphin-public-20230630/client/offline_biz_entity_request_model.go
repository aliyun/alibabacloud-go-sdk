...
type iOfflineBizEntityRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *OfflineBizEntityRequest
	GetOpUserId() *string
}
...
func (s *OfflineBizEntityRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *OfflineBizEntityRequest) SetOpUserId(v string) *OfflineBizEntityRequest {
	s.OpUserId = &v
	return s
}
