...
type iCreateSecurityClassifyRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *CreateSecurityClassifyRequest
	GetOpUserId() *string
}
...
func (s *CreateSecurityClassifyRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *CreateSecurityClassifyRequest) SetOpUserId(v string) *CreateSecurityClassifyRequest {
	s.OpUserId = &v
	return s
}
