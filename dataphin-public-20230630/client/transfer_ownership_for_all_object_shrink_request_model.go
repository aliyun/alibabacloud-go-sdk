...
type iTransferOwnershipForAllObjectShrinkRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *TransferOwnershipForAllObjectShrinkRequest
	GetOpUserId() *string
...
func (s *TransferOwnershipForAllObjectShrinkRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *TransferOwnershipForAllObjectShrinkRequest) SetOpUserId(v string) *TransferOwnershipForAllObjectShrinkRequest {
	s.OpUserId = &v
	return s
}
