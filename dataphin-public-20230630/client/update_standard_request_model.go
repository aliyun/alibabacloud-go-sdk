...
type iUpdateStandardRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *UpdateStandardRequest
	GetOpUserId() *string
...
func (s *UpdateStandardRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *UpdateStandardRequest) SetOpUserId(v string) *UpdateStandardRequest {
	s.OpUserId = &v
	return s
}
