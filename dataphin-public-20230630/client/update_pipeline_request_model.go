...
type iUpdatePipelineRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *UpdatePipelineRequest
	GetOpUserId() *string
...
func (s *UpdatePipelineRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *UpdatePipelineRequest) SetOpUserId(v string) *UpdatePipelineRequest {
	s.OpUserId = &v
	return s
}
