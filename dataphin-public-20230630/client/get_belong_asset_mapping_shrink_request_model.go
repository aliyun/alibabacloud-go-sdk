...
type iGetBelongAssetMappingShrinkRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *GetBelongAssetMappingShrinkRequest
	GetOpUserId() *string
}
...
func (s *GetBelongAssetMappingShrinkRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *GetBelongAssetMappingShrinkRequest) SetOpUserId(v string) *GetBelongAssetMappingShrinkRequest {
	s.OpUserId = &v
	return s
}
