...
type iGetPhysicalNodeContentRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *GetPhysicalNodeContentRequest
	GetOpUserId() *string
}
...
func (s *GetPhysicalNodeContentRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *GetPhysicalNodeContentRequest) SetOpUserId(v string) *GetPhysicalNodeContentRequest {
	s.OpUserId = &v
	return s
}
