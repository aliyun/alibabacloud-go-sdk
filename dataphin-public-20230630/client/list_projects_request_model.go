...
type iListProjectsRequest interface {
	...
	GetOpTenantId() *int64
	SetOpUserId(v string) *ListProjectsRequest
	GetOpUserId() *string
}
...
func (s *ListProjectsRequest) GetOpUserId() *string {
	return s.OpUserId
}
...
func (s *ListProjectsRequest) SetOpUserId(v string) *ListProjectsRequest {
	s.OpUserId = &v
	return s
}
