...
func (client *Client) InterruptForArbitrationWithContext(ctx context.Context, tmpReq *InterruptForArbitrationRequest, runtime *dara.RuntimeOptions) (_result *InterruptForArbitrationResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = tmpReq.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListDomainWithContext(ctx context.Context, request *ListDomainRequest, runtime *dara.RuntimeOptions) (_result *ListDomainResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
