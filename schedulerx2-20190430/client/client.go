...
func (client *Client) ReadSchedulerxDesignateDetailWithOptions(request *ReadSchedulerxDesignateDetailRequest, runtime *util.RuntimeOptions) (_result *ReadSchedulerxDesignateDetailResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapi.Params{
		Action:      tea.String("ReadSchedulerxDesignateDetail"),
		Version:     tea.String("2019-04-30"),
		Protocol:    tea.String("HTTPS"),
		Pathname:    tea.String("/"),
		Method:      tea.String("POST"),
...
func (client *Client) ReadSchedulerxDesignateInfoWithOptions(request *ReadSchedulerxDesignateInfoRequest, runtime *util.RuntimeOptions) (_result *ReadSchedulerxDesignateInfoResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapi.Params{
		Action:      tea.String("ReadSchedulerxDesignateInfo"),
		Version:     tea.String("2019-04-30"),
		Protocol:    tea.String("HTTPS"),
		Pathname:    tea.String("/"),
		Method:      tea.String("POST"),
...
func (client *Client) UpdateAppGroupWithOptions(request *UpdateAppGroupRequest, runtime *util.RuntimeOptions) (_result *UpdateAppGroupResponse, _err error) {
	...
	if !tea.BoolValue(util.IsUnset(request.MonitorConfigJson)) {
		query["MonitorConfigJson"] = request.MonitorConfigJson
	}

	if !tea.BoolValue(util.IsUnset(request.MonitorContactsJson)) {
