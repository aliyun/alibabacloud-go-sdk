...
type iConfigLayer7CCRuleResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *ConfigLayer7CCRuleResponseBody
	GetRequestId() *string
}
...
func (s *ConfigLayer7CCRuleResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *ConfigLayer7CCRuleResponseBody) Validate() error {
