...
type iModifyAddressBookRequest interface {
	...
	SetClientToken(v string) *ModifyAddressBookRequest
	GetClientToken() *string
	SetDescription(v string) *ModifyAddressBookRequest
	GetDescription() *string
	SetDryRun(v bool) *ModifyAddressBookRequest
	GetDryRun() *bool
...
func (s *ModifyAddressBookRequest) GetClientToken() *string {
...
func (s *ModifyAddressBookRequest) GetDryRun() *bool {
	return s.DryRun
}
...
func (s *ModifyAddressBookRequest) SetClientToken(v string) *ModifyAddressBookRequest {
	s.ClientToken = &v
	return s
}
...
func (s *ModifyAddressBookRequest) SetDryRun(v bool) *ModifyAddressBookRequest {
	s.DryRun = &v
	return s
}
