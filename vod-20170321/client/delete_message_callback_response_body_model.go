...
type iDeleteMessageCallbackResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *DeleteMessageCallbackResponseBody
	GetRequestId() *string
}
...
func (s *DeleteMessageCallbackResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *DeleteMessageCallbackResponseBody) Validate() error {
