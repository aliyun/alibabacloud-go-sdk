...
func (client *Client) Init(config *openapiutil.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(dara.String("ada"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
...
func (client *Client) CreateTransitUploadPolicyWithOptions(request *CreateTransitUploadPolicyRequest, runtime *dara.RuntimeOptions) (_result *CreateTransitUploadPolicyResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return CreateTransitUploadPolicyResponse
func (client *Client) CreateTransitUploadPolicy(request *CreateTransitUploadPolicyRequest) (_result *CreateTransitUploadPolicyResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &CreateTransitUploadPolicyResponse{}
	_body, _err := client.CreateTransitUploadPolicyWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) GetTransitMetaWithOptions(request *GetTransitMetaRequest, runtime *dara.RuntimeOptions) (_result *GetTransitMetaResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return GetTransitMetaResponse
func (client *Client) GetTransitMeta(request *GetTransitMetaRequest) (_result *GetTransitMetaResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &GetTransitMetaResponse{}
	_body, _err := client.GetTransitMetaWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
