...
func (s *ListAccountsForParentResponseBodyAccountsAccount) GetAccountName() *string {
	return s.AccountName
}

func (s *ListAccountsForParentResponseBodyAccountsAccount) GetDeletionStatus() *string {
