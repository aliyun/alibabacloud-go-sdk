...
type iCreateControlPolicyRequest interface {
	...
	SetTag(v []*CreateControlPolicyRequestTag) *CreateControlPolicyRequest
	GetTag() []*CreateControlPolicyRequestTag
}
...
func (s *CreateControlPolicyRequest) GetTag() []*CreateControlPolicyRequestTag {
	return s.Tag
}
...
func (s *CreateControlPolicyRequestTag) GetKey() *string {
	return s.Key
}

func (s *CreateControlPolicyRequestTag) GetValue() *string {
	return s.Value
}
...
func (s *CreateControlPolicyRequestTag) Validate() error {
