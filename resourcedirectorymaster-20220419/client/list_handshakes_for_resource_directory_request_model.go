...
type iListHandshakesForResourceDirectoryRequest interface {
	dara.Model
	String() string
	GoString() string
	SetPageNumber(v int32) *ListHandshakesForResourceDirectoryRequest
	GetPageNumber() *int32
	SetPageSize(v int32) *ListHandshakesForResourceDirectoryRequest
	GetPageSize() *int32
}
...
func (s *ListHandshakesForResourceDirectoryRequest) GetPageNumber() *int32 {
	return s.PageNumber
}

func (s *ListHandshakesForResourceDirectoryRequest) GetPageSize() *int32 {
	return s.PageSize
}
...
func (s *ListHandshakesForResourceDirectoryRequest) Validate() error {
