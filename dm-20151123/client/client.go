...
func (client *Client) BatchSendMailWithOptions(tmpReq *BatchSendMailRequest, runtime *dara.RuntimeOptions) (_result *BatchSendMailResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
...
func (client *Client) ListValidateFileWithOptions(request *ListValidateFileRequest, runtime *dara.RuntimeOptions) (_result *ListValidateFileResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return ListValidateFileResponse
func (client *Client) ListValidateFile(request *ListValidateFileRequest) (_result *ListValidateFileResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &ListValidateFileResponse{}
	_body, _err := client.ListValidateFileWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
