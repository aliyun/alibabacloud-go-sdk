...
type iDeleteMailAddressResponseBody interface {
	dara.Model
	String() string
	GoString() string
	SetRequestId(v string) *DeleteMailAddressResponseBody
	GetRequestId() *string
}
...
func (s *DeleteMailAddressResponseBody) GetRequestId() *string {
	return s.RequestId
}
...
func (s *DeleteMailAddressResponseBody) Validate() error {
