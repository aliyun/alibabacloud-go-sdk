...
func (s *DedicatedIpPoolListResponseBodyIpPoolsIps) GetZoneId() *string {
	return s.ZoneId
}
...
func (s *DedicatedIpPoolListResponseBodyIpPoolsIps) SetZoneId(v string) *DedicatedIpPoolListResponseBodyIpPoolsIps {
	s.ZoneId = &v
	return s
}
