...
type iDetectImageLabelsShrinkRequest interface {
	dara.Model
	String() string
	GoString() string
	SetCredentialConfigShrink(v string) *DetectImageLabelsShrinkRequest
	GetCredentialConfigShrink() *string
	SetProjectName(v string) *DetectImageLabelsShrinkRequest
	GetProjectName() *string
	SetSourceURI(v string) *DetectImageLabelsShrinkRequest
	GetSourceURI() *string
	SetThreshold(v float32) *DetectImageLabelsShrinkRequest
...
func (s *DetectImageLabelsShrinkRequest) GetCredentialConfigShrink() *string {
	return s.CredentialConfigShrink
}

func (s *DetectImageLabelsShrinkRequest) GetProjectName() *string {
	return s.ProjectName
}

func (s *DetectImageLabelsShrinkRequest) GetSourceURI() *string {
	return s.SourceURI
}

func (s *DetectImageLabelsShrinkRequest) GetThreshold() *float32 {
	return s.Threshold
}
...
func (s *DetectImageLabelsShrinkRequest) Validate() error {
