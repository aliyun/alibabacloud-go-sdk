...
func (client *Client) GetPassThroughAuthInfoWithOptions(request *GetPassThroughAuthInfoRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetPassThroughAuthInfoResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return GetPassThroughAuthInfoResponse
func (client *Client) GetPassThroughAuthInfo(request *GetPassThroughAuthInfoRequest) (_result *GetPassThroughAuthInfoResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &GetPassThroughAuthInfoResponse{}
	_body, _err := client.GetPassThroughAuthInfoWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
