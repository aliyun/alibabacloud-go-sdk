...
type iDeleteServiceTaskRequest interface {
	dara.Model
	String() string
	GoString() string
	SetType(v string) *DeleteServiceTaskRequest
	GetType() *string
}

type DeleteServiceTaskRequest struct {
...
func (s DeleteServiceTaskRequest) String() string {
	return dara.Prettify(s)
}

func (s DeleteServiceTaskRequest) GoString() string {
	return s.String()
}

func (s *DeleteServiceTaskRequest) GetType() *string {
	return s.Type
}

func (s *DeleteServiceTaskRequest) SetType(v string) *DeleteServiceTaskRequest {
	s.Type = &v
	return s
}

func (s *DeleteServiceTaskRequest) Validate() error {
