...
type iReleaseInstanceResponseBody interface {
	...
	GetCode() *int32
	SetData(v string) *ReleaseInstanceResponseBody
	GetData() *string
...
func (s *ReleaseInstanceResponseBody) GetData() *string {
	return s.Data
}
...
func (s *ReleaseInstanceResponseBody) SetData(v string) *ReleaseInstanceResponseBody {
	s.Data = &v
	return s
}
