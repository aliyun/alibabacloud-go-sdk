...
func (client *Client) AlterTableSchemaWithContext(ctx context.Context, catalogId *string, database *string, table *string, request *AlterTableSchemaRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *AlterTableSchemaResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GetVpcConfigWithContext(ctx context.Context, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetVpcConfigResponse, _err error) {
	req := &openapiutil.OpenApiRequest{
		Headers: headers,
	}
	params := &openapiutil.Params{
...
func (client *Client) ListFunctionsWithContext(ctx context.Context, catalogId *string, database *string, request *ListFunctionsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListFunctionsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListPartitionsWithContext(ctx context.Context, catalogId *string, database *string, table *string, request *ListPartitionsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListPartitionsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListPartitionsByNamesWithContext(ctx context.Context, catalogId *string, database *string, table *string, request *ListPartitionsByNamesRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListPartitionsByNamesResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListViewDetailsWithContext(ctx context.Context, catalogId *string, database *string, request *ListViewDetailsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListViewDetailsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListViewsWithContext(ctx context.Context, catalogId *string, database *string, request *ListViewsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListViewsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
