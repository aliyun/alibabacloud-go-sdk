...
func (s *GetBodyPersonResponseBodyData) SetInstanceId(v int64) *GetBodyPersonResponseBodyData {
	s.InstanceId = &v
	return s
}
...
func (s *AddBodyTraceResponseBody) SetCode(v string) *AddBodyTraceResponseBody {
	s.Code = &v
	return s
}

func (s *AddBodyTraceResponseBody) SetMessage(v string) *AddBodyTraceResponseBody {
	s.Message = &v
	return s
}
