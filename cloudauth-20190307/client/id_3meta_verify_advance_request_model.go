...
type iId3MetaVerifyAdvanceRequest interface {
	...
	SetFacePicture(v string) *Id3MetaVerifyAdvanceRequest
...
func (s *Id3MetaVerifyAdvanceRequest) GetFacePicture() *string {
...
func (s *Id3MetaVerifyAdvanceRequest) SetFacePicture(v string) *Id3MetaVerifyAdvanceRequest {
	s.FacePicture = &v
	return s
}
