...
type DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes struct {
	...
	Ethnicity *string                                                                                  `json:"Ethnicity,omitempty" xml:"Ethnicity,omitempty" require:"true"`
	Gender    *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender   `json:"Gender,omitempty" xml:"Gender,omitempty" require:"true" type:"Struct"`
...
func (s *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes) SetAge(v int) *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes {
	s.Age = &v
	return s
}
...
func (s *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes) SetEthnicity(v string) *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes {
	s.Ethnicity = &v
	return s
}

func (s *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes) SetGender(v *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender) *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributes {
	s.Gender = v
	return s
}
...
type DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender struct {
	Score *float32 `json:"Score,omitempty" xml:"Score,omitempty" require:"true"`
	Value *string  `json:"Value,omitempty" xml:"Value,omitempty" require:"true"`
}

func (s DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender) String() string {
	return tea.Prettify(s)
}

func (s DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender) GoString() string {
	return s.String()
}

func (s *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender) SetScore(v float32) *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender {
	s.Score = &v
	return s
}

func (s *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender) SetValue(v string) *DetectFaceAttributesResponseDataFaceInfosFaceAttributesDetectInfoFaceAttributesGender {
	s.Value = &v
	return s
}
...
func (s *VerifyMaterialResponseMaterialIdCardInfo) SetSex(v string) *VerifyMaterialResponseMaterialIdCardInfo {
	s.Sex = &v
	return s
}
...
func (s *DescribeVerifyResultResponseMaterialIdCardInfo) SetSex(v string) *DescribeVerifyResultResponseMaterialIdCardInfo {
	s.Sex = &v
	return s
}
