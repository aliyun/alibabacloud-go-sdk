...
func (s *CreateAuthKeyRequest) SetSourceIp(v string) *CreateAuthKeyRequest {
	s.SourceIp = &v
	return s
}

func (s *CreateAuthKeyRequest) SetLang(v string) *CreateAuthKeyRequest {
	s.Lang = &v
	return s
}
...
func (s *CreateVerifySDKRequest) SetSourceIp(v string) *CreateVerifySDKRequest {
	s.SourceIp = &v
	return s
}

func (s *CreateVerifySDKRequest) SetLang(v string) *CreateVerifySDKRequest {
	s.Lang = &v
	return s
}
...
func (s *CreateVerifySettingRequest) SetSourceIp(v string) *CreateVerifySettingRequest {
	s.SourceIp = &v
	return s
}
...
func (s *DescribeDeviceInfoRequest) SetSourceIp(v string) *DescribeDeviceInfoRequest {
	s.SourceIp = &v
	return s
}

func (s *DescribeDeviceInfoRequest) SetLang(v string) *DescribeDeviceInfoRequest {
	s.Lang = &v
	return s
}

func (s *DescribeDeviceInfoRequest) SetTotalCount(v int32) *DescribeDeviceInfoRequest {
	s.TotalCount = &v
	return s
}
...
func (s *DescribeFaceUsageRequest) SetSourceIp(v string) *DescribeFaceUsageRequest {
	s.SourceIp = &v
	return s
}
...
func (s *DescribeOssUploadTokenRequest) SetSourceIp(v string) *DescribeOssUploadTokenRequest {
	s.SourceIp = &v
	return s
}
...
func (s *DescribeVerifyRecordsRequest) SetSourceIp(v string) *DescribeVerifyRecordsRequest {
	s.SourceIp = &v
	return s
}
...
func (s *DescribeVerifySDKRequest) SetSourceIp(v string) *DescribeVerifySDKRequest {
	s.SourceIp = &v
	return s
}

func (s *DescribeVerifySDKRequest) SetLang(v string) *DescribeVerifySDKRequest {
	s.Lang = &v
	return s
}
...
func (s *DescribeVerifySettingRequest) SetSourceIp(v string) *DescribeVerifySettingRequest {
	s.SourceIp = &v
	return s
}
...
func (s *DescribeVerifyUsageRequest) SetSourceIp(v string) *DescribeVerifyUsageRequest {
	s.SourceIp = &v
	return s
}
...
func (s *ModifyDeviceInfoRequest) SetSourceIp(v string) *ModifyDeviceInfoRequest {
	s.SourceIp = &v
	return s
}

func (s *ModifyDeviceInfoRequest) SetLang(v string) *ModifyDeviceInfoRequest {
	s.Lang = &v
	return s
}
...
func (s *UpdateVerifySettingRequest) SetSourceIp(v string) *UpdateVerifySettingRequest {
	s.SourceIp = &v
	return s
}
...
func (client *Client) DescribeOssUploadTokenWithOptions(request *DescribeOssUploadTokenRequest, runtime *util.RuntimeOptions) (_result *DescribeOssUploadTokenResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DescribeOssUploadToken(request *DescribeOssUploadTokenRequest) (_result *DescribeOssUploadTokenResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	_result = &DescribeOssUploadTokenResponse{}
	_body, _err := client.DescribeOssUploadTokenWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) DescribeVerifySettingWithOptions(request *DescribeVerifySettingRequest, runtime *util.RuntimeOptions) (_result *DescribeVerifySettingResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DescribeVerifySetting(request *DescribeVerifySettingRequest) (_result *DescribeVerifySettingResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	_result = &DescribeVerifySettingResponse{}
	_body, _err := client.DescribeVerifySettingWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
