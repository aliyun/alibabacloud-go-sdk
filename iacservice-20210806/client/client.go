...
func (client *Client) CreateStackWithOptions(request *CreateStackRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *CreateStackResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) CreateStack(request *CreateStackRequest) (_result *CreateStackResponse, _err error) {
	...
	headers := make(map[string]*string)
	_result = &CreateStackResponse{}
	_body, _err := client.CreateStackWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) GetStackWithOptions(stackId *string, request *GetStackRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetStackResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return GetStackResponse
func (client *Client) GetStack(stackId *string, request *GetStackRequest) (_result *GetStackResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &GetStackResponse{}
	_body, _err := client.GetStackWithOptions(stackId, request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) ListStackConfigsWithOptions(stackId *string, request *ListStackConfigsRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListStackConfigsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return ListStackConfigsResponse
func (client *Client) ListStackConfigs(stackId *string, request *ListStackConfigsRequest) (_result *ListStackConfigsResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ListStackConfigsResponse{}
	_body, _err := client.ListStackConfigsWithOptions(stackId, request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) ListStacksWithOptions(request *ListStacksRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListStacksResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListStacks(request *ListStacksRequest) (_result *ListStacksResponse, _err error) {
	...
	headers := make(map[string]*string)
	_result = &ListStacksResponse{}
	_body, _err := client.ListStacksWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) ManageTerraformStateWithOptions(request *ManageTerraformStateRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ManageTerraformStateResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return ManageTerraformStateResponse
func (client *Client) ManageTerraformState(request *ManageTerraformStateRequest) (_result *ManageTerraformStateResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &ManageTerraformStateResponse{}
	_body, _err := client.ManageTerraformStateWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) UpdateStackWithOptions(stackId *string, request *UpdateStackRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *UpdateStackResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return UpdateStackResponse
func (client *Client) UpdateStack(stackId *string, request *UpdateStackRequest) (_result *UpdateStackResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &UpdateStackResponse{}
	_body, _err := client.UpdateStackWithOptions(stackId, request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) UploadModuleWithOptions(resourceType *string, request *UploadModuleRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *UploadModuleResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return UploadModuleResponse
func (client *Client) UploadModule(resourceType *string, request *UploadModuleRequest) (_result *UploadModuleResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	headers := make(map[string]*string)
	_result = &UploadModuleResponse{}
	_body, _err := client.UploadModuleWithOptions(resourceType, request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) UploadModuleAdvance(resourceType *string, request *UploadModuleAdvanceRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *UploadModuleResponse, _err error) {
	// Step 0: init client
	...
	authRequest := map[string]*string{
		"Product":  dara.String("IaCService"),
		"RegionId": client.RegionId,
	}
	...
	uploadModuleReq := &UploadModuleRequest{}
	...
	if !dara.IsNil(request.UrlObject) {
		...
		uploadModuleReq.Url = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}

	uploadModuleResp, _err := client.UploadModuleWithOptions(resourceType, uploadModuleReq, headers, runtime)
	if _err != nil {
		return _result, _err
	}

	_result = uploadModuleResp
	return _result, _err
}
