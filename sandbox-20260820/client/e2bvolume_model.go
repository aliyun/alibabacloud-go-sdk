...
type iE2BVolume interface {
  ...
  GetCreatedAt() *string 
  SetJuiceFSVolumeConfig(v *JuiceFSVolumeConfig) *E2BVolume
  GetJuiceFSVolumeConfig() *JuiceFSVolumeConfig 
  SetMountConfig(v *VolumeMountConfig) *E2BVolume
  GetMountConfig() *VolumeMountConfig 
...
func (s *E2BVolume) GetJuiceFSVolumeConfig() *JuiceFSVolumeConfig  {
  return s.JuiceFSVolumeConfig
}

func (s *E2BVolume) GetMountConfig() *VolumeMountConfig  {
...
func (s *E2BVolume) SetJuiceFSVolumeConfig(v *JuiceFSVolumeConfig) *E2BVolume {
  s.JuiceFSVolumeConfig = v
  return s
}

func (s *E2BVolume) SetMountConfig(v *VolumeMountConfig) *E2BVolume {
  s.MountConfig = v
  return s
}
