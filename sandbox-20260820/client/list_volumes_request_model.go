...
type iListVolumesRequest interface {
	...
	GetStatus() *string
	SetStorageClass(v string) *ListVolumesRequest
...
func (s *ListVolumesRequest) GetStorageClass() *string {
...
func (s *ListVolumesRequest) SetStorageClass(v string) *ListVolumesRequest {
	s.StorageClass = &v
	return s
}
