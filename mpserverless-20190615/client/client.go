...
func (s *DeleteDBCollectionResponseBody) SetAffectedDocs(v int32) *DeleteDBCollectionResponseBody {
	s.AffectedDocs = &v
	return s
}
...
func (s *DeleteDBCollectionResponseBody) SetResult(v string) *DeleteDBCollectionResponseBody {
	s.Result = &v
	return s
}
...
func (s *DescribeFileUploadSignedUrlRequest) SetTargetPath(v string) *DescribeFileUploadSignedUrlRequest {
	s.TargetPath = &v
	return s
}
...
func (s *ListFunctionDeploymentResponseBodyDataListStatus) SetMessage(v string) *ListFunctionDeploymentResponseBodyDataListStatus {
	s.Message = &v
	return s
}
