...
func (client *Client) CreateGenerateAICoachScriptTaskWithContext(ctx context.Context, request *CreateGenerateAICoachScriptTaskRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *CreateGenerateAICoachScriptTaskResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GetAICoachDebugResultWithContext(ctx context.Context, request *GetAICoachDebugResultRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetAICoachDebugResultResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GetAICoachScriptGenerateTaskWithContext(ctx context.Context, request *GetAICoachScriptGenerateTaskRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *GetAICoachScriptGenerateTaskResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) ListAICoachTaskSessionWithContext(ctx context.Context, request *ListAICoachTaskSessionRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *ListAICoachTaskSessionResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) SubmitAICoachDebugWithContext(ctx context.Context, request *SubmitAICoachDebugRequest, headers map[string]*string, runtime *dara.RuntimeOptions) (_result *SubmitAICoachDebugResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
