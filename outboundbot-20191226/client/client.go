...
func (client *Client) CreateTenantKeyWithOptions(request *CreateTenantKeyRequest, runtime *dara.RuntimeOptions) (_result *CreateTenantKeyResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
	...
	req := &openapiutil.OpenApiRequest{}
	params := &openapiutil.Params{
		Action:      dara.String("CreateTenantKey"),
		Version:     dara.String("2019-12-26"),
		Protocol:    dara.String("HTTPS"),
		Pathname:    dara.String("/"),
		Method:      dara.String("POST"),
	...
	_result = &CreateTenantKeyResponse{}
	_body, _err := client.CallApi(params, req, runtime)
	if _err != nil {
		return _result, _err
	}
...
//
// @return CreateTenantKeyResponse
func (client *Client) CreateTenantKey(request *CreateTenantKeyRequest) (_result *CreateTenantKeyResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &CreateTenantKeyResponse{}
	_body, _err := client.CreateTenantKeyWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) DownloadRecordingWithOptions(request *DownloadRecordingRequest, runtime *dara.RuntimeOptions) (_result *DownloadRecordingResponse, _err error) {
	...
	if !dara.IsNil(request.SwapChannels) {
...
func (client *Client) ListScriptVariablesWithOptions(request *ListScriptVariablesRequest, runtime *dara.RuntimeOptions) (_result *ListScriptVariablesResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
	...
	params := &openapiutil.Params{
		Action:      dara.String("ListScriptVariables"),
		Version:     dara.String("2019-12-26"),
		Protocol:    dara.String("HTTPS"),
		Pathname:    dara.String("/"),
		Method:      dara.String("POST"),
	...
	_result = &ListScriptVariablesResponse{}
	_body, _err := client.CallApi(params, req, runtime)
	if _err != nil {
		return _result, _err
	}
...
//
// @return ListScriptVariablesResponse
func (client *Client) ListScriptVariables(request *ListScriptVariablesRequest) (_result *ListScriptVariablesResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &ListScriptVariablesResponse{}
	_body, _err := client.ListScriptVariablesWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
