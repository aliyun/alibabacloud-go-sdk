...
func (client *Client) Init(config *openapiutil.Config) (_err error) {
	...
	client.Endpoint, _err = client.GetEndpoint(dara.String("videorecog"), client.RegionId, client.EndpointRule, client.Network, client.Suffix, client.EndpointMap, client.Endpoint)
	if _err != nil {
		return _err
	}
...
func (client *Client) DetectVideoShotWithOptions(request *DetectVideoShotRequest, runtime *dara.RuntimeOptions) (_result *DetectVideoShotResponse, _err error) {
...
func (client *Client) DetectVideoShotAdvance(request *DetectVideoShotAdvanceRequest, runtime *dara.RuntimeOptions) (_result *DetectVideoShotResponse, _err error) {
	// Step 0: init client
	...
	authRequest := map[string]*string{
		"Product":  dara.String("videorecog"),
		"RegionId": client.RegionId,
	}
	...
	if !dara.IsNil(request.VideoUrlObject) {
		...
		detectVideoShotReq.VideoUrl = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) EvaluateVideoQualityWithOptions(request *EvaluateVideoQualityRequest, runtime *dara.RuntimeOptions) (_result *EvaluateVideoQualityResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) EvaluateVideoQualityAdvance(request *EvaluateVideoQualityAdvanceRequest, runtime *dara.RuntimeOptions) (_result *EvaluateVideoQualityResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.VideoUrlObject) {
		...
		evaluateVideoQualityReq.VideoUrl = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) GenerateVideoCoverWithOptions(request *GenerateVideoCoverRequest, runtime *dara.RuntimeOptions) (_result *GenerateVideoCoverResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) GenerateVideoCoverAdvance(request *GenerateVideoCoverAdvanceRequest, runtime *dara.RuntimeOptions) (_result *GenerateVideoCoverResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.VideoUrlObject) {
		...
		generateVideoCoverReq.VideoUrl = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) RecognizeVideoCastCrewListWithOptions(tmpReq *RecognizeVideoCastCrewListRequest, runtime *dara.RuntimeOptions) (_result *RecognizeVideoCastCrewListResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
...
func (client *Client) RecognizeVideoCastCrewListAdvance(request *RecognizeVideoCastCrewListAdvanceRequest, runtime *dara.RuntimeOptions) (_result *RecognizeVideoCastCrewListResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.VideoUrlObject) {
		...
		recognizeVideoCastCrewListReq.VideoUrl = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) SplitVideoPartsWithOptions(request *SplitVideoPartsRequest, runtime *dara.RuntimeOptions) (_result *SplitVideoPartsResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) SplitVideoPartsAdvance(request *SplitVideoPartsAdvanceRequest, runtime *dara.RuntimeOptions) (_result *SplitVideoPartsResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.VideoUrlObject) {
		...
		splitVideoPartsReq.VideoUrl = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
...
func (client *Client) UnderstandVideoContentWithOptions(request *UnderstandVideoContentRequest, runtime *dara.RuntimeOptions) (_result *UnderstandVideoContentResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
func (client *Client) UnderstandVideoContentAdvance(request *UnderstandVideoContentAdvanceRequest, runtime *dara.RuntimeOptions) (_result *UnderstandVideoContentResponse, _err error) {
	// Step 0: init client
	if dara.IsNil(client.Credential) {
		_err = &openapi.ClientError{
			Code:    dara.String("InvalidCredentials"),
	...
	if !dara.IsNil(request.VideoURLObject) {
		...
		understandVideoContentReq.VideoURL = dara.String("http://" + dara.StringValue(authResponseBody["Bucket"]) + "." + dara.StringValue(authResponseBody["Endpoint"]) + "/" + dara.StringValue(authResponseBody["ObjectKey"]))
	}
