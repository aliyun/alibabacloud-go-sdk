...
type iScanFileResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *ScanFileOutput) *ScanFileResponse
	GetBody() *ScanFileOutput
}

type ScanFileResponse struct {
	Headers    map[string]*string `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32             `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *ScanFileOutput    `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *ScanFileResponse) GetBody() *ScanFileOutput {
	return s.Body
}
...
func (s *ScanFileResponse) SetBody(v *ScanFileOutput) *ScanFileResponse {
	s.Body = v
	return s
}
