...
func (s *DescribeNamespacesResponseBodyNamespaces) GetElasticResourceSpec() *DescribeNamespacesResponseBodyNamespacesElasticResourceSpec {
...
func (s *DescribeNamespacesResponseBodyNamespaces) GetGuaranteedResourceSpec() *DescribeNamespacesResponseBodyNamespacesGuaranteedResourceSpec {
...
func (s *DescribeNamespacesResponseBodyNamespacesElasticResourceSpec) GetCpu() *int32 {
	return s.Cpu
}

func (s *DescribeNamespacesResponseBodyNamespacesElasticResourceSpec) GetMemoryGB() *int32 {
	return s.MemoryGB
}
...
func (s *DescribeNamespacesResponseBodyNamespacesElasticResourceSpec) Validate() error {
...
func (s *DescribeNamespacesResponseBodyNamespacesGuaranteedResourceSpec) GetCpu() *int32 {
	return s.Cpu
}

func (s *DescribeNamespacesResponseBodyNamespacesGuaranteedResourceSpec) GetMemoryGB() *int32 {
	return s.MemoryGB
}
...
func (s *DescribeNamespacesResponseBodyNamespacesGuaranteedResourceSpec) Validate() error {
	return dara.Validate(s)
}
