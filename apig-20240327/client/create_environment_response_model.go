...
type iCreateEnvironmentResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *CreateEnvironmentResponseBody) *CreateEnvironmentResponse
	GetBody() *CreateEnvironmentResponseBody
}
...
func (s *CreateEnvironmentResponse) GetBody() *CreateEnvironmentResponseBody {
	return s.Body
}
