...
func (s *UpdateLabelTableRequestFields) GetAlignedEntityName() *string {
...
func (s *UpdateLabelTableRequestFields) SetAlignedEntityName(v string) *UpdateLabelTableRequestFields {
