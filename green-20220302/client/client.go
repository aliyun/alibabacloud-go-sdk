...
func (client *Client) MultiModalAgentSSEWithSSE(request *MultiModalAgentSSERequest, runtime *dara.RuntimeOptions, _yield chan *MultiModalAgentSSEResponse, _yieldErr chan error) {
	defer close(_yield)
	client.multiModalAgentSSEWithSSE_opYieldFunc(_yield, _yieldErr, request, runtime)
	return
}
...
//
// @return MultiModalAgentSSEResponse
func (client *Client) MultiModalAgentSSEWithOptions(request *MultiModalAgentSSERequest, runtime *dara.RuntimeOptions) (_result *MultiModalAgentSSEResponse, _err error) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err = request.Validate()
		if _err != nil {
			return _result, _err
...
//
// @return MultiModalAgentSSEResponse
func (client *Client) MultiModalAgentSSE(request *MultiModalAgentSSERequest) (_result *MultiModalAgentSSEResponse, _err error) {
	runtime := &dara.RuntimeOptions{}
	_result = &MultiModalAgentSSEResponse{}
	_body, _err := client.MultiModalAgentSSEWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) multiModalAgentSSEWithSSE_opYieldFunc(_yield chan *MultiModalAgentSSEResponse, _yieldErr chan error, request *MultiModalAgentSSERequest, runtime *dara.RuntimeOptions) {
	if dara.BoolValue(client.EnableValidate) == true {
		_err := request.Validate()
		if _err != nil {
			_yieldErr <- _err
