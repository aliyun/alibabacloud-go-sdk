...
func (client *Client) GetOpenApiListWithContext(ctx context.Context, request *GetOpenApiListRequest, runtime *dara.RuntimeOptions) (_result *GetOpenApiListResponse, _err error) {
