...
type iDescribeRTSNativeSDKPlayFailStatusShrinkRequest interface {
	dara.Model
	String() string
	GoString() string
	SetDataInterval(v string) *DescribeRTSNativeSDKPlayFailStatusShrinkRequest
	GetDataInterval() *string
	SetDomainNameListShrink(v string) *DescribeRTSNativeSDKPlayFailStatusShrinkRequest
	GetDomainNameListShrink() *string
	SetEndTime(v string) *DescribeRTSNativeSDKPlayFailStatusShrinkRequest
	GetEndTime() *string
	SetStartTime(v string) *DescribeRTSNativeSDKPlayFailStatusShrinkRequest
	GetStartTime() *string
}
...
func (s *DescribeRTSNativeSDKPlayFailStatusShrinkRequest) GetDataInterval() *string {
	return s.DataInterval
}

func (s *DescribeRTSNativeSDKPlayFailStatusShrinkRequest) GetDomainNameListShrink() *string {
	return s.DomainNameListShrink
}

func (s *DescribeRTSNativeSDKPlayFailStatusShrinkRequest) GetEndTime() *string {
	return s.EndTime
}

func (s *DescribeRTSNativeSDKPlayFailStatusShrinkRequest) GetStartTime() *string {
	return s.StartTime
}
...
func (s *DescribeRTSNativeSDKPlayFailStatusShrinkRequest) Validate() error {
