...
type iUpdateCredentialResponse interface {
	...
	GetStatusCode() *int32
	SetBody(v *UpdateCredentialResponseBody) *UpdateCredentialResponse
	GetBody() *UpdateCredentialResponseBody
}

type UpdateCredentialResponse struct {
	Headers    map[string]*string            `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                        `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *UpdateCredentialResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}
...
func (s *UpdateCredentialResponse) GetBody() *UpdateCredentialResponseBody {
	return s.Body
}
...
func (s *UpdateCredentialResponse) SetBody(v *UpdateCredentialResponseBody) *UpdateCredentialResponse {
	s.Body = v
	return s
}
